              ...
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                ...
                <li class="nav-item">
                  ...
                  <ul class="nav collapse show" id="tables">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="../../modules/tables/bulk-select.jsp">
          ...
          <div class="card">
              ...
              <div class="row flex-between-end">
                ...
                <div class="col-auto ms-auto">
                  <div class="nav nav-pills nav-pills-falcon flex-grow-1" role="tablist">
                    <button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-f6566925-688d-4345-b935-2c882b143088" type="button" role="tab" aria-controls="dom-f6566925-688d-4345-b935-2c882b143088" aria-selected="true" id="tab-dom-f6566925-688d-4345-b935-2c882b143088">Preview</button>
                    <button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-e380bd0b-fa95-490a-9e10-8d5c2f32e4e8" type="button" role="tab" aria-controls="dom-e380bd0b-fa95-490a-9e10-8d5c2f32e4e8" aria-selected="false" id="tab-dom-e380bd0b-fa95-490a-9e10-8d5c2f32e4e8">Code</button>
                  </div>
                </div>
              </div>
            </div>
            <div class="card-body py-0 border-top">
              <div class="tab-content">
                <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-f6566925-688d-4345-b935-2c882b143088" id="dom-f6566925-688d-4345-b935-2c882b143088">
                  <div class="card shadow-none">
                ...
                <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-e380bd0b-fa95-490a-9e10-8d5c2f32e4e8" id="dom-e380bd0b-fa95-490a-9e10-8d5c2f32e4e8">
