              ...
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                ...
                <li class="nav-item">
                  ...
                  <ul class="nav collapse show" id="utilities">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="../../modules/utilities/stretched-link.jsp">
            ...
            <div class="card-body position-relative">
              <div class="row">
                <div class="col-lg-8">
                  ...
                  <p class="mb-0">Make any HTML element or Bootstrap component clickable by “stretching” a nested link via CSS.</p><a class="btn btn-link btn-sm ps-0 mt-2" href="https://getbootstrap.com/docs/5.3/helpers/stretched-link/" target="_blank">Stretched-link on Bootstrap<span class="fas fa-chevron-right ms-1 fs--2"></span></a>
                </div>
              </div>
            </div>
          </div>
          <div class="card mb-3">
              ...
              <div class="row flex-between-end">
                ...
                <div class="col-auto ms-auto">
                  <div class="nav nav-pills nav-pills-falcon flex-grow-1 mt-2" role="tablist">
                    <button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-9d31187e-dc86-4e93-ab0c-9429b4696a74" type="button" role="tab" aria-controls="dom-9d31187e-dc86-4e93-ab0c-9429b4696a74" aria-selected="true" id="tab-dom-9d31187e-dc86-4e93-ab0c-9429b4696a74">Preview</button>
                    <button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-4453b198-beff-4555-b504-147ec7994f36" type="button" role="tab" aria-controls="dom-4453b198-beff-4555-b504-147ec7994f36" aria-selected="false" id="tab-dom-4453b198-beff-4555-b504-147ec7994f36">Code</button>
                  </div>
                </div>
              </div>
            </div>
            <div class="card-body bg-light">
              <div class="tab-content">
                <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-9d31187e-dc86-4e93-ab0c-9429b4696a74" id="dom-9d31187e-dc86-4e93-ab0c-9429b4696a74">
                ...
                <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-4453b198-beff-4555-b504-147ec7994f36" id="dom-4453b198-beff-4555-b504-147ec7994f36">
          ...
          <div class="card mb-3">
            ...
            <div class="card-body py-0">
              <div class="card mx-nx1 shadow-none rounded-top-0">
                  ...
                  <div class="row flex-between-end">
                    ...
                    <div class="col-auto ms-auto">
                      <div class="nav nav-pills nav-pills-falcon flex-grow-1" role="tablist">
                        <button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-5cdddecd-e5b7-4c6d-bd6c-69a6ec4cfeba" type="button" role="tab" aria-controls="dom-5cdddecd-e5b7-4c6d-bd6c-69a6ec4cfeba" aria-selected="true" id="tab-dom-5cdddecd-e5b7-4c6d-bd6c-69a6ec4cfeba">Preview</button>
                        <button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-820b98c2-0052-434e-a7b9-4af0ddb32491" type="button" role="tab" aria-controls="dom-820b98c2-0052-434e-a7b9-4af0ddb32491" aria-selected="false" id="tab-dom-820b98c2-0052-434e-a7b9-4af0ddb32491">Code</button>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="card-body bg-light">
                  <div class="tab-content">
                    <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-5cdddecd-e5b7-4c6d-bd6c-69a6ec4cfeba" id="dom-5cdddecd-e5b7-4c6d-bd6c-69a6ec4cfeba">
                    ...
                    <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-820b98c2-0052-434e-a7b9-4af0ddb32491" id="dom-820b98c2-0052-434e-a7b9-4af0ddb32491">
