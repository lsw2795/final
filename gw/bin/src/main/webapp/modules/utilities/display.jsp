              ...
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                ...
                <li class="nav-item">
                  ...
                  <ul class="nav collapse show" id="utilities">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="../../modules/utilities/display.jsp">
          ...
          <div class="card mb-3">
              ...
              <div class="row flex-between-end">
                ...
                <div class="col-auto ms-auto">
                  <div class="nav nav-pills nav-pills-falcon flex-grow-1" role="tablist">
                    <button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-e3aa154e-da8b-480a-8012-2f1ca04ce509" type="button" role="tab" aria-controls="dom-e3aa154e-da8b-480a-8012-2f1ca04ce509" aria-selected="true" id="tab-dom-e3aa154e-da8b-480a-8012-2f1ca04ce509">Preview</button>
                    <button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-01385f48-e7ae-41a1-8bd1-7c4b42e2a047" type="button" role="tab" aria-controls="dom-01385f48-e7ae-41a1-8bd1-7c4b42e2a047" aria-selected="false" id="tab-dom-01385f48-e7ae-41a1-8bd1-7c4b42e2a047">Code</button>
                  </div>
                </div>
              </div>
            </div>
            <div class="card-body bg-light">
              <div class="tab-content">
                <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-e3aa154e-da8b-480a-8012-2f1ca04ce509" id="dom-e3aa154e-da8b-480a-8012-2f1ca04ce509">
                  <div class="d-inline bg-primary p-2 text-white">d-inline</div>
                  <div class="d-block bg-primary p-2 text-white mt-3">d-block</div>
                </div>
                <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-01385f48-e7ae-41a1-8bd1-7c4b42e2a047" id="dom-01385f48-e7ae-41a1-8bd1-7c4b42e2a047">
...
&lt;div class=&quot;d-block bg-primary p-2 text-white mt-3&quot;&gt;d-block&lt;/div&gt;</code></pre>
          ...
          <div class="card mb-3">
              ...
              <div class="row flex-between-end">
                ...
                <div class="col-auto ms-auto">
                  <div class="nav nav-pills nav-pills-falcon flex-grow-1 mt-2" role="tablist">
                    <button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-de949240-8b84-4fad-b9f8-86d55e007bce" type="button" role="tab" aria-controls="dom-de949240-8b84-4fad-b9f8-86d55e007bce" aria-selected="true" id="tab-dom-de949240-8b84-4fad-b9f8-86d55e007bce">Preview</button>
                    <button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-87d8769c-f888-435d-b3da-d3a7274f83f6" type="button" role="tab" aria-controls="dom-87d8769c-f888-435d-b3da-d3a7274f83f6" aria-selected="false" id="tab-dom-87d8769c-f888-435d-b3da-d3a7274f83f6">Code</button>
                  </div>
                </div>
              </div>
            </div>
            <div class="card-body bg-light">
              <div class="tab-content">
                <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-de949240-8b84-4fad-b9f8-86d55e007bce" id="dom-de949240-8b84-4fad-b9f8-86d55e007bce">
                  <div class="d-print-none">Screen Only (Hide on print only)</div>
                  <div class="d-none d-print-block">Print Only (Hide on screen only)</div>
                  <div class="d-none d-lg-block d-print-block">Hide up to large on screen, but always show on print</div>
                </div>
                <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-87d8769c-f888-435d-b3da-d3a7274f83f6" id="dom-87d8769c-f888-435d-b3da-d3a7274f83f6">
