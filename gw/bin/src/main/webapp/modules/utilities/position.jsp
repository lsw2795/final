              ...
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                ...
                <li class="nav-item">
                  ...
                  <ul class="nav collapse show" id="utilities">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="../../modules/utilities/position.jsp">
          ...
          <div class="card mb-3">
            ...
            <div class="card-body position-relative">
              <div class="row">
                <div class="col-lg-8">
                  <h3>Position</h3>
                  <p class="mb-0">Use these shorthand utilities for quickly configuring the position of an element.</p><a class="btn btn-link btn-sm ps-0 mt-2" href="https://getbootstrap.com/docs/5.3/utilities/position/" target="_blank">Position on Bootstrap<span class="fas fa-chevron-right ms-1 fs--2"></span></a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="card mb-3">
              ...
              <div class="row flex-between-end">
                ...
                <div class="col-auto ms-auto">
                  <div class="nav nav-pills nav-pills-falcon flex-grow-1 mt-2" role="tablist">
                    <button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-48d08410-c573-40f8-9f58-5c276a102047" type="button" role="tab" aria-controls="dom-48d08410-c573-40f8-9f58-5c276a102047" aria-selected="true" id="tab-dom-48d08410-c573-40f8-9f58-5c276a102047">Preview</button>
                    <button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-154b69ec-5a48-46bb-9d08-244f34e4839b" type="button" role="tab" aria-controls="dom-154b69ec-5a48-46bb-9d08-244f34e4839b" aria-selected="false" id="tab-dom-154b69ec-5a48-46bb-9d08-244f34e4839b">Code</button>
                  </div>
                </div>
              </div>
            </div>
            <div class="card-body bg-light">
              <div class="tab-content">
                <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-48d08410-c573-40f8-9f58-5c276a102047" id="dom-48d08410-c573-40f8-9f58-5c276a102047">
                  <div class="position-relative bg-200 mb-4" style="height: 200px;">
                    <div class="p-3 bg-900 rounded-1 position-absolute top-0 start-0" data-bs-theme="light"></div>
                    <div class="p-3 bg-900 rounded-1 position-absolute top-0 end-0" data-bs-theme="light"></div>
                    <div class="p-3 bg-900 rounded-1 position-absolute top-50 start-50" data-bs-theme="light"></div>
                    <div class="p-3 bg-900 rounded-1 position-absolute bottom-50 end-50" data-bs-theme="light"></div>
                    <div class="p-3 bg-900 rounded-1 position-absolute bottom-0 start-0" data-bs-theme="light"></div>
                    <div class="p-3 bg-900 rounded-1 position-absolute bottom-0 end-0" data-bs-theme="light"></div>
                  </div>
                  <div class="position-relative" style="height: 100px; width: 100px" data-bs-theme="light">
                    <div class="bg-900 rounded-1 text-white d-flex flex-center position-absolute all-0">.all-0</div>
                  </div>
                </div>
                <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-154b69ec-5a48-46bb-9d08-244f34e4839b" id="dom-154b69ec-5a48-46bb-9d08-244f34e4839b">
          ...
          <div class="card mb-3">
            <div class="card-header">
              <div class="row flex-between-end">
                ...
                <div class="col-auto ms-auto">
                  <div class="nav nav-pills nav-pills-falcon flex-grow-1 mt-2" role="tablist">
                    <button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-9e3bd308-9754-411f-b87c-aac09add53fd" type="button" role="tab" aria-controls="dom-9e3bd308-9754-411f-b87c-aac09add53fd" aria-selected="true" id="tab-dom-9e3bd308-9754-411f-b87c-aac09add53fd">Preview</button>
                    <button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-aebb6ee0-0295-40ee-bc03-3245084ecd3b" type="button" role="tab" aria-controls="dom-aebb6ee0-0295-40ee-bc03-3245084ecd3b" aria-selected="false" id="tab-dom-aebb6ee0-0295-40ee-bc03-3245084ecd3b">Code</button>
                  </div>
                </div>
              </div>
            </div>
            <div class="card-body bg-light">
              <div class="tab-content">
                <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-9e3bd308-9754-411f-b87c-aac09add53fd" id="dom-9e3bd308-9754-411f-b87c-aac09add53fd">
                  <div class="position-relative bg-200" style="height: 200px;">
                    <div class="p-3 bg-900 rounded-1 position-absolute top-0 start-50 translate-middle-x" data-bs-theme="light"></div>
                    <div class="p-3 bg-900 rounded-1 position-absolute top-50 start-0 translate-middle-y" data-bs-theme="light"></div>
                    <div class="p-3 bg-900 rounded-1 position-absolute top-50 start-50 translate-middle" data-bs-theme="light"></div>
                    <div class="p-3 bg-900 rounded-1 position-absolute top-50 end-0 translate-middle-y" data-bs-theme="light"></div>
                    <div class="p-3 bg-900 rounded-1 position-absolute bottom-0 start-50 translate-middle-x" data-bs-theme="light"></div>
                  </div>
                </div>
                <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-aebb6ee0-0295-40ee-bc03-3245084ecd3b" id="dom-aebb6ee0-0295-40ee-bc03-3245084ecd3b">
