              ...
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                ...
                <li class="nav-item">
                  ...
                  <ul class="nav collapse show" id="utilities">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="../../modules/utilities/float.jsp">
          ...
          <div class="card mb-3">
            ...
            <div class="card-body position-relative">
              <div class="row">
                <div class="col-lg-8">
                  <h3>Float</h3>
                  <p class="mb-0">Toggle floats on any element, across any breakpoint, using our responsive float utilities</p><a class="btn btn-link btn-sm ps-0 mt-2" href="https://getbootstrap.com/docs/5.3/utilities/float/" target="_blank">Float on Bootstrap<span class="fas fa-chevron-right ms-1 fs--2"></span></a>
                </div>
              </div>
            </div>
          </div>
          <div class="card">
              ...
              <div class="row flex-between-end">
                ...
                <div class="col-auto ms-auto">
                  <div class="nav nav-pills nav-pills-falcon flex-grow-1 mt-2" role="tablist">
                    <button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-62e5a2fd-6d49-40ff-83b3-1044181e1ebf" type="button" role="tab" aria-controls="dom-62e5a2fd-6d49-40ff-83b3-1044181e1ebf" aria-selected="true" id="tab-dom-62e5a2fd-6d49-40ff-83b3-1044181e1ebf">Preview</button>
                    <button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-a41aed21-e163-4c4b-b13e-dff53092d540" type="button" role="tab" aria-controls="dom-a41aed21-e163-4c4b-b13e-dff53092d540" aria-selected="false" id="tab-dom-a41aed21-e163-4c4b-b13e-dff53092d540">Code</button>
                  </div>
                </div>
              </div>
            </div>
            <div class="card-body bg-light">
              <div class="tab-content">
                <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-62e5a2fd-6d49-40ff-83b3-1044181e1ebf" id="dom-62e5a2fd-6d49-40ff-83b3-1044181e1ebf">
                ...
                <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-a41aed21-e163-4c4b-b13e-dff53092d540" id="dom-a41aed21-e163-4c4b-b13e-dff53092d540">
