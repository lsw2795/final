    ...
    <main class="main" id="top">
      <div class="container" data-layout="container">
              ...
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                ...
                <li class="nav-item">
                  ...
                  <ul class="nav collapse show" id="utilities">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="../../modules/utilities/colors.jsp">
        ...
        <div class="content">
          ...
          <div class="card mb-3">
            <div class="card-header">
              <h5 class="mb-0" data-anchor="data-anchor">Subtle colors</h5>
            </div>
            <div class="card-body bg-light">
              <div class="row g-0">
                <div class="col-6 col-sm-4 col-lg-3">
                  <div class="p-3 bg-primary-subtle" style="height: 180px"><code class="text-primary">.text-primary</code><br /><code class="text-primary">.bg-primary-subtle</code></div>
                </div>
                <div class="col-6 col-sm-4 col-lg-3">
                  <div class="p-3 bg-secondary-subtle" style="height: 180px"><code class="text-secondary">.text-secondary</code><br /><code class="text-secondary">.bg-secondary-subtle</code></div>
                </div>
                <div class="col-6 col-sm-4 col-lg-3">
                  <div class="p-3 bg-success-subtle" style="height: 180px"><code class="text-success">.text-success</code><br /><code class="text-success">.bg-success-subtle</code></div>
                </div>
                <div class="col-6 col-sm-4 col-lg-3">
                  <div class="p-3 bg-info-subtle" style="height: 180px"><code class="text-info">.text-info</code><br /><code class="text-info">.bg-info-subtle</code></div>
                </div>
                <div class="col-6 col-sm-4 col-lg-3">
                  <div class="p-3 bg-warning-subtle" style="height: 180px"><code class="text-warning">.text-warning</code><br /><code class="text-warning">.bg-warning-subtle</code></div>
                </div>
                <div class="col-6 col-sm-4 col-lg-3">
                  <div class="p-3 bg-danger-subtle" style="height: 180px"><code class="text-danger">.text-danger</code><br /><code class="text-danger">.bg-danger-subtle</code></div>
                </div>
                <div class="col-6 col-sm-4 col-lg-3">
                  <div class="p-3 bg-light-subtle" style="height: 180px"><code class="text-black">.text-light</code><br /><code class="text-black">.bg-light-subtle</code></div>
                </div>
                <div class="col-6 col-sm-4 col-lg-3">
                  <div class="p-3 bg-dark-subtle" style="height: 180px"><code class="text-dark">.text-dark</code><br /><code class="text-dark">.bg-dark-subtle</code></div>
                </div>
              </div>
            </div>
          </div>
          <div class="card">
            ...
            <div class="card-body bg-light">
              <div class="row g-0">
                <div class="col-6 col-sm-4 col-lg-3" data-bs-theme="light">
