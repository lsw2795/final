...
<html data-bs-theme="light" lang="en-US" dir="ltr">
              ...
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                ...
                <li class="nav-item">
                  ...
                  <ul class="nav collapse show" id="utilities">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="../../modules/utilities/text-truncation.jsp">
            ...
            <div class="card-body position-relative">
              <div class="row">
                <div class="col-lg-8">
                  ...
                  <p class="mb-0">Truncate long strings of text with an ellipsis.</p><a class="btn btn-link btn-sm ps-0 mt-2" href="https://getbootstrap.com/docs/5.3/helpers/text-truncation/" target="_blank">Text Truncation on Bootstrap<span class="fas fa-chevron-right ms-1 fs--2"></span></a>
                </div>
              </div>
            </div>
          </div>
          <div class="card mb-3">
              ...
              <div class="row flex-between-end">
                ...
                <div class="col-auto ms-auto">
                  <div class="nav nav-pills nav-pills-falcon flex-grow-1 mt-2" role="tablist">
                    <button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-b8f2b0f8-1c86-4d5e-aad4-b35b40766cfb" type="button" role="tab" aria-controls="dom-b8f2b0f8-1c86-4d5e-aad4-b35b40766cfb" aria-selected="true" id="tab-dom-b8f2b0f8-1c86-4d5e-aad4-b35b40766cfb">Preview</button>
                    <button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-0f97c402-45d5-4e6e-bd95-eb4f1f1f4d1f" type="button" role="tab" aria-controls="dom-0f97c402-45d5-4e6e-bd95-eb4f1f1f4d1f" aria-selected="false" id="tab-dom-0f97c402-45d5-4e6e-bd95-eb4f1f1f4d1f">Code</button>
                  </div>
                </div>
              </div>
            </div>
            <div class="card-body bg-light">
              <div class="tab-content">
                <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-b8f2b0f8-1c86-4d5e-aad4-b35b40766cfb" id="dom-b8f2b0f8-1c86-4d5e-aad4-b35b40766cfb">
                  <div class="row">
  ...
  Truncate your long text with bootstrap text trancation featuer.
                ...
                <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-0f97c402-45d5-4e6e-bd95-eb4f1f1f4d1f" id="dom-0f97c402-45d5-4e6e-bd95-eb4f1f1f4d1f">
