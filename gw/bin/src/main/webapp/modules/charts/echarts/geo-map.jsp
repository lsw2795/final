                  ...
                  <ul class="nav collapse show" id="charts">
                    ...
                    <li class="nav-item"><a class="nav-link dropdown-indicator" href="#eCharts" data-bs-toggle="collapse" aria-expanded="true" aria-controls="charts">
                      ...
                      <ul class="nav collapse show" id="eCharts">
                        ...
                        <li class="nav-item"><a class="nav-link active" href="../../../modules/charts/echarts/geo-map.jsp">
            ...
            <div class="card-body position-relative">
              <div class="row">
                <div class="col-lg-8">
                  ...
                  <p class="mb-0">ECharts can uses geoJSON format as map outline. You can use third-party <a href="https://geojson.org/" target="_blank">geoJSON</a> data (like maps) and register them into ECharts. You can get the JSON data from this <a href="https://github.com/pissang/starbucks/tree/gh-pages/json">Starbuck's Github repository</a>.</p><a class="btn btn-link btn-sm ps-0 mt-2" href="https://echarts.apache.org/en/option.jsp#series-map.type" target="_blank">Echart's map documentation<span class="fas fa-chevron-right ms-1 fs--2"></span></a>
                </div>
              </div>
            </div>
          </div>
              ...
              <div class="card h-100 position-relative">
                  ...
                  <div class="row flex-between-end">
                    ...
                    <div class="col-auto ms-auto">
                      <div class="nav nav-pills nav-pills-falcon flex-grow-1" role="tablist">
                        <button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-7c250c3f-6342-4cc3-a54b-31cbcddeb844" type="button" role="tab" aria-controls="dom-7c250c3f-6342-4cc3-a54b-31cbcddeb844" aria-selected="true" id="tab-dom-7c250c3f-6342-4cc3-a54b-31cbcddeb844">Preview</button>
                        <button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-6d7ccc3c-4106-4693-8872-1119eb1b104b" type="button" role="tab" aria-controls="dom-6d7ccc3c-4106-4693-8872-1119eb1b104b" aria-selected="false" id="tab-dom-6d7ccc3c-4106-4693-8872-1119eb1b104b">Code</button>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="card-body bg-light">
                  <div class="tab-content">
                    <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-7c250c3f-6342-4cc3-a54b-31cbcddeb844" id="dom-7c250c3f-6342-4cc3-a54b-31cbcddeb844">
                    ...
                    <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-6d7ccc3c-4106-4693-8872-1119eb1b104b" id="dom-6d7ccc3c-4106-4693-8872-1119eb1b104b">
                      <pre class="scrollbar rounded-1" style="max-height:420px"><code class="language-html">&lt;div class=&quot;position-absolute z-2&quot; style=&quot;right:16px&quot;&gt;
  &lt;button class=&quot;btn btn-falcon-default btn-sm mb-1 session-by-country-map-reset&quot;&gt;&lt;span class=&quot;fas fa-sync-alt fs--1&quot;&gt;&lt;/span&gt;&lt;/button&gt;
&lt;/div&gt;
              ...
              <div class="card h-100 position-relative">
                <div class="card-header">
                  <div class="row flex-between-end">
                    ...
                    <div class="col-auto ms-auto">
                      <div class="nav nav-pills nav-pills-falcon flex-grow-1" role="tablist">
                        <button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-6a6ec67f-705a-49b0-8f20-7b70667bd7e1" type="button" role="tab" aria-controls="dom-6a6ec67f-705a-49b0-8f20-7b70667bd7e1" aria-selected="true" id="tab-dom-6a6ec67f-705a-49b0-8f20-7b70667bd7e1">Preview</button>
                        <button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-4b7d9934-913a-4e1c-bcb5-253a9a3fcf33" type="button" role="tab" aria-controls="dom-4b7d9934-913a-4e1c-bcb5-253a9a3fcf33" aria-selected="false" id="tab-dom-4b7d9934-913a-4e1c-bcb5-253a9a3fcf33">Code</button>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="card-body bg-light">
                  <div class="tab-content">
                    <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-6a6ec67f-705a-49b0-8f20-7b70667bd7e1" id="dom-6a6ec67f-705a-49b0-8f20-7b70667bd7e1">
                      <div class="position-absolute z-2" style="right:16px">
                    ...
                    <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-4b7d9934-913a-4e1c-bcb5-253a9a3fcf33" id="dom-4b7d9934-913a-4e1c-bcb5-253a9a3fcf33">
                      <pre class="scrollbar rounded-1" style="max-height:420px"><code class="language-html">&lt;div class=&quot;position-absolute z-2&quot; style=&quot;right:16px&quot;&gt;
  &lt;button class=&quot;btn btn-falcon-default btn-sm mb-1 usa-map-reset&quot;&gt;&lt;span class=&quot;fas fa-sync-alt fs--1&quot;&gt;&lt;/span&gt;&lt;/button&gt;
&lt;/div&gt;
