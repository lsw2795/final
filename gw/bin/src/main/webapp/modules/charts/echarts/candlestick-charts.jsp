                  ...
                  <ul class="nav collapse show" id="charts">
                    ...
                    <li class="nav-item"><a class="nav-link dropdown-indicator" href="#eCharts" data-bs-toggle="collapse" aria-expanded="true" aria-controls="charts">
                      ...
                      <ul class="nav collapse show" id="eCharts">
                        ...
                        <li class="nav-item"><a class="nav-link active" href="../../../modules/charts/echarts/candlestick-charts.jsp">
              ...
              <div class="card h-100" dir="ltr">
                <div class="card-header">
                  <div class="row flex-between-end">
                    <div class="col-auto align-self-center">
                      <h5 class="mb-0" data-anchor="data-anchor">Basic candlestick chart</h5>
                    </div>
                    <div class="col-auto ms-auto">
                      <div class="nav nav-pills nav-pills-falcon flex-grow-1" role="tablist">
                        <button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-140342bf-0f1b-44f7-b874-e5246ca1faac" type="button" role="tab" aria-controls="dom-140342bf-0f1b-44f7-b874-e5246ca1faac" aria-selected="true" id="tab-dom-140342bf-0f1b-44f7-b874-e5246ca1faac">Preview</button>
                        <button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-1cb2cc44-98a5-434c-bf7e-9f5488da9ecd" type="button" role="tab" aria-controls="dom-1cb2cc44-98a5-434c-bf7e-9f5488da9ecd" aria-selected="false" id="tab-dom-1cb2cc44-98a5-434c-bf7e-9f5488da9ecd">Code</button>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="card-body bg-light">
                  <div class="tab-content">
                    <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-140342bf-0f1b-44f7-b874-e5246ca1faac" id="dom-140342bf-0f1b-44f7-b874-e5246ca1faac">
                      ...
                      <div class="echart-candlestick-chart-example" style="min-height: 300px;" data-echart-responsive="true"></div>
                    </div>
                    <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-1cb2cc44-98a5-434c-bf7e-9f5488da9ecd" id="dom-1cb2cc44-98a5-434c-bf7e-9f5488da9ecd">
                      <pre class="scrollbar rounded-1" style="max-height:420px"><code class="language-html">
&lt;!-- Find the JS file for the following chart at: src/js/charts/echarts/examples/basic-candlestick-chart.js--&gt;

&lt;!-- If you are not using gulp based workflow, you can find the transpiled code at: public/assets/js/echarts-example.js--&gt;
&lt;div class=&quot;echart-candlestick-chart-example&quot; style=&quot;min-height: 300px;&quot; data-echart-responsive=&quot;true&quot;&gt;&lt;/div&gt;</code></pre>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-lg-6">
              <div class="card h-100" dir="ltr">
                <div class="card-header">
                  <div class="row flex-between-end">
                    <div class="col-auto align-self-center">
                      <h5 class="mb-0" data-anchor="data-anchor">Candlestick mixed chart</h5>
                    </div>
                    <div class="col-auto ms-auto">
                      <div class="nav nav-pills nav-pills-falcon flex-grow-1" role="tablist">
                        <button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-def75269-3ab1-4471-bb8f-67cdbe1aeaf7" type="button" role="tab" aria-controls="dom-def75269-3ab1-4471-bb8f-67cdbe1aeaf7" aria-selected="true" id="tab-dom-def75269-3ab1-4471-bb8f-67cdbe1aeaf7">Preview</button>
                        <button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-73456752-8f38-46b3-a228-dc701b1d2a0f" type="button" role="tab" aria-controls="dom-73456752-8f38-46b3-a228-dc701b1d2a0f" aria-selected="false" id="tab-dom-73456752-8f38-46b3-a228-dc701b1d2a0f">Code</button>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="card-body bg-light">
                  <div class="tab-content">
                    <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-def75269-3ab1-4471-bb8f-67cdbe1aeaf7" id="dom-def75269-3ab1-4471-bb8f-67cdbe1aeaf7">
                      <!-- Find the JS file for the following chart at: src/js/charts/echarts/examples/candle-stick-mixed-chart.js-->
                      <!-- If you are not using gulp based workflow, you can find the transpiled code at: public/assets/js/echarts-example.js-->
                      <div class="echart-candlestick-mixed-chart-example" style="min-height: 300px;" data-echart-responsive="true"></div>
                    </div>
                    <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-73456752-8f38-46b3-a228-dc701b1d2a0f" id="dom-73456752-8f38-46b3-a228-dc701b1d2a0f">
                      <pre class="scrollbar rounded-1" style="max-height:420px"><code class="language-html">
&lt;!-- Find the JS file for the following chart at: src/js/charts/echarts/examples/candle-stick-mixed-chart.js--&gt;

&lt;!-- If you are not using gulp based workflow, you can find the transpiled code at: public/assets/js/echarts-example.js--&gt;
&lt;div class=&quot;echart-candlestick-mixed-chart-example&quot; style=&quot;min-height: 300px;&quot; data-echart-responsive=&quot;true&quot;&gt;&lt;/div&gt;</code></pre>
                    </div>
                  </div>
                </div>
              </div>
