                  ...
                  <ul class="nav collapse show" id="charts">
                    ...
                    <li class="nav-item"><a class="nav-link dropdown-indicator" href="#eCharts" data-bs-toggle="collapse" aria-expanded="true" aria-controls="charts">
                      ...
                      <ul class="nav collapse show" id="eCharts">
                        ...
                        <li class="nav-item"><a class="nav-link active" href="../../../modules/charts/echarts/radar-charts.jsp">
              ...
              <div class="card h-100" dir="ltr">
                  ...
                  <div class="row flex-between-end">
                    ...
                    <div class="col-auto ms-auto">
                      <div class="nav nav-pills nav-pills-falcon flex-grow-1" role="tablist">
                        <button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-616a2fe9-a69a-43cc-bc5a-3ddbcd0f98db" type="button" role="tab" aria-controls="dom-616a2fe9-a69a-43cc-bc5a-3ddbcd0f98db" aria-selected="true" id="tab-dom-616a2fe9-a69a-43cc-bc5a-3ddbcd0f98db">Preview</button>
                        <button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-f4966b0c-d127-424b-9a05-aa85196f02bd" type="button" role="tab" aria-controls="dom-f4966b0c-d127-424b-9a05-aa85196f02bd" aria-selected="false" id="tab-dom-f4966b0c-d127-424b-9a05-aa85196f02bd">Code</button>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="card-body bg-light">
                  <div class="tab-content">
                    <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-616a2fe9-a69a-43cc-bc5a-3ddbcd0f98db" id="dom-616a2fe9-a69a-43cc-bc5a-3ddbcd0f98db">
                    ...
                    <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-f4966b0c-d127-424b-9a05-aa85196f02bd" id="dom-f4966b0c-d127-424b-9a05-aa85196f02bd">
                      <pre class="scrollbar rounded-1" style="max-height:420px"><code class="language-html">
&lt;!-- Find the JS file for the following chart at: src/js/charts/echarts/examples/radar-chart.js--&gt;

&lt;!-- If you are not using gulp based workflow, you can find the transpiled code at: public/assets/js/echarts-example.js--&gt;
&lt;div class=&quot;echart-radar-chart-example&quot; style=&quot;min-height: 300px;&quot; data-echart-responsive=&quot;true&quot;&gt;&lt;/div&gt;</code></pre>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-lg-12">
              <div class="card h-100" dir="ltr">
                <div class="card-header">
                  <div class="row flex-between-end">
                    <div class="col-auto align-self-center">
                      <h5 class="mb-0" data-anchor="data-anchor">Radar Customized Chart</h5>
                    </div>
                    <div class="col-auto ms-auto">
                      <div class="nav nav-pills nav-pills-falcon flex-grow-1" role="tablist">
                        <button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-07111466-094f-42a5-99ac-7cfcfb534304" type="button" role="tab" aria-controls="dom-07111466-094f-42a5-99ac-7cfcfb534304" aria-selected="true" id="tab-dom-07111466-094f-42a5-99ac-7cfcfb534304">Preview</button>
                        <button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-63f65c32-5489-4313-8201-de9fc49fb7b0" type="button" role="tab" aria-controls="dom-63f65c32-5489-4313-8201-de9fc49fb7b0" aria-selected="false" id="tab-dom-63f65c32-5489-4313-8201-de9fc49fb7b0">Code</button>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="card-body bg-light">
                  <div class="tab-content">
                    <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-07111466-094f-42a5-99ac-7cfcfb534304" id="dom-07111466-094f-42a5-99ac-7cfcfb534304">
                    ...
                    <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-63f65c32-5489-4313-8201-de9fc49fb7b0" id="dom-63f65c32-5489-4313-8201-de9fc49fb7b0">
                      <pre class="scrollbar rounded-1" style="max-height:420px"><code class="language-html">
&lt;!-- Find the JS file for the following chart at: src/js/charts/echarts/examples/radar-customized-chart.js--&gt;

&lt;!-- If you are not using gulp based workflow, you can find the transpiled code at: public/assets/js/echarts-example.js--&gt;
&lt;div class=&quot;echart-radar-customized-chart&quot; data-echart-responsive=&quot;true&quot;&gt;&lt;/div&gt;</code></pre>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-lg-12">
              <div class="card h-100" dir="ltr">
                <div class="card-header">
                  <div class="row flex-between-end">
                    <div class="col-auto align-self-center">
                      <h5 class="mb-0" data-anchor="data-anchor">Radar Multiple Chart</h5>
                    </div>
                    <div class="col-auto ms-auto">
                      <div class="nav nav-pills nav-pills-falcon flex-grow-1" role="tablist">
                        <button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-962f0c9a-6aad-4c24-aa4a-baf7b9961c35" type="button" role="tab" aria-controls="dom-962f0c9a-6aad-4c24-aa4a-baf7b9961c35" aria-selected="true" id="tab-dom-962f0c9a-6aad-4c24-aa4a-baf7b9961c35">Preview</button>
                        <button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-8583a456-615a-4cf2-b186-ba39a2a1c5bc" type="button" role="tab" aria-controls="dom-8583a456-615a-4cf2-b186-ba39a2a1c5bc" aria-selected="false" id="tab-dom-8583a456-615a-4cf2-b186-ba39a2a1c5bc">Code</button>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="card-body bg-light">
                  <div class="tab-content">
                    <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-962f0c9a-6aad-4c24-aa4a-baf7b9961c35" id="dom-962f0c9a-6aad-4c24-aa4a-baf7b9961c35">
                    ...
                    <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-8583a456-615a-4cf2-b186-ba39a2a1c5bc" id="dom-8583a456-615a-4cf2-b186-ba39a2a1c5bc">
                      <pre class="scrollbar rounded-1" style="max-height:420px"><code class="language-html">
&lt;!-- Find the JS file for the following chart at: src/js/charts/echarts/examples/radar-multiple-chart.js--&gt;

&lt;!-- If you are not using gulp based workflow, you can find the transpiled code at: public/assets/js/echarts-example.js--&gt;
&lt;div class=&quot;echart-radar-multiple-chart&quot; data-echart-responsive=&quot;true&quot;&gt;&lt;/div&gt;</code></pre>
                    </div>
                  </div>
                </div>
              </div>
