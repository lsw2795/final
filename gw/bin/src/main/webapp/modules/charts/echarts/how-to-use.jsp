                  ...
                  <ul class="nav collapse show" id="charts">
                    ...
                    <li class="nav-item"><a class="nav-link dropdown-indicator" href="#eCharts" data-bs-toggle="collapse" aria-expanded="true" aria-controls="charts">
                      ...
                      <ul class="nav collapse show" id="eCharts">
                        ...
                        <li class="nav-item"><a class="nav-link active" href="../../../modules/charts/echarts/how-to-use.jsp">
          ...
          <div class="card mb-3">
            ...
            <div class="card-body position-relative">
              <div class="row">
                <div class="col-lg-8">
                  <h3>How to use</h3>
                  <p class="mb-0">A powerful, interactive charting and visualization library for browser.</p><a class="btn btn-link btn-sm ps-0 mt-2" href="https://echarts.apache.org/en/option.jsp#title" target="_blank">Documentation for EChart<span class="fas fa-chevron-right ms-1 fs--2"></span></a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="card">
              ...
              <div class="row flex-between-end">
                ...
                <div class="col-auto ms-auto">
                  <div class="nav nav-pills nav-pills-falcon flex-grow-1 mt-2" role="tablist">
                    <button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-4e56c98a-b4c2-4c3d-b3bb-f60e5e0a4309" type="button" role="tab" aria-controls="dom-4e56c98a-b4c2-4c3d-b3bb-f60e5e0a4309" aria-selected="true" id="tab-dom-4e56c98a-b4c2-4c3d-b3bb-f60e5e0a4309">Preview</button>
                    <button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-e62cf205-28a4-4d84-bf53-dc796616674e" type="button" role="tab" aria-controls="dom-e62cf205-28a4-4d84-bf53-dc796616674e" aria-selected="false" id="tab-dom-e62cf205-28a4-4d84-bf53-dc796616674e">Code</button>
                  </div>
                </div>
              </div>
            </div>
            <div class="card-body bg-light">
              <div class="tab-content">
                <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-4e56c98a-b4c2-4c3d-b3bb-f60e5e0a4309" id="dom-4e56c98a-b4c2-4c3d-b3bb-f60e5e0a4309">
                ...
                <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-e62cf205-28a4-4d84-bf53-dc796616674e" id="dom-e62cf205-28a4-4d84-bf53-dc796616674e">
