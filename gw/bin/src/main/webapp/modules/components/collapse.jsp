              ...
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                ...
                <li class="nav-item">
                  ...
                  <ul class="nav collapse show" id="components">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="../../modules/components/collapse.jsp">
          ...
          <div class="card mb-3">
            ...
            <div class="card-body position-relative">
              <div class="row">
                <div class="col-lg-8">
                  <h3>Collapse</h3>
                  <p class="mb-0">Toggle the visibility of content with a few classes and Bootstrap's JavaScript plugins.</p><a class="btn btn-link btn-sm ps-0 mt-2" href="https://getbootstrap.com/docs/5.3/components/collapse/" target="_blank">Collapse on Bootstrap<span class="fas fa-chevron-right ms-1 fs--2"></span></a>
                </div>
              </div>
            </div>
          </div>
          <div class="card mb-3">
              ...
              <div class="row flex-between-end">
                ...
                <div class="col-auto ms-auto">
                  <div class="nav nav-pills nav-pills-falcon flex-grow-1" role="tablist">
                    <button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-2c35824b-959e-4f2e-bf40-997385c3083c" type="button" role="tab" aria-controls="dom-2c35824b-959e-4f2e-bf40-997385c3083c" aria-selected="true" id="tab-dom-2c35824b-959e-4f2e-bf40-997385c3083c">Preview</button>
                    <button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-845c7e71-8d45-43e8-834f-6a7b87458052" type="button" role="tab" aria-controls="dom-845c7e71-8d45-43e8-834f-6a7b87458052" aria-selected="false" id="tab-dom-845c7e71-8d45-43e8-834f-6a7b87458052">Code</button>
                  </div>
                </div>
              </div>
            </div>
            <div class="card-body bg-light">
              <div class="tab-content">
                <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-2c35824b-959e-4f2e-bf40-997385c3083c" id="dom-2c35824b-959e-4f2e-bf40-997385c3083c">
                  <p>
                ...
                <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-845c7e71-8d45-43e8-834f-6a7b87458052" id="dom-845c7e71-8d45-43e8-834f-6a7b87458052">
...
&lt;/div&gt;</code></pre>
          ...
          <div class="card mb-3">
              ...
              <div class="row flex-between-end">
                ...
                <div class="col-auto ms-auto">
                  <div class="nav nav-pills nav-pills-falcon flex-grow-1 mt-2" role="tablist">
                    <button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-6ec72424-8a5e-4b9d-b21b-79607a8eb317" type="button" role="tab" aria-controls="dom-6ec72424-8a5e-4b9d-b21b-79607a8eb317" aria-selected="true" id="tab-dom-6ec72424-8a5e-4b9d-b21b-79607a8eb317">Preview</button>
                    <button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-05d753cb-bf28-41f9-8068-2e1f4510b804" type="button" role="tab" aria-controls="dom-05d753cb-bf28-41f9-8068-2e1f4510b804" aria-selected="false" id="tab-dom-05d753cb-bf28-41f9-8068-2e1f4510b804">Code</button>
                  </div>
                </div>
              </div>
            </div>
            <div class="card-body bg-light">
              <div class="tab-content">
                <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-6ec72424-8a5e-4b9d-b21b-79607a8eb317" id="dom-6ec72424-8a5e-4b9d-b21b-79607a8eb317">
                ...
                <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-05d753cb-bf28-41f9-8068-2e1f4510b804" id="dom-05d753cb-bf28-41f9-8068-2e1f4510b804">
