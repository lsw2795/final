              ...
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                ...
                <li class="nav-item">
                  ...
                  <ul class="nav collapse show" id="components">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="../../modules/components/alerts.jsp">
          ...
          <div class="card mb-3">
              ...
              <div class="row flex-between-end">
                ...
                <div class="col-auto ms-auto">
                  <div class="nav nav-pills nav-pills-falcon flex-grow-1" role="tablist">
                    <button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-b7a7cf80-b80f-45ae-a183-1c8182f4fd2f" type="button" role="tab" aria-controls="dom-b7a7cf80-b80f-45ae-a183-1c8182f4fd2f" aria-selected="true" id="tab-dom-b7a7cf80-b80f-45ae-a183-1c8182f4fd2f">Preview</button>
                    <button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-59c9766e-36da-44a0-be22-65f93e84f190" type="button" role="tab" aria-controls="dom-59c9766e-36da-44a0-be22-65f93e84f190" aria-selected="false" id="tab-dom-59c9766e-36da-44a0-be22-65f93e84f190">Code</button>
                  </div>
                </div>
              </div>
            </div>
            <div class="card-body bg-light">
              <div class="tab-content">
                <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-b7a7cf80-b80f-45ae-a183-1c8182f4fd2f" id="dom-b7a7cf80-b80f-45ae-a183-1c8182f4fd2f">
                  ...
                  <div class="alert alert-info border-2 d-flex align-items-center" role="alert">
                    ...
                    <p class="mb-0 flex-1">A simple info alert—check it out!</p>
                    <button class="btn-close" type="button" data-bs-dismiss="alert" aria-label="Close"></button>
                  </div>
                  <div class="alert alert-warning border-2 d-flex align-items-center" role="alert">
                    <div class="bg-warning me-3 icon-item"><span class="fas fa-exclamation-circle text-white fs-3"></span></div>
                    <p class="mb-0 flex-1">A simple warning alert—check it out!</p>
                    <button class="btn-close" type="button" data-bs-dismiss="alert" aria-label="Close"></button>
                  </div>
                ...
                <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-59c9766e-36da-44a0-be22-65f93e84f190" id="dom-59c9766e-36da-44a0-be22-65f93e84f190">
...
&lt;/div&gt;</code></pre>
          ...
          <div class="card mb-3">
              ...
              <div class="row flex-between-end">
                ...
                <div class="col-auto ms-auto">
                  <div class="nav nav-pills nav-pills-falcon flex-grow-1 mt-2" role="tablist">
                    <button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-ecf3358a-a266-4db6-ac6f-75ef58e1d335" type="button" role="tab" aria-controls="dom-ecf3358a-a266-4db6-ac6f-75ef58e1d335" aria-selected="true" id="tab-dom-ecf3358a-a266-4db6-ac6f-75ef58e1d335">Preview</button>
                    <button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-31fc8126-854d-4010-b558-01dc47745eb0" type="button" role="tab" aria-controls="dom-31fc8126-854d-4010-b558-01dc47745eb0" aria-selected="false" id="tab-dom-31fc8126-854d-4010-b558-01dc47745eb0">Code</button>
                  </div>
                </div>
              </div>
            </div>
            <div class="card-body bg-light">
              <div class="tab-content">
                <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-ecf3358a-a266-4db6-ac6f-75ef58e1d335" id="dom-ecf3358a-a266-4db6-ac6f-75ef58e1d335">
                ...
                <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-31fc8126-854d-4010-b558-01dc47745eb0" id="dom-31fc8126-854d-4010-b558-01dc47745eb0">
                  <pre class="scrollbar rounded-1" style="max-height:420px"><code class="language-html">&lt;div class=&quot;alert alert-primary&quot; role=&quot;alert&quot;&gt;A simple primary alert—check it out!&lt;/div&gt;
&lt;div class=&quot;alert alert-secondary&quot; role=&quot;alert&quot;&gt;A simple secondary alert—check it out!&lt;/div&gt;
&lt;div class=&quot;alert alert-success&quot; role=&quot;alert&quot;&gt;A simple success alert—check it out!&lt;/div&gt;
&lt;div class=&quot;alert alert-danger&quot; role=&quot;alert&quot;&gt;A simple danger alert—check it out!&lt;/div&gt;
&lt;div class=&quot;alert alert-warning&quot; role=&quot;alert&quot;&gt;A simple warning alert—check it out!&lt;/div&gt;
          ...
          <div class="card mb-3">
            <div class="card-header">
              <div class="row flex-between-end">
                ...
                <div class="col-auto ms-auto">
                  <div class="nav nav-pills nav-pills-falcon flex-grow-1" role="tablist">
                    <button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-13db9166-6832-42ef-923c-249157924ab3" type="button" role="tab" aria-controls="dom-13db9166-6832-42ef-923c-249157924ab3" aria-selected="true" id="tab-dom-13db9166-6832-42ef-923c-249157924ab3">Preview</button>
                    <button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-bb4ac396-7ac2-483b-b97f-d9b5068b1c77" type="button" role="tab" aria-controls="dom-bb4ac396-7ac2-483b-b97f-d9b5068b1c77" aria-selected="false" id="tab-dom-bb4ac396-7ac2-483b-b97f-d9b5068b1c77">Code</button>
                  </div>
                </div>
              </div>
            </div>
            <div class="card-body bg-light">
              <div class="tab-content">
                <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-13db9166-6832-42ef-923c-249157924ab3" id="dom-13db9166-6832-42ef-923c-249157924ab3">
                ...
                <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-bb4ac396-7ac2-483b-b97f-d9b5068b1c77" id="dom-bb4ac396-7ac2-483b-b97f-d9b5068b1c77">
          ...
          <div class="card mb-3">
            <div class="card-header">
              <div class="row flex-between-end">
                ...
                <div class="col-auto ms-auto">
                  <div class="nav nav-pills nav-pills-falcon flex-grow-1" role="tablist">
                    <button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-72c13b9f-e1eb-4bf8-a5fe-e0db60eec899" type="button" role="tab" aria-controls="dom-72c13b9f-e1eb-4bf8-a5fe-e0db60eec899" aria-selected="true" id="tab-dom-72c13b9f-e1eb-4bf8-a5fe-e0db60eec899">Preview</button>
                    <button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-65bb6ee8-7f7f-479d-a675-5c4f2b5feea4" type="button" role="tab" aria-controls="dom-65bb6ee8-7f7f-479d-a675-5c4f2b5feea4" aria-selected="false" id="tab-dom-65bb6ee8-7f7f-479d-a675-5c4f2b5feea4">Code</button>
                  </div>
                </div>
              </div>
            </div>
            <div class="card-body bg-light">
              <div class="tab-content">
                <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-72c13b9f-e1eb-4bf8-a5fe-e0db60eec899" id="dom-72c13b9f-e1eb-4bf8-a5fe-e0db60eec899">
                ...
                <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-65bb6ee8-7f7f-479d-a675-5c4f2b5feea4" id="dom-65bb6ee8-7f7f-479d-a675-5c4f2b5feea4">
