              ...
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                ...
                <li class="nav-item">
                  ...
                  <ul class="nav collapse show" id="components">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="../../modules/components/buttons.jsp">
          ...
          <div class="card mb-3">
            ...
            <div class="card-body position-relative">
              <div class="row">
                <div class="col-lg-8">
                  <h3>Buttons</h3>
                  <p class="mb-0">Use Falcon custom button styles for actions in forms, dialogs, and more with support for multiple sizes, states, and more.</p><a class="btn btn-link btn-sm ps-0 mt-2" href="https://getbootstrap.com/docs/5.3/components/buttons/" target="_blank">Buttons on Bootstrap<span class="fas fa-chevron-right ms-1 fs--2"></span></a>
                </div>
              </div>
            </div>
          </div>
          <div class="card mb-3">
            <div class="card-header">
              <div class="row flex-between-end">
                <div class="col-auto align-self-center">
                  <h5 class="mb-0" data-anchor="data-anchor">Falcon Buttons</h5>
                </div>
                <div class="col-auto ms-auto">
                  <div class="nav nav-pills nav-pills-falcon flex-grow-1" role="tablist">
                    <button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-409e6e9e-21d1-44b1-aeed-c512a508b49d" type="button" role="tab" aria-controls="dom-409e6e9e-21d1-44b1-aeed-c512a508b49d" aria-selected="true" id="tab-dom-409e6e9e-21d1-44b1-aeed-c512a508b49d">Preview</button>
                    <button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-7640cafc-aec0-410b-ac5a-6ba13684b94b" type="button" role="tab" aria-controls="dom-7640cafc-aec0-410b-ac5a-6ba13684b94b" aria-selected="false" id="tab-dom-7640cafc-aec0-410b-ac5a-6ba13684b94b">Code</button>
                  </div>
                </div>
              </div>
            </div>
            <div class="card-body bg-light">
              <div class="tab-content">
                <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-409e6e9e-21d1-44b1-aeed-c512a508b49d" id="dom-409e6e9e-21d1-44b1-aeed-c512a508b49d">
                ...
                <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-7640cafc-aec0-410b-ac5a-6ba13684b94b" id="dom-7640cafc-aec0-410b-ac5a-6ba13684b94b">
                  <pre class="scrollbar rounded-1" style="max-height:420px"><code class="language-html">&lt;button class=&quot;btn btn-falcon-primary me-1 mb-1&quot; type=&quot;button&quot;&gt;Primary
&lt;/button&gt;
&lt;button class=&quot;btn btn-falcon-success me-1 mb-1&quot; type=&quot;button&quot;&gt;Success
&lt;/button&gt;
&lt;button class=&quot;btn btn-falcon-info me-1 mb-1&quot; type=&quot;button&quot;&gt;Info
...
&lt;/button&gt;</code></pre>
          ...
          <div class="card mb-3">
            <div class="card-header">
              <div class="row flex-between-end">
                <div class="col-auto align-self-center">
                  <h5 class="mb-0" data-anchor="data-anchor">Solid Buttons</h5>
                </div>
                <div class="col-auto ms-auto">
                  <div class="nav nav-pills nav-pills-falcon flex-grow-1" role="tablist">
                    <button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-88c78677-bc94-4a25-94e0-2cb20bf23701" type="button" role="tab" aria-controls="dom-88c78677-bc94-4a25-94e0-2cb20bf23701" aria-selected="true" id="tab-dom-88c78677-bc94-4a25-94e0-2cb20bf23701">Preview</button>
                    <button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-9fc26044-a41d-4616-8b9a-84de6f0f89c2" type="button" role="tab" aria-controls="dom-9fc26044-a41d-4616-8b9a-84de6f0f89c2" aria-selected="false" id="tab-dom-9fc26044-a41d-4616-8b9a-84de6f0f89c2">Code</button>
                  </div>
                </div>
              </div>
            </div>
            <div class="card-body bg-light">
              <div class="tab-content">
                <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-88c78677-bc94-4a25-94e0-2cb20bf23701" id="dom-88c78677-bc94-4a25-94e0-2cb20bf23701">
                  ...
                  </button><br class='d-none d-xl-block d-xxl-none' />
                ...
                <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-9fc26044-a41d-4616-8b9a-84de6f0f89c2" id="dom-9fc26044-a41d-4616-8b9a-84de6f0f89c2">
                  <pre class="scrollbar rounded-1" style="max-height:420px"><code class="language-html">&lt;button class=&quot;btn btn-primary me-1 mb-1&quot; type=&quot;button&quot;&gt;Primary
&lt;/button&gt;
&lt;button class=&quot;btn btn-secondary me-1 mb-1&quot; type=&quot;button&quot;&gt;Secondary
&lt;/button&gt;
&lt;button class=&quot;btn btn-success me-1 mb-1&quot; type=&quot;button&quot;&gt;Success
...
&lt;/button&gt;</code></pre>
          ...
          <div class="card mb-3">
            <div class="card-header">
              <div class="row flex-between-end">
                <div class="col-auto align-self-center">
                  <h5 class="mb-0" data-anchor="data-anchor">Outline Buttons</h5>
                  <p class="mb-0 pt-1 mt-2 mb-0">In need of a button, but not the hefty background colors they bring? Replace the default modifier classes with the <code> .btn-outline-* </code> ones to remove all background images and colors on any button.</p>
                </div>
                <div class="col-auto ms-auto">
                  <div class="nav nav-pills nav-pills-falcon flex-grow-1 mt-2" role="tablist">
                    <button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-73e1a31d-4149-4dc2-a0ba-3d4befb42471" type="button" role="tab" aria-controls="dom-73e1a31d-4149-4dc2-a0ba-3d4befb42471" aria-selected="true" id="tab-dom-73e1a31d-4149-4dc2-a0ba-3d4befb42471">Preview</button>
                    <button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-a5cb2d4e-396b-4704-8887-2c49106d8f9b" type="button" role="tab" aria-controls="dom-a5cb2d4e-396b-4704-8887-2c49106d8f9b" aria-selected="false" id="tab-dom-a5cb2d4e-396b-4704-8887-2c49106d8f9b">Code</button>
                  </div>
                </div>
              </div>
            </div>
            <div class="card-body bg-light">
              <div class="tab-content">
                <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-73e1a31d-4149-4dc2-a0ba-3d4befb42471" id="dom-73e1a31d-4149-4dc2-a0ba-3d4befb42471">
                ...
                <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-a5cb2d4e-396b-4704-8887-2c49106d8f9b" id="dom-a5cb2d4e-396b-4704-8887-2c49106d8f9b">
                  <pre class="scrollbar rounded-1" style="max-height:420px"><code class="language-html">&lt;button class=&quot;btn btn-outline-primary me-1 mb-1&quot; type=&quot;button&quot;&gt;Primary
&lt;/button&gt;
&lt;button class=&quot;btn btn-outline-secondary me-1 mb-1&quot; type=&quot;button&quot;&gt;Secondary
&lt;/button&gt;
&lt;button class=&quot;btn btn-outline-success me-1 mb-1&quot; type=&quot;button&quot;&gt;Success
...
&lt;/button&gt;</code></pre>
          ...
          <div class="card mb-3">
            <div class="card-header">
              <div class="row flex-between-end">
                <div class="col-auto align-self-center">
                  <h5 class="mb-0" data-anchor="data-anchor">Close Buttons</h5>
                  <p class="mb-0 pt-1 mt-2 mb-0"><strong>Be sure to include text for screen readers</strong>, as we’ve done with <code>aria-label</code>. Disabled close buttons have <code>pointer-events: none </code>and <code>user-select: none</code> applied to, preventing hover and active states from triggering.</p>
                </div>
                <div class="col-auto ms-auto">
                  <div class="nav nav-pills nav-pills-falcon flex-grow-1 mt-2" role="tablist">
                    <button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-b7fc6d1b-386b-4f2f-bf8f-90a35959383f" type="button" role="tab" aria-controls="dom-b7fc6d1b-386b-4f2f-bf8f-90a35959383f" aria-selected="true" id="tab-dom-b7fc6d1b-386b-4f2f-bf8f-90a35959383f">Preview</button>
                    <button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-15062bb5-f43c-4baa-829a-1c38a9176a42" type="button" role="tab" aria-controls="dom-15062bb5-f43c-4baa-829a-1c38a9176a42" aria-selected="false" id="tab-dom-15062bb5-f43c-4baa-829a-1c38a9176a42">Code</button>
                  </div>
                </div>
              </div>
            </div>
            <div class="card-body bg-light">
              <div class="tab-content">
                <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-b7fc6d1b-386b-4f2f-bf8f-90a35959383f" id="dom-b7fc6d1b-386b-4f2f-bf8f-90a35959383f">
                  <button class="btn-close" type="button" aria-label="Close"></button>
                  <button class="btn-close" type="button" disabled="" aria-label="Close"></button>
                </div>
                <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-15062bb5-f43c-4baa-829a-1c38a9176a42" id="dom-15062bb5-f43c-4baa-829a-1c38a9176a42">
                  <pre class="scrollbar rounded-1" style="max-height:420px"><code class="language-html">&lt;button class=&quot;btn-close&quot; type=&quot;button&quot; aria-label=&quot;Close&quot;&gt;&lt;/button&gt;
&lt;button class=&quot;btn-close&quot; type=&quot;button&quot; disabled=&quot;&quot; aria-label=&quot;Close&quot;&gt;&lt;/button&gt;</code></pre>
          ...
          <div class="card mb-3">
            <div class="card-header">
              <div class="row flex-between-end">
                <div class="col-auto align-self-center">
                  <h5 class="mb-0" data-anchor="data-anchor">Close buttons white variant</h5>
                  <p class="mb-0 pt-1 mt-2 mb-0">Change the default <code>.btn-close </code>to be white with the <code>.btn-close-white </code>class. This class uses the <code>backdrop-filter </code>property to invert the <code>background-image.</code></p>
                </div>
                <div class="col-auto ms-auto">
                  <div class="nav nav-pills nav-pills-falcon flex-grow-1 mt-2" role="tablist">
                    <button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-0ffdd98c-f8f4-4e24-8f02-81c0d9306523" type="button" role="tab" aria-controls="dom-0ffdd98c-f8f4-4e24-8f02-81c0d9306523" aria-selected="true" id="tab-dom-0ffdd98c-f8f4-4e24-8f02-81c0d9306523">Preview</button>
                    <button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-7840c5da-d988-4710-b77d-d7ab4ec71823" type="button" role="tab" aria-controls="dom-7840c5da-d988-4710-b77d-d7ab4ec71823" aria-selected="false" id="tab-dom-7840c5da-d988-4710-b77d-d7ab4ec71823">Code</button>
                  </div>
                </div>
              </div>
            </div>
            <div class="card-body bg-light">
              <div class="tab-content">
                <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-0ffdd98c-f8f4-4e24-8f02-81c0d9306523" id="dom-0ffdd98c-f8f4-4e24-8f02-81c0d9306523">
                ...
                <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-7840c5da-d988-4710-b77d-d7ab4ec71823" id="dom-7840c5da-d988-4710-b77d-d7ab4ec71823">
                  <pre class="scrollbar rounded-1" style="max-height:420px"><code class="language-html">&lt;div class=&quot;bg-1000 rounded-1 p-3&quot; data-bs-theme=&quot;light&quot;&gt;
  &lt;button class=&quot;btn-close btn-close-white&quot; type=&quot;button&quot; aria-label=&quot;Close&quot;&gt;&lt;/button&gt;
  &lt;button class=&quot;btn-close btn-close-white&quot; type=&quot;button&quot; disabled=&quot;&quot; aria-label=&quot;Close&quot;&gt;&lt;/button&gt;
&lt;/div&gt;</code></pre>
                </div>
          ...
          <div class="card mb-3">
            <div class="card-header">
              <div class="row flex-between-end">
                <div class="col-auto align-self-center">
                  <h5 class="mb-0" data-anchor="data-anchor">Falcon close button</h5>
                  <p class="mb-0 pt-1 mt-2 mb-0">Falcon close button is properly optimized for both light and dark mode. Use <code> .btn-close-falcon </code> class for falcon close button.</p>
                </div>
                <div class="col-auto ms-auto">
                  <div class="nav nav-pills nav-pills-falcon flex-grow-1 mt-2" role="tablist">
                    <button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-fb07a4e8-782b-45d8-82ef-ff7ddfdef473" type="button" role="tab" aria-controls="dom-fb07a4e8-782b-45d8-82ef-ff7ddfdef473" aria-selected="true" id="tab-dom-fb07a4e8-782b-45d8-82ef-ff7ddfdef473">Preview</button>
                    <button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-1d697561-f3b4-420d-892e-cfd76b625ae2" type="button" role="tab" aria-controls="dom-1d697561-f3b4-420d-892e-cfd76b625ae2" aria-selected="false" id="tab-dom-1d697561-f3b4-420d-892e-cfd76b625ae2">Code</button>
                  </div>
                </div>
              </div>
            </div>
            <div class="card-body bg-light">
              <div class="tab-content">
                <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-fb07a4e8-782b-45d8-82ef-ff7ddfdef473" id="dom-fb07a4e8-782b-45d8-82ef-ff7ddfdef473">
                  <div class="btn-close-falcon"></div>
                </div>
                <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-1d697561-f3b4-420d-892e-cfd76b625ae2" id="dom-1d697561-f3b4-420d-892e-cfd76b625ae2">
                  <pre class="scrollbar rounded-1" style="max-height:420px"><code class="language-html">&lt;div class=&quot;btn-close-falcon&quot;&gt;&lt;/div&gt;</code></pre>
                </div>
              </div>
            </div>
          </div>
          <div class="card mb-3">
            <div class="card-header">
              <div class="row flex-between-end">
                <div class="col-auto align-self-center">
                  <h5 class="mb-0" data-anchor="data-anchor">Button Sizes</h5>
                  <p class="mb-0 pt-1 mt-2 mb-0">Fancy larger or smaller buttons? Add <code>.btn-lg</code> or <code>.btn-sm</code> for additional sizes.</p>
                </div>
                <div class="col-auto ms-auto">
                  <div class="nav nav-pills nav-pills-falcon flex-grow-1 mt-2" role="tablist">
                    <button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-b4faf1b5-54d2-494d-b230-ba2822299467" type="button" role="tab" aria-controls="dom-b4faf1b5-54d2-494d-b230-ba2822299467" aria-selected="true" id="tab-dom-b4faf1b5-54d2-494d-b230-ba2822299467">Preview</button>
                    <button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-8b98ad08-e4e9-4de4-b09c-f61ca03fab44" type="button" role="tab" aria-controls="dom-8b98ad08-e4e9-4de4-b09c-f61ca03fab44" aria-selected="false" id="tab-dom-8b98ad08-e4e9-4de4-b09c-f61ca03fab44">Code</button>
                  </div>
                </div>
              </div>
            </div>
            <div class="card-body bg-light">
              <div class="tab-content">
                <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-b4faf1b5-54d2-494d-b230-ba2822299467" id="dom-b4faf1b5-54d2-494d-b230-ba2822299467">
                ...
                <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-8b98ad08-e4e9-4de4-b09c-f61ca03fab44" id="dom-8b98ad08-e4e9-4de4-b09c-f61ca03fab44">
                  <pre class="scrollbar rounded-1" style="max-height:420px"><code class="language-html">&lt;div class=&quot;btn btn-secondary btn-sm&quot;&gt;Small&lt;/div&gt;
&lt;div class=&quot;btn btn-secondary&quot;&gt;Regular&lt;/div&gt;
&lt;div class=&quot;btn btn-secondary btn-lg&quot;&gt;Large&lt;/div&gt;</code></pre>
                </div>
              </div>
            </div>
          </div>
          <div class="card mb-3">
            <div class="card-header">
              <div class="row flex-between-end">
                <div class="col-auto align-self-center">
                  <h5 class="mb-0" data-anchor="data-anchor">Icon Buttons</h5>
                </div>
                <div class="col-auto ms-auto">
                  <div class="nav nav-pills nav-pills-falcon flex-grow-1" role="tablist">
                    <button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-96a9d025-c7c5-4830-a461-b3a60f3a9899" type="button" role="tab" aria-controls="dom-96a9d025-c7c5-4830-a461-b3a60f3a9899" aria-selected="true" id="tab-dom-96a9d025-c7c5-4830-a461-b3a60f3a9899">Preview</button>
                    <button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-63de23a4-cccd-4364-a7bb-75f21bb75505" type="button" role="tab" aria-controls="dom-63de23a4-cccd-4364-a7bb-75f21bb75505" aria-selected="false" id="tab-dom-63de23a4-cccd-4364-a7bb-75f21bb75505">Code</button>
                  </div>
                </div>
              </div>
            </div>
            <div class="card-body bg-light">
              <div class="tab-content">
                <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-96a9d025-c7c5-4830-a461-b3a60f3a9899" id="dom-96a9d025-c7c5-4830-a461-b3a60f3a9899">
                ...
                <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-63de23a4-cccd-4364-a7bb-75f21bb75505" id="dom-63de23a4-cccd-4364-a7bb-75f21bb75505">
                  <pre class="scrollbar rounded-1" style="max-height:420px"><code class="language-html">&lt;button class=&quot;btn btn-falcon-default btn-sm me-1 mb-1&quot; type=&quot;button&quot;&gt;
  &lt;span class=&quot;fas fa-plus me-1&quot; data-fa-transform=&quot;shrink-3&quot;&gt;&lt;/span&gt;Small
&lt;/button&gt;
&lt;button class=&quot;btn btn-falcon-default me-1 mb-1&quot; type=&quot;button&quot;&gt;
  &lt;span class=&quot;fas fa-plus me-1&quot; data-fa-transform=&quot;shrink-3&quot;&gt;&lt;/span&gt;Regular
...
&lt;/button&gt;</code></pre>
          ...
          <div class="card mb-3">
            <div class="card-header">
              <div class="row flex-between-end">
                <div class="col-auto align-self-center">
                  <h5 class="mb-0" data-anchor="data-anchor">Button Capsule</h5>
                </div>
                <div class="col-auto ms-auto">
                  <div class="nav nav-pills nav-pills-falcon flex-grow-1" role="tablist">
                    <button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-f56ccc31-3792-436a-adab-f80bddeed8a0" type="button" role="tab" aria-controls="dom-f56ccc31-3792-436a-adab-f80bddeed8a0" aria-selected="true" id="tab-dom-f56ccc31-3792-436a-adab-f80bddeed8a0">Preview</button>
                    <button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-222ef555-dccc-48b9-9e10-51fdb8c14351" type="button" role="tab" aria-controls="dom-222ef555-dccc-48b9-9e10-51fdb8c14351" aria-selected="false" id="tab-dom-222ef555-dccc-48b9-9e10-51fdb8c14351">Code</button>
                  </div>
                </div>
              </div>
            </div>
            <div class="card-body bg-light">
              <div class="tab-content">
                <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-f56ccc31-3792-436a-adab-f80bddeed8a0" id="dom-f56ccc31-3792-436a-adab-f80bddeed8a0">
                ...
                <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-222ef555-dccc-48b9-9e10-51fdb8c14351" id="dom-222ef555-dccc-48b9-9e10-51fdb8c14351">
                  <pre class="scrollbar rounded-1" style="max-height:420px"><code class="language-html">&lt;button class=&quot;btn btn-falcon-default rounded-pill me-1 mb-1&quot; type=&quot;button&quot;&gt;Example
&lt;/button&gt;
&lt;button class=&quot;btn btn-falcon-default rounded-pill me-1 mb-1&quot; type=&quot;button&quot;&gt;
  &lt;span class=&quot;fas fa-align-left me-1&quot; data-fa-transform=&quot;shrink-3&quot;&gt;&lt;/span&gt;Icon Left
&lt;/button&gt;
...
&lt;button class=&quot;btn btn-sm btn-falcon-default rounded-pill me-1 mb-1&quot; type=&quot;button&quot;&gt;Capsule Small&lt;/button&gt;
&lt;button class=&quot;btn btn-falcon-default rounded-pill me-1 mb-1&quot; type=&quot;button&quot;&gt;Capsule Regular&lt;/button&gt;
&lt;button class=&quot;btn btn-lg btn-falcon-default rounded-pill me-1 mb-1&quot; type=&quot;button&quot;&gt;Capsule Large&lt;/button&gt;</code></pre>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="card-body position-relative">
              <div class="row">
                <div class="col-lg-8">
                  ...
                  <p class="mb-0">Group a series of buttons together on a single line with the button group, and super-power them with JavaScript.</p><a class="btn btn-link btn-sm ps-0 mt-2" href="https://getbootstrap.com/docs/5.3/components/button-group/" target="_blank">Button-Group on Bootstrap<span class="fas fa-chevron-right ms-1 fs--2"></span></a>
                </div>
              </div>
            </div>
          </div>
          <div class="card mb-3">
            <div class="card-header">
              <div class="row flex-between-end">
                <div class="col-auto align-self-center">
                  ...
                  <p class="mb-0 pt-1 mt-2 mb-0">Wrap a series of buttons with <code>.btn</code> in<code>.btn-group</code>. Add on optional JavaScript radio and checkbox style behavior with</p>
                </div>
                <div class="col-auto ms-auto">
                  <div class="nav nav-pills nav-pills-falcon flex-grow-1 mt-2" role="tablist">
                    <button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-4bed3c73-4942-4f47-ab35-97db3026a175" type="button" role="tab" aria-controls="dom-4bed3c73-4942-4f47-ab35-97db3026a175" aria-selected="true" id="tab-dom-4bed3c73-4942-4f47-ab35-97db3026a175">Preview</button>
                    <button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-f9000d8a-1c96-4829-bacc-3a2f4f29e388" type="button" role="tab" aria-controls="dom-f9000d8a-1c96-4829-bacc-3a2f4f29e388" aria-selected="false" id="tab-dom-f9000d8a-1c96-4829-bacc-3a2f4f29e388">Code</button>
                  </div>
                </div>
              </div>
            </div>
            <div class="card-body bg-light">
              <div class="tab-content">
                <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-4bed3c73-4942-4f47-ab35-97db3026a175" id="dom-4bed3c73-4942-4f47-ab35-97db3026a175">
                ...
                <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-f9000d8a-1c96-4829-bacc-3a2f4f29e388" id="dom-f9000d8a-1c96-4829-bacc-3a2f4f29e388">
                  <pre class="scrollbar rounded-1" style="max-height:420px"><code class="language-html">&lt;div class=&quot;btn-group&quot; role=&quot;group&quot; aria-label=&quot;Basic example&quot;&gt;
  &lt;button class=&quot;btn btn-secondary&quot; type=&quot;button&quot;&gt;Left&lt;/button&gt;
  &lt;button class=&quot;btn btn-secondary&quot; type=&quot;button&quot;&gt;Middle&lt;/button&gt;
  &lt;button class=&quot;btn btn-secondary&quot; type=&quot;button&quot;&gt;Right&lt;/button&gt;
&lt;/div&gt;</code></pre>
          ...
          <div class="card mb-3">
            <div class="card-header">
              <div class="row flex-between-end">
                <div class="col-auto align-self-center">
                  <h5 class="mb-0" data-anchor="data-anchor">Button Toolbar</h5>
                  <p class="mb-0 pt-1 mt-2 mb-0">Combine sets of button groups into button toolbars for more complex components. Use utility classes as needed to space out groups, buttons, and more.</p>
                </div>
                <div class="col-auto ms-auto">
                  <div class="nav nav-pills nav-pills-falcon flex-grow-1 mt-2" role="tablist">
                    <button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-80b28099-92b9-4a96-976f-1239ee124908" type="button" role="tab" aria-controls="dom-80b28099-92b9-4a96-976f-1239ee124908" aria-selected="true" id="tab-dom-80b28099-92b9-4a96-976f-1239ee124908">Preview</button>
                    <button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-0e6baa4e-cabe-4178-a5f2-34d9365044d6" type="button" role="tab" aria-controls="dom-0e6baa4e-cabe-4178-a5f2-34d9365044d6" aria-selected="false" id="tab-dom-0e6baa4e-cabe-4178-a5f2-34d9365044d6">Code</button>
                  </div>
                </div>
              </div>
            </div>
            <div class="card-body bg-light">
              <div class="tab-content">
                <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-80b28099-92b9-4a96-976f-1239ee124908" id="dom-80b28099-92b9-4a96-976f-1239ee124908">
                ...
                <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-0e6baa4e-cabe-4178-a5f2-34d9365044d6" id="dom-0e6baa4e-cabe-4178-a5f2-34d9365044d6">
                  <pre class="scrollbar rounded-1" style="max-height:420px"><code class="language-html">&lt;div class=&quot;btn-toolbar&quot; role=&quot;toolbar&quot; aria-label=&quot;Toolbar with button groups&quot;&gt;
  &lt;div class=&quot;btn-group me-2 mb-2&quot; role=&quot;group&quot; aria-label=&quot;First group&quot;&gt;
    &lt;button class=&quot;btn btn-secondary&quot; type=&quot;button&quot;&gt;1&lt;/button&gt;
    &lt;button class=&quot;btn btn-secondary&quot; type=&quot;button&quot;&gt;2&lt;/button&gt;
    &lt;button class=&quot;btn btn-secondary&quot; type=&quot;button&quot;&gt;3&lt;/button&gt;
...
&lt;/div&gt;</code></pre>
          ...
          <div class="card mb-3">
            <div class="card-header">
              <div class="row flex-between-end">
                <div class="col-auto align-self-center">
                  <h5 class="mb-0" data-anchor="data-anchor">Button toolbar with input group</h5>
                  <p class="mb-0 pt-1 mt-2 mb-0">Feel free to mix input groups with button groups in your toolbars. Similar to the example above, you'll likely need some utilities though to space things properly.</p>
                </div>
                <div class="col-auto ms-auto">
                  <div class="nav nav-pills nav-pills-falcon flex-grow-1 mt-2" role="tablist">
                    <button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-828d2a69-de26-458b-9d5a-2fff2f262a27" type="button" role="tab" aria-controls="dom-828d2a69-de26-458b-9d5a-2fff2f262a27" aria-selected="true" id="tab-dom-828d2a69-de26-458b-9d5a-2fff2f262a27">Preview</button>
                    <button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-111be34b-6b12-4fe8-808c-ea1185814b89" type="button" role="tab" aria-controls="dom-111be34b-6b12-4fe8-808c-ea1185814b89" aria-selected="false" id="tab-dom-111be34b-6b12-4fe8-808c-ea1185814b89">Code</button>
                  </div>
                </div>
              </div>
            </div>
            <div class="card-body bg-light">
              <div class="tab-content">
                <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-828d2a69-de26-458b-9d5a-2fff2f262a27" id="dom-828d2a69-de26-458b-9d5a-2fff2f262a27">
                ...
                <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-111be34b-6b12-4fe8-808c-ea1185814b89" id="dom-111be34b-6b12-4fe8-808c-ea1185814b89">
                  <pre class="scrollbar rounded-1" style="max-height:420px"><code class="language-html">&lt;div class=&quot;btn-toolbar mb-3&quot; role=&quot;toolbar&quot; aria-label=&quot;Toolbar with button groups&quot;&gt;
  &lt;div class=&quot;btn-group mb-2 me-2&quot; role=&quot;group&quot; aria-label=&quot;First group&quot;&gt;
    &lt;button class=&quot;btn btn-secondary&quot; type=&quot;button&quot;&gt;1&lt;/button&gt;
    &lt;button class=&quot;btn btn-secondary&quot; type=&quot;button&quot;&gt;2&lt;/button&gt;
    &lt;button class=&quot;btn btn-secondary&quot; type=&quot;button&quot;&gt;3&lt;/button&gt;
...
&lt;/div&gt;</code></pre>
          ...
          <div class="card mb-3">
            <div class="card-header">
              <div class="row flex-between-end">
                <div class="col-auto align-self-center">
                  ...
                  <p class="mb-0 pt-1 mt-2 mb-0">Instead of aplying button sizing classes to every button in a group, just add <code>.btn-gorup-* </code>to each <code>.btn-group</code>, including each one when nesting multiple groups.</p>
                </div>
                <div class="col-auto ms-auto">
                  <div class="nav nav-pills nav-pills-falcon flex-grow-1 mt-2" role="tablist">
                    <button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-81e46334-13a6-43ac-b6f9-688194d96214" type="button" role="tab" aria-controls="dom-81e46334-13a6-43ac-b6f9-688194d96214" aria-selected="true" id="tab-dom-81e46334-13a6-43ac-b6f9-688194d96214">Preview</button>
                    <button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-810de562-61d6-47b3-a59f-93d13e82de5d" type="button" role="tab" aria-controls="dom-810de562-61d6-47b3-a59f-93d13e82de5d" aria-selected="false" id="tab-dom-810de562-61d6-47b3-a59f-93d13e82de5d">Code</button>
                  </div>
                </div>
              </div>
            </div>
            <div class="card-body bg-light">
              <div class="tab-content">
                <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-81e46334-13a6-43ac-b6f9-688194d96214" id="dom-81e46334-13a6-43ac-b6f9-688194d96214">
                ...
                <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-810de562-61d6-47b3-a59f-93d13e82de5d" id="dom-810de562-61d6-47b3-a59f-93d13e82de5d">
                  <pre class="scrollbar rounded-1" style="max-height:420px"><code class="language-html">&lt;div class=&quot;btn-group btn-group-lg&quot; role=&quot;group&quot; aria-label=&quot;...&quot;&gt;
  &lt;button class=&quot;btn btn-secondary&quot; type=&quot;button&quot;&gt;Left&lt;/button&gt;
  &lt;button class=&quot;btn btn-secondary&quot; type=&quot;button&quot;&gt;Middle&lt;/button&gt;
  &lt;button class=&quot;btn btn-secondary&quot; type=&quot;button&quot;&gt;Right&lt;/button&gt;
&lt;/div&gt;
...
&lt;/div&gt;</code></pre>
          ...
          <div class="card mb-3">
            <div class="card-header">
              <div class="row flex-between-end">
                <div class="col-auto align-self-center">
                  <h5 class="mb-0" data-anchor="data-anchor">Vertical variation</h5>
                  <p class="mb-0 pt-1 mt-2 mb-0">Make a set of buttons appear vertically tacked rather than horizontally. Split button dropdowns ae not supported here.</p>
                </div>
                <div class="col-auto ms-auto">
                  <div class="nav nav-pills nav-pills-falcon flex-grow-1 mt-2" role="tablist">
                    <button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-29c94584-ced5-48e4-b5e9-f643b88643ec" type="button" role="tab" aria-controls="dom-29c94584-ced5-48e4-b5e9-f643b88643ec" aria-selected="true" id="tab-dom-29c94584-ced5-48e4-b5e9-f643b88643ec">Preview</button>
                    <button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-1753adb4-60d8-4b8b-889a-b59421a9ac70" type="button" role="tab" aria-controls="dom-1753adb4-60d8-4b8b-889a-b59421a9ac70" aria-selected="false" id="tab-dom-1753adb4-60d8-4b8b-889a-b59421a9ac70">Code</button>
                  </div>
                </div>
              </div>
            </div>
            <div class="card-body bg-light">
              <div class="tab-content">
                <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-29c94584-ced5-48e4-b5e9-f643b88643ec" id="dom-29c94584-ced5-48e4-b5e9-f643b88643ec">
                ...
                <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-1753adb4-60d8-4b8b-889a-b59421a9ac70" id="dom-1753adb4-60d8-4b8b-889a-b59421a9ac70">
                  <pre class="scrollbar rounded-1" style="max-height:420px"><code class="language-html">&lt;div class=&quot;btn-group-vertical&quot; role=&quot;group&quot; aria-label=&quot;Vertical button group&quot;&gt;
  &lt;button class=&quot;btn btn-secondary&quot; type=&quot;button&quot;&gt;Button&lt;/button&gt;
  &lt;button class=&quot;btn btn-secondary&quot; type=&quot;button&quot;&gt;Button&lt;/button&gt;
  &lt;button class=&quot;btn btn-secondary&quot; type=&quot;button&quot;&gt;Button&lt;/button&gt;
  &lt;button class=&quot;btn btn-secondary&quot; type=&quot;button&quot;&gt;Button&lt;/button&gt;
...
&lt;/div&gt;</code></pre>
          ...
          <div class="card mb-3">
            <div class="card-header">
              <div class="row flex-between-end">
                <div class="col-auto align-self-center">
                  <h5 class="mb-0" data-anchor="data-anchor">Vertical variation with dropdown</h5>
                </div>
                <div class="col-auto ms-auto">
                  <div class="nav nav-pills nav-pills-falcon flex-grow-1" role="tablist">
                    <button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-860b8b6e-1d73-43c9-ad83-23e0e8f7ed43" type="button" role="tab" aria-controls="dom-860b8b6e-1d73-43c9-ad83-23e0e8f7ed43" aria-selected="true" id="tab-dom-860b8b6e-1d73-43c9-ad83-23e0e8f7ed43">Preview</button>
                    <button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-bf0be151-c899-45b5-bc27-b717048dff6d" type="button" role="tab" aria-controls="dom-bf0be151-c899-45b5-bc27-b717048dff6d" aria-selected="false" id="tab-dom-bf0be151-c899-45b5-bc27-b717048dff6d">Code</button>
                  </div>
                </div>
              </div>
            </div>
            <div class="card-body bg-light">
              <div class="tab-content">
                <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-860b8b6e-1d73-43c9-ad83-23e0e8f7ed43" id="dom-860b8b6e-1d73-43c9-ad83-23e0e8f7ed43">
                  <div class="btn-group-vertical" role="group" aria-label="Vertical button group">
                ...
                <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-bf0be151-c899-45b5-bc27-b717048dff6d" id="dom-bf0be151-c899-45b5-bc27-b717048dff6d">
                  <pre class="scrollbar rounded-1" style="max-height:420px"><code class="language-html">&lt;div class=&quot;btn-group-vertical&quot; role=&quot;group&quot; aria-label=&quot;Vertical button group&quot;&gt;
  &lt;button class=&quot;btn btn-secondary&quot; type=&quot;button&quot;&gt;Button&lt;/button&gt;
  &lt;button class=&quot;btn btn-secondary&quot; type=&quot;button&quot;&gt;Button&lt;/button&gt;
  &lt;div class=&quot;btn-group&quot; role=&quot;group&quot;&gt;
...
&lt;/div&gt;</code></pre>
          ...
          <div class="card mb-3">
            <div class="card-header">
              <div class="row flex-between-end">
                <div class="col-auto align-self-center">
                  <h5 class="mb-0" data-anchor="data-anchor">Disabled state</h5>
                  <p class="mb-0 pt-1 mt-2 mb-0">Make buttons look inactive by adding the disabled boolean attribute to any <code> &lt;button&gt; </code> element. Disabled buttons have <code> pointer-events: none; </code> applied to, preventing hover and active states from triggering.</p>
                </div>
                <div class="col-auto ms-auto">
                  <div class="nav nav-pills nav-pills-falcon flex-grow-1 mt-2" role="tablist">
                    <button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-cd4497a1-65fb-4371-952c-63579c8c2b0f" type="button" role="tab" aria-controls="dom-cd4497a1-65fb-4371-952c-63579c8c2b0f" aria-selected="true" id="tab-dom-cd4497a1-65fb-4371-952c-63579c8c2b0f">Preview</button>
                    <button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-bae29f3c-2bcc-40fe-8d53-eca65c3cf5f9" type="button" role="tab" aria-controls="dom-bae29f3c-2bcc-40fe-8d53-eca65c3cf5f9" aria-selected="false" id="tab-dom-bae29f3c-2bcc-40fe-8d53-eca65c3cf5f9">Code</button>
                  </div>
                </div>
              </div>
            </div>
            <div class="card-body bg-light">
              <div class="tab-content">
                <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-cd4497a1-65fb-4371-952c-63579c8c2b0f" id="dom-cd4497a1-65fb-4371-952c-63579c8c2b0f">
                ...
                <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-bae29f3c-2bcc-40fe-8d53-eca65c3cf5f9" id="dom-bae29f3c-2bcc-40fe-8d53-eca65c3cf5f9">
                  <pre class="scrollbar rounded-1" style="max-height:420px"><code class="language-html">&lt;button class=&quot;btn btn-lg btn-primary&quot; type=&quot;button&quot; disabled=&quot;disabled&quot;&gt;Primary button&lt;/button&gt;
&lt;button class=&quot;btn btn-secondary btn-lg ms-2&quot; type=&quot;button&quot; disabled=&quot;disabled&quot;&gt;Button&lt;/button&gt;</code></pre>
          ...
          <div class="card mb-3">
            <div class="card-header">
              <div class="row flex-between-end">
                <div class="col-auto align-self-center">
                  <h5 class="mb-0" data-anchor="data-anchor">Block buttons</h5>
                </div>
                <div class="col-auto ms-auto">
                  <div class="nav nav-pills nav-pills-falcon flex-grow-1" role="tablist">
                    <button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-eee5b9ab-7eb1-4f16-bbaf-86087f48d3f6" type="button" role="tab" aria-controls="dom-eee5b9ab-7eb1-4f16-bbaf-86087f48d3f6" aria-selected="true" id="tab-dom-eee5b9ab-7eb1-4f16-bbaf-86087f48d3f6">Preview</button>
                    <button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-b148cfdb-9a02-4302-9d8c-6de78f43b533" type="button" role="tab" aria-controls="dom-b148cfdb-9a02-4302-9d8c-6de78f43b533" aria-selected="false" id="tab-dom-b148cfdb-9a02-4302-9d8c-6de78f43b533">Code</button>
                  </div>
                </div>
              </div>
            </div>
            <div class="card-body bg-light">
              <div class="tab-content">
                <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-eee5b9ab-7eb1-4f16-bbaf-86087f48d3f6" id="dom-eee5b9ab-7eb1-4f16-bbaf-86087f48d3f6">
                  <div class="d-grid gap-2">
                    <button class="btn btn-primary" type="button">Button</button>
                    <button class="btn btn-primary" type="button">Button</button>
                  </div>
                </div>
                <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-b148cfdb-9a02-4302-9d8c-6de78f43b533" id="dom-b148cfdb-9a02-4302-9d8c-6de78f43b533">
                  <pre class="scrollbar rounded-1" style="max-height:420px"><code class="language-html">&lt;div class=&quot;d-grid gap-2&quot;&gt;
  &lt;button class=&quot;btn btn-primary&quot; type=&quot;button&quot;&gt;Button&lt;/button&gt;
  &lt;button class=&quot;btn btn-primary&quot; type=&quot;button&quot;&gt;Button&lt;/button&gt;
&lt;/div&gt;</code></pre>
                </div>
