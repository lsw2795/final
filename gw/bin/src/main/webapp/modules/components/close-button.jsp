          ...
          <div class="card mb-3">
            ...
            <div class="card-body position-relative">
              <div class="row">
                <div class="col-lg-8">
                  <h3>Close button</h3>
                  <p class="mb-0">A generic close button for dismissing content like modals and alerts.</p><a class="btn btn-link btn-sm ps-0 mt-2" href="https://getbootstrap.com/docs/5.3/components/close-button/" target="_blank">Close Button on Bootstrap<span class="fas fa-chevron-right ms-1 fs--2"></span></a>
                </div>
              </div>
            </div>
          </div>
                  ...
                  <div class="card">
                      ...
                      <div class="row flex-between-end">
                        ...
                        <div class="col-auto ms-auto">
                          <div class="nav nav-pills nav-pills-falcon flex-grow-1" role="tablist">
                            <button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-f505fe03-daa2-498d-b302-930fbcdcd54d" type="button" role="tab" aria-controls="dom-f505fe03-daa2-498d-b302-930fbcdcd54d" aria-selected="true" id="tab-dom-f505fe03-daa2-498d-b302-930fbcdcd54d">Preview</button>
                            <button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-003ccfe6-9996-4ef7-90fe-d591bc6e4b22" type="button" role="tab" aria-controls="dom-003ccfe6-9996-4ef7-90fe-d591bc6e4b22" aria-selected="false" id="tab-dom-003ccfe6-9996-4ef7-90fe-d591bc6e4b22">Code</button>
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="card-body bg-light">
                      <div class="tab-content">
                        <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-f505fe03-daa2-498d-b302-930fbcdcd54d" id="dom-f505fe03-daa2-498d-b302-930fbcdcd54d">
                          <div class="rounded-1 p-3">
                            <button class="btn-close" type="button" aria-label="Close"></button>
                            <button class="btn-close" type="button" disabled="" aria-label="Close"></button>
                          </div>
                        </div>
                        <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-003ccfe6-9996-4ef7-90fe-d591bc6e4b22" id="dom-003ccfe6-9996-4ef7-90fe-d591bc6e4b22">
                  ...
                  <div class="card">
                    <div class="card-header">
                      <div class="row flex-between-end">
                        ...
                        <div class="col-auto ms-auto">
                          <div class="nav nav-pills nav-pills-falcon flex-grow-1" role="tablist">
                            <button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-39306414-b2b7-4abb-90c9-03d3a3d4211a" type="button" role="tab" aria-controls="dom-39306414-b2b7-4abb-90c9-03d3a3d4211a" aria-selected="true" id="tab-dom-39306414-b2b7-4abb-90c9-03d3a3d4211a">Preview</button>
                            <button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-55df29e6-9b4a-4d6a-bb31-522c91e76291" type="button" role="tab" aria-controls="dom-55df29e6-9b4a-4d6a-bb31-522c91e76291" aria-selected="false" id="tab-dom-55df29e6-9b4a-4d6a-bb31-522c91e76291">Code</button>
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="card-body bg-light">
                      <div class="tab-content">
                        <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-39306414-b2b7-4abb-90c9-03d3a3d4211a" id="dom-39306414-b2b7-4abb-90c9-03d3a3d4211a">
                        ...
                        <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-55df29e6-9b4a-4d6a-bb31-522c91e76291" id="dom-55df29e6-9b4a-4d6a-bb31-522c91e76291">
