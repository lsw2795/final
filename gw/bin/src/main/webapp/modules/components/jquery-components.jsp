      ...
      <div class="container" data-layout="container">
              ...
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                ...
                <li class="nav-item">
                  ...
                  <ul class="nav collapse show" id="components">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="../../modules/components/jquery-components.jsp">
        ...
        <div class="content">
          ...
          <div class="alert alert-warning p-x1" role="alert">
            <div class="d-flex align-items-center"><span class="fab fa-intentionally-kept fs-3"></span>
              <div class="flex-1 ms-3">
                <p class="mb-0">
                  In Falcon, we include jQuery only this page. Other pages aren't dependent on jQuery plugin. If your project included jQuery, you can use these components without writing any extra CSS.</p>
              </div>
            </div>
          </div>
          <div class="row g-3">
                      ...
                      <li class="treeview-list-item mb-3"><a data-bs-toggle="collapse" href="#jquery-Datatables" role="button" aria-expanded="false">
                        ...
                        <ul class="collapse treeview-list" id="jquery-Datatables" data-show="true">
                          <li class="treeview-item"><a class="flex-1" href="#jquery-datatables-default-example">
                              <p class="treeview-text fw-medium"><span class="me-2 fas fa-hashtag fs--2"></span>Default example</p>
                            </a></li>
                          <li class="treeview-item"><a class="flex-1" href="#jquery-datatables-simple-pagination">
                              <p class="treeview-text fw-medium"><span class="me-2 fas fa-hashtag fs--2"></span>Simple pagination</p>
                            </a></li>
                          <li class="treeview-item"><a class="flex-1" href="#jquery-datatables-number-pagination">
                              <p class="treeview-text fw-medium"><span class="me-2 fas fa-hashtag fs--2"></span>Number pagination</p>
                            </a></li>
                          <li class="treeview-item"><a class="flex-1" href="#jquery-datatables-vertical-scroll">
                              <p class="treeview-text fw-medium"><span class="me-2 fas fa-hashtag fs--2"></span>Vertical scroll</p>
                            </a></li>
                          <li class="treeview-item"><a class="flex-1" href="#jquery-datatables-fixed-columns">
                              <p class="treeview-text fw-medium"><span class="me-2 fas fa-hashtag fs--2"></span>Fixed columns</p>
                            </a></li>
                        </ul>
                      </li>
                      <li class="treeview-list-item"><a data-bs-toggle="collapse" href="#jquery-Select2" role="button" aria-expanded="false">
                        ...
                        <ul class="collapse treeview-list" id="jquery-Select2" data-show="true">
                          <li class="treeview-item"><a class="flex-1" href="#jquery-select2-single-select">
                              <p class="treeview-text fw-medium"><span class="me-2 fas fa-hashtag fs--2"></span>SIngle Select</p>
                            </a></li>
                          <li class="treeview-item"><a class="flex-1" href="#jquery-select2-multiple-select">
                              <p class="treeview-text fw-medium"><span class="me-2 fas fa-hashtag fs--2"></span>Multiple select</p>
                            </a></li>
                        </ul>
                      </li>
                    </ul>
              ...
              <div class="card mb-3">
                  ...
                  <div class="row flex-between-end">
                    ...
                    <div class="col-auto ms-auto">
                      <div class="nav nav-pills nav-pills-falcon flex-grow-1" role="tablist">
                        <button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-41652773-160b-4cf3-9789-a0613d09ac47" type="button" role="tab" aria-controls="dom-41652773-160b-4cf3-9789-a0613d09ac47" aria-selected="true" id="tab-dom-41652773-160b-4cf3-9789-a0613d09ac47">Preview</button>
                        <button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-f0fbe6f1-d1e2-44af-90d3-5bf3680aff97" type="button" role="tab" aria-controls="dom-f0fbe6f1-d1e2-44af-90d3-5bf3680aff97" aria-selected="false" id="tab-dom-f0fbe6f1-d1e2-44af-90d3-5bf3680aff97">Code</button>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="card-body px-0">
                  <div class="tab-content">
                    <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-41652773-160b-4cf3-9789-a0613d09ac47" id="dom-41652773-160b-4cf3-9789-a0613d09ac47">
                      <table class="table mb-0 data-table fs--1">
                        <thead class="bg-200 text-900">
                          <tr>
                            ...
                            <th class="sort text-end">Salary</th>
                          </tr>
                        </thead>
                        <tbody>
                          <tr>
                    ...
                    <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-f0fbe6f1-d1e2-44af-90d3-5bf3680aff97" id="dom-f0fbe6f1-d1e2-44af-90d3-5bf3680aff97">
                      <pre class="scrollbar rounded-1" style="max-height:420px"><code class="language-html">&lt;table class=&quot;table mb-0 data-table fs--1&quot;&gt;
  &lt;thead class=&quot;bg-200 text-900&quot;&gt;
    &lt;tr&gt;
      &lt;th class=&quot;sort&quot;&gt;Name&lt;/th&gt;
      &lt;th class=&quot;sort&quot;&gt;Position&lt;/th&gt;
              ...
              <div class="card mb-3">
                <div class="card-header">
                  <div class="row flex-between-end">
                    ...
                    <div class="col-auto ms-auto">
                      <div class="nav nav-pills nav-pills-falcon flex-grow-1" role="tablist">
                        <button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-dbd59e05-484e-457c-889e-189057f0423f" type="button" role="tab" aria-controls="dom-dbd59e05-484e-457c-889e-189057f0423f" aria-selected="true" id="tab-dom-dbd59e05-484e-457c-889e-189057f0423f">Preview</button>
                        <button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-3eca603f-0997-4014-ad41-336453df6ce2" type="button" role="tab" aria-controls="dom-3eca603f-0997-4014-ad41-336453df6ce2" aria-selected="false" id="tab-dom-3eca603f-0997-4014-ad41-336453df6ce2">Code</button>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="card-body p-0">
                  <div class="tab-content">
                    <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-dbd59e05-484e-457c-889e-189057f0423f" id="dom-dbd59e05-484e-457c-889e-189057f0423f">
                      <div class="card shadow-none">
                        <div class="card-header">
                        ...
                        <div class="card-body px-0 pt-0">
                          <table class="table table-sm mb-0 overflow-hidden data-table fs--1" data-options='{"responsive":false,"pagingType":"simple","lengthChange":false,"searching":false,"pageLength":8,"language":{"info":"_START_ to _END_ Items of _TOTAL_"}}'>
                            <thead class="bg-200 text-900">
                              <tr>
                                ...
                                <th class="sort pe-1 align-middle white-space-nowrap">Customer</th>
                                <th class="sort pe-1 align-middle white-space-nowrap">Email</th>
                                <th class="sort pe-1 align-middle white-space-nowrap">Product</th>
                                <th class="sort pe-1 align-middle white-space-nowrap text-center">Payment</th>
                                <th class="sort pe-1 align-middle white-space-nowrap text-end">Amount</th>
                            ...
                            <tbody class="list" id="table-simple-pagination-body">
                              <tr class="btn-reveal-trigger">
                                ...
                                <td class="align-middle white-space-nowrap text-end">
                                  <div class="dropstart font-sans-serif position-static d-inline-block">
                                    <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal float-end" type="button" id="dropdown-simple-pagination-table-item-0" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="fas fa-ellipsis-h fs--1"></span></button>
                              ...
                              <tr class="btn-reveal-trigger">
                                ...
                                <td class="align-middle white-space-nowrap text-end">
                                  <div class="dropstart font-sans-serif position-static d-inline-block">
                                    <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal float-end" type="button" id="dropdown-simple-pagination-table-item-1" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="fas fa-ellipsis-h fs--1"></span></button>
                              ...
                              <tr class="btn-reveal-trigger">
                                ...
                                <td class="align-middle text-center fs-0 white-space-nowrap payment"><span class="badge badge rounded-pill badge-subtle-secondary">Blocked<span class="ms-1 fas fa-ban" data-fa-transform="shrink-2"></span></span>
                                </td>
                                <td class="align-middle text-end amount">$199</td>
                                <td class="align-middle white-space-nowrap text-end">
                                  <div class="dropstart font-sans-serif position-static d-inline-block">
                                    <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal float-end" type="button" id="dropdown-simple-pagination-table-item-2" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="fas fa-ellipsis-h fs--1"></span></button>
                              ...
                              <tr class="btn-reveal-trigger">
                                ...
                                <td class="align-middle white-space-nowrap text-end">
                                  <div class="dropstart font-sans-serif position-static d-inline-block">
                                    <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal float-end" type="button" id="dropdown-simple-pagination-table-item-3" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="fas fa-ellipsis-h fs--1"></span></button>
                              ...
                              <tr class="btn-reveal-trigger">
                                ...
                                <td class="align-middle white-space-nowrap text-end">
                                  <div class="dropstart font-sans-serif position-static d-inline-block">
                                    <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal float-end" type="button" id="dropdown-simple-pagination-table-item-4" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="fas fa-ellipsis-h fs--1"></span></button>
                              ...
                              <tr class="btn-reveal-trigger">
                                ...
                                <td class="align-middle text-center fs-0 white-space-nowrap payment"><span class="badge badge rounded-pill badge-subtle-warning">Pending<span class="ms-1 fas fa-stream" data-fa-transform="shrink-2"></span></span>
                                </td>
                                <td class="align-middle text-end amount">$11</td>
                                <td class="align-middle white-space-nowrap text-end">
                                  <div class="dropstart font-sans-serif position-static d-inline-block">
                                    <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal float-end" type="button" id="dropdown-simple-pagination-table-item-5" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="fas fa-ellipsis-h fs--1"></span></button>
                              ...
                              <tr class="btn-reveal-trigger">
                                ...
                                <td class="align-middle white-space-nowrap text-end">
                                  <div class="dropstart font-sans-serif position-static d-inline-block">
                                    <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal float-end" type="button" id="dropdown-simple-pagination-table-item-6" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="fas fa-ellipsis-h fs--1"></span></button>
                              ...
                              <tr class="btn-reveal-trigger">
                                ...
                                <td class="align-middle white-space-nowrap text-end">
                                  <div class="dropstart font-sans-serif position-static d-inline-block">
                                    <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal float-end" type="button" id="dropdown-simple-pagination-table-item-7" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="fas fa-ellipsis-h fs--1"></span></button>
                              ...
                              <tr class="btn-reveal-trigger">
                                ...
                                <td class="align-middle white-space-nowrap text-end">
                                  <div class="dropstart font-sans-serif position-static d-inline-block">
                                    <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal float-end" type="button" id="dropdown-simple-pagination-table-item-8" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="fas fa-ellipsis-h fs--1"></span></button>
                              ...
                              <tr class="btn-reveal-trigger">
                                ...
                                <td class="align-middle white-space-nowrap text-end">
                                  <div class="dropstart font-sans-serif position-static d-inline-block">
                                    <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal float-end" type="button" id="dropdown-simple-pagination-table-item-9" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="fas fa-ellipsis-h fs--1"></span></button>
                              ...
                              <tr class="btn-reveal-trigger">
                                ...
                                <td class="align-middle white-space-nowrap text-end">
                                  <div class="dropstart font-sans-serif position-static d-inline-block">
                                    <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal float-end" type="button" id="dropdown-simple-pagination-table-item-10" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="fas fa-ellipsis-h fs--1"></span></button>
                              ...
                              <tr class="btn-reveal-trigger">
                                ...
                                <td class="align-middle white-space-nowrap text-end">
                                  <div class="dropstart font-sans-serif position-static d-inline-block">
                                    <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal float-end" type="button" id="dropdown-simple-pagination-table-item-11" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="fas fa-ellipsis-h fs--1"></span></button>
                              ...
                              <tr class="btn-reveal-trigger">
                                ...
                                <td class="align-middle white-space-nowrap text-end">
                                  <div class="dropstart font-sans-serif position-static d-inline-block">
                                    <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal float-end" type="button" id="dropdown-simple-pagination-table-item-12" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="fas fa-ellipsis-h fs--1"></span></button>
                              ...
                              <tr class="btn-reveal-trigger">
                                ...
                                <td class="align-middle white-space-nowrap text-end">
                                  <div class="dropstart font-sans-serif position-static d-inline-block">
                                    <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal float-end" type="button" id="dropdown-simple-pagination-table-item-13" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="fas fa-ellipsis-h fs--1"></span></button>
                    ...
                    <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-3eca603f-0997-4014-ad41-336453df6ce2" id="dom-3eca603f-0997-4014-ad41-336453df6ce2">
              ...
              <div class="card mb-3">
                <div class="card-header">
                  <div class="row flex-between-end">
                    ...
                    <div class="col-auto ms-auto">
                      <div class="nav nav-pills nav-pills-falcon flex-grow-1" role="tablist">
                        <button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-23f8aede-0e3e-475d-84d0-7fbcf8667ebc" type="button" role="tab" aria-controls="dom-23f8aede-0e3e-475d-84d0-7fbcf8667ebc" aria-selected="true" id="tab-dom-23f8aede-0e3e-475d-84d0-7fbcf8667ebc">Preview</button>
                        <button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-cbf857c6-7be4-4897-9894-af3eed49ebc9" type="button" role="tab" aria-controls="dom-cbf857c6-7be4-4897-9894-af3eed49ebc9" aria-selected="false" id="tab-dom-cbf857c6-7be4-4897-9894-af3eed49ebc9">Code</button>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="card-body p-0">
                  <div class="tab-content">
                    <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-23f8aede-0e3e-475d-84d0-7fbcf8667ebc" id="dom-23f8aede-0e3e-475d-84d0-7fbcf8667ebc">
                      <div class="card shadow-none">
                        <div class="card-header">
                          <div class="row flex-between-center">
                            <div class="col-6 col-sm-auto d-flex align-items-center pe-0">
                            ...
                            <table class="table table-sm mb-0 data-table fs--1" data-options='{"searching":false,"responsive":false,"pageLength":8,"info":true,"lengthChange":false,"dom":"<&#39;row mx-1&#39;<&#39;col-sm-12 col-md-6&#39;l><&#39;col-sm-12 col-md-6&#39;f>><&#39;table-responsive scrollbar&#39;tr><&#39;row no-gutters px-1 pb-3 align-items-center justify-content-center&#39;<&#39;col-auto&#39; p>>","language":{"paginate":{"next":"<span class=\"fas fa-chevron-right\"></span>","previous":"<span class=\"fas fa-chevron-left\"></span>"}}}'>
                              ...
                              <tbody class="list" id="table-number-pagination-body">
                                <tr class="btn-reveal-trigger">
                                  ...
                                  <td class="align-middle white-space-nowrap text-end">
                                    <div class="dropstart font-sans-serif position-static d-inline-block">
                                      <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal float-end" type="button" id="dropdown-number-pagination-table-item-0" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="fas fa-ellipsis-h fs--1"></span></button>
                                ...
                                <tr class="btn-reveal-trigger">
                                  <td class="align-middle" style="width: 28px;">
                                    <div class="form-check mb-0">
                                      <input class="form-check-input" type="checkbox" id="number-pagination-item-1" data-bulk-select-row="data-bulk-select-row" />
                                    </div>
                                  </td>
                                  <th class="align-middle white-space-nowrap name"><a href="../../app/e-commerce/customer-details.jsp">Homer</a></th>
                                  <td class="align-middle white-space-nowrap email">sylvia@mail.ru</td>
                                  ...
                                  <td class="align-middle white-space-nowrap text-end">
                                    <div class="dropstart font-sans-serif position-static d-inline-block">
                                      <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal float-end" type="button" id="dropdown-number-pagination-table-item-1" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="fas fa-ellipsis-h fs--1"></span></button>
                                ...
                                <tr class="btn-reveal-trigger">
                                  <td class="align-middle" style="width: 28px;">
                                    <div class="form-check mb-0">
                                      <input class="form-check-input" type="checkbox" id="number-pagination-item-2" data-bulk-select-row="data-bulk-select-row" />
                                    </div>
                                  </td>
                                  <th class="align-middle white-space-nowrap name"><a href="../../app/e-commerce/customer-details.jsp">Edgar Allan Poe</a></th>
                                  <td class="align-middle white-space-nowrap email">edgar@yahoo.com</td>
                                  ...
                                  <td class="align-middle white-space-nowrap text-end">
                                    <div class="dropstart font-sans-serif position-static d-inline-block">
                                      <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal float-end" type="button" id="dropdown-number-pagination-table-item-2" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="fas fa-ellipsis-h fs--1"></span></button>
                                ...
                                <tr class="btn-reveal-trigger">
                                  <td class="align-middle" style="width: 28px;">
                                    <div class="form-check mb-0">
                                      <input class="form-check-input" type="checkbox" id="number-pagination-item-3" data-bulk-select-row="data-bulk-select-row" />
                                    </div>
                                  </td>
                                  <th class="align-middle white-space-nowrap name"><a href="../../app/e-commerce/customer-details.jsp">William Butler Yeats</a></th>
                                  <td class="align-middle white-space-nowrap email">william@gmail.com</td>
                                  ...
                                  <td class="align-middle white-space-nowrap text-end">
                                    <div class="dropstart font-sans-serif position-static d-inline-block">
                                      <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal float-end" type="button" id="dropdown-number-pagination-table-item-3" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="fas fa-ellipsis-h fs--1"></span></button>
                                ...
                                <tr class="btn-reveal-trigger">
                                  <td class="align-middle" style="width: 28px;">
                                    <div class="form-check mb-0">
                                      <input class="form-check-input" type="checkbox" id="number-pagination-item-4" data-bulk-select-row="data-bulk-select-row" />
                                    </div>
                                  </td>
                                  <th class="align-middle white-space-nowrap name"><a href="../../app/e-commerce/customer-details.jsp">Rabindranath Tagore</a></th>
                                  <td class="align-middle white-space-nowrap email">tagore@twitter.com</td>
                                  ...
                                  <td class="align-middle white-space-nowrap text-end">
                                    <div class="dropstart font-sans-serif position-static d-inline-block">
                                      <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal float-end" type="button" id="dropdown-number-pagination-table-item-4" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="fas fa-ellipsis-h fs--1"></span></button>
                                ...
                                <tr class="btn-reveal-trigger">
                                  <td class="align-middle" style="width: 28px;">
                                    <div class="form-check mb-0">
                                      <input class="form-check-input" type="checkbox" id="number-pagination-item-5" data-bulk-select-row="data-bulk-select-row" />
                                    </div>
                                  </td>
                                  <th class="align-middle white-space-nowrap name"><a href="../../app/e-commerce/customer-details.jsp">Emily Dickinson</a></th>
                                  <td class="align-middle white-space-nowrap email">emily@gmail.com</td>
                                  ...
                                  <td class="align-middle white-space-nowrap text-end">
                                    <div class="dropstart font-sans-serif position-static d-inline-block">
                                      <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal float-end" type="button" id="dropdown-number-pagination-table-item-5" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="fas fa-ellipsis-h fs--1"></span></button>
                                ...
                                <tr class="btn-reveal-trigger">
                                  <td class="align-middle" style="width: 28px;">
                                    <div class="form-check mb-0">
                                      <input class="form-check-input" type="checkbox" id="number-pagination-item-6" data-bulk-select-row="data-bulk-select-row" />
                                    </div>
                                  </td>
                                  <th class="align-middle white-space-nowrap name"><a href="../../app/e-commerce/customer-details.jsp">Giovanni Boccaccio</a></th>
                                  <td class="align-middle white-space-nowrap email">giovanni@outlook.com</td>
                                  ...
                                  <td class="align-middle white-space-nowrap text-end">
                                    <div class="dropstart font-sans-serif position-static d-inline-block">
                                      <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal float-end" type="button" id="dropdown-number-pagination-table-item-6" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="fas fa-ellipsis-h fs--1"></span></button>
                                ...
                                <tr class="btn-reveal-trigger">
                                  <td class="align-middle" style="width: 28px;">
                                    <div class="form-check mb-0">
                                      <input class="form-check-input" type="checkbox" id="number-pagination-item-7" data-bulk-select-row="data-bulk-select-row" />
                                    </div>
                                  </td>
                                  <th class="align-middle white-space-nowrap name"><a href="../../app/e-commerce/customer-details.jsp">Oscar Wilde</a></th>
                                  <td class="align-middle white-space-nowrap email">oscar@hotmail.com</td>
                                  ...
                                  <td class="align-middle white-space-nowrap text-end">
                                    <div class="dropstart font-sans-serif position-static d-inline-block">
                                      <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal float-end" type="button" id="dropdown-number-pagination-table-item-7" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="fas fa-ellipsis-h fs--1"></span></button>
                                ...
                                <tr class="btn-reveal-trigger">
                                  <td class="align-middle" style="width: 28px;">
                                    <div class="form-check mb-0">
                                      <input class="form-check-input" type="checkbox" id="number-pagination-item-8" data-bulk-select-row="data-bulk-select-row" />
                                    </div>
                                  </td>
                                  <th class="align-middle white-space-nowrap name"><a href="../../app/e-commerce/customer-details.jsp">John Doe</a></th>
                                  <td class="align-middle white-space-nowrap email">doe@gmail.com</td>
                                  ...
                                  <td class="align-middle white-space-nowrap text-end">
                                    <div class="dropstart font-sans-serif position-static d-inline-block">
                                      <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal float-end" type="button" id="dropdown-number-pagination-table-item-8" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="fas fa-ellipsis-h fs--1"></span></button>
                                ...
                                <tr class="btn-reveal-trigger">
                                  <td class="align-middle" style="width: 28px;">
                                    <div class="form-check mb-0">
                                      <input class="form-check-input" type="checkbox" id="number-pagination-item-9" data-bulk-select-row="data-bulk-select-row" />
                                    </div>
                                  </td>
                                  <th class="align-middle white-space-nowrap name"><a href="../../app/e-commerce/customer-details.jsp">Emma Watson</a></th>
                                  <td class="align-middle white-space-nowrap email">emma@gmail.com</td>
                                  ...
                                  <td class="align-middle white-space-nowrap text-end">
                                    <div class="dropstart font-sans-serif position-static d-inline-block">
                                      <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal float-end" type="button" id="dropdown-number-pagination-table-item-9" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="fas fa-ellipsis-h fs--1"></span></button>
                                ...
                                <tr class="btn-reveal-trigger">
                                  <td class="align-middle" style="width: 28px;">
                                    <div class="form-check mb-0">
                                      <input class="form-check-input" type="checkbox" id="number-pagination-item-10" data-bulk-select-row="data-bulk-select-row" />
                                    </div>
                                  </td>
                                  <th class="align-middle white-space-nowrap name"><a href="../../app/e-commerce/customer-details.jsp">Sylvia Plath</a></th>
                                  <td class="align-middle white-space-nowrap email">plath@yahoo.com</td>
                                  ...
                                  <td class="align-middle white-space-nowrap text-end">
                                    <div class="dropstart font-sans-serif position-static d-inline-block">
                                      <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal float-end" type="button" id="dropdown-number-pagination-table-item-10" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="fas fa-ellipsis-h fs--1"></span></button>
                                ...
                                <tr class="btn-reveal-trigger">
                                  <td class="align-middle" style="width: 28px;">
                                    <div class="form-check mb-0">
                                      <input class="form-check-input" type="checkbox" id="number-pagination-item-11" data-bulk-select-row="data-bulk-select-row" />
                                    </div>
                                  </td>
                                  <th class="align-middle white-space-nowrap name"><a href="../../app/e-commerce/customer-details.jsp">Rabindranath Tagore</a></th>
                                  <td class="align-middle white-space-nowrap email">Rabindra@gmail.com</td>
                                  ...
                                  <td class="align-middle white-space-nowrap text-end">
                                    <div class="dropstart font-sans-serif position-static d-inline-block">
                                      <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal float-end" type="button" id="dropdown-number-pagination-table-item-11" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="fas fa-ellipsis-h fs--1"></span></button>
                                ...
                                <tr class="btn-reveal-trigger">
                                  <td class="align-middle" style="width: 28px;">
                                    <div class="form-check mb-0">
                                      <input class="form-check-input" type="checkbox" id="number-pagination-item-12" data-bulk-select-row="data-bulk-select-row" />
                                    </div>
                                  </td>
                                  <th class="align-middle white-space-nowrap name"><a href="../../app/e-commerce/customer-details.jsp">Anila Wilde</a></th>
                                  <td class="align-middle white-space-nowrap email">anila@yahoo.com</td>
                                  ...
                                  <td class="align-middle white-space-nowrap text-end">
                                    <div class="dropstart font-sans-serif position-static d-inline-block">
                                      <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal float-end" type="button" id="dropdown-number-pagination-table-item-12" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="fas fa-ellipsis-h fs--1"></span></button>
                                ...
                                <tr class="btn-reveal-trigger">
                                  <td class="align-middle" style="width: 28px;">
                                    <div class="form-check mb-0">
                                      <input class="form-check-input" type="checkbox" id="number-pagination-item-13" data-bulk-select-row="data-bulk-select-row" />
                                    </div>
                                  </td>
                                  <th class="align-middle white-space-nowrap name"><a href="../../app/e-commerce/customer-details.jsp">Jack Watson </a></th>
                                  <td class="align-middle white-space-nowrap email">Jack@gmail.com</td>
                                  ...
                                  <td class="align-middle white-space-nowrap text-end">
                                    <div class="dropstart font-sans-serif position-static d-inline-block">
                                      <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal float-end" type="button" id="dropdown-number-pagination-table-item-13" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="fas fa-ellipsis-h fs--1"></span></button>
                    ...
                    <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-cbf857c6-7be4-4897-9894-af3eed49ebc9" id="dom-cbf857c6-7be4-4897-9894-af3eed49ebc9">
                      <pre class="scrollbar rounded-1" style="max-height:420px"><code class="language-html">&lt;div class=&quot;card shadow-none&quot;&gt;
  &lt;div class=&quot;card-header&quot;&gt;
    &lt;div class=&quot;row flex-between-center&quot;&gt;
      &lt;div class=&quot;col-6 col-sm-auto d-flex align-items-center pe-0&quot;&gt;
              ...
              <div class="card mb-3">
                <div class="card-header">
                  <div class="row flex-between-end">
                    ...
                    <div class="col-auto ms-auto">
                      <div class="nav nav-pills nav-pills-falcon flex-grow-1" role="tablist">
                        <button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-b99d5d8d-9344-48cf-8227-bf3e99e426d2" type="button" role="tab" aria-controls="dom-b99d5d8d-9344-48cf-8227-bf3e99e426d2" aria-selected="true" id="tab-dom-b99d5d8d-9344-48cf-8227-bf3e99e426d2">Preview</button>
                        <button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-c006b27f-2f9b-40e4-be0e-2258ca3b319c" type="button" role="tab" aria-controls="dom-c006b27f-2f9b-40e4-be0e-2258ca3b319c" aria-selected="false" id="tab-dom-c006b27f-2f9b-40e4-be0e-2258ca3b319c">Code</button>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="card-body px-0 pt-0">
                  <div class="tab-content">
                    <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-b99d5d8d-9344-48cf-8227-bf3e99e426d2" id="dom-b99d5d8d-9344-48cf-8227-bf3e99e426d2">
                      <table class="table mb-0 data-table fs--1" data-options='{"paging":false,"scrollY":"300px","searching":false,"scrollCollapse":true,"scrollX":true}'>
                        <thead class="bg-200 text-900">
                          <tr>
                            <th class="sort">Name</th>
                            <th class="sort">Position</th>
                    ...
                    <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-c006b27f-2f9b-40e4-be0e-2258ca3b319c" id="dom-c006b27f-2f9b-40e4-be0e-2258ca3b319c">
                      <pre class="scrollbar rounded-1" style="max-height:420px"><code class="language-html">&lt;table class=&quot;table mb-0 data-table fs--1&quot; data-options='{&quot;paging&quot;:false,&quot;scrollY&quot;:&quot;300px&quot;,&quot;searching&quot;:false,&quot;scrollCollapse&quot;:true,&quot;scrollX&quot;:true}'&gt;
  &lt;thead class=&quot;bg-200 text-900&quot;&gt;
    &lt;tr&gt;
      &lt;th class=&quot;sort&quot;&gt;Name&lt;/th&gt;
      &lt;th class=&quot;sort&quot;&gt;Position&lt;/th&gt;
              ...
              <div class="card mb-3">
                <div class="card-header">
                  <div class="row flex-between-end">
                    ...
                    <div class="col-auto ms-auto">
                      <div class="nav nav-pills nav-pills-falcon flex-grow-1" role="tablist">
                        <button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-5380f61a-11f6-4685-8570-f59aaf84d604" type="button" role="tab" aria-controls="dom-5380f61a-11f6-4685-8570-f59aaf84d604" aria-selected="true" id="tab-dom-5380f61a-11f6-4685-8570-f59aaf84d604">Preview</button>
                        <button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-486240ed-dc39-4640-966d-bbc43b77f001" type="button" role="tab" aria-controls="dom-486240ed-dc39-4640-966d-bbc43b77f001" aria-selected="false" id="tab-dom-486240ed-dc39-4640-966d-bbc43b77f001">Code</button>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="card-body px-0 pt-0">
                  <div class="tab-content">
                    <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-5380f61a-11f6-4685-8570-f59aaf84d604" id="dom-5380f61a-11f6-4685-8570-f59aaf84d604">
                      <table class="table mb-0 data-table fs--1" data-options='{"paging":false,"scrollY":"300px","searching":false,"scrollCollapse":true,"fixedColumns":{"left":1},"scrollX":true}'>
                        <thead class="bg-200 text-900">
                          <tr>
                            <th class="sort">Name</th>
                            <th class="sort">Position</th>
                    ...
                    <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-486240ed-dc39-4640-966d-bbc43b77f001" id="dom-486240ed-dc39-4640-966d-bbc43b77f001">
                      <pre class="scrollbar rounded-1" style="max-height:420px"><code class="language-html">&lt;table class=&quot;table mb-0 data-table fs--1&quot; data-options='{&quot;paging&quot;:false,&quot;scrollY&quot;:&quot;300px&quot;,&quot;searching&quot;:false,&quot;scrollCollapse&quot;:true,&quot;fixedColumns&quot;:{&quot;left&quot;:1},&quot;scrollX&quot;:true}'&gt;
  &lt;thead class=&quot;bg-200 text-900&quot;&gt;
    &lt;tr&gt;
      &lt;th class=&quot;sort&quot;&gt;Name&lt;/th&gt;
      &lt;th class=&quot;sort&quot;&gt;Position&lt;/th&gt;
...
&lt;/table&gt;</code></pre>
              ...
              <div class="card mb-3">
                <div class="card-body">
                  ...
                  <pre class="scrollbar mt-2 mb-3"><code class="language-html">&lt;script src=&quot;vendors/jquery/jquery.min.js&quot;&gt;&lt;/script&gt;
...
&lt;script src=&quot;vendors/datatables.net-fixedcolumns/dataTables.fixedColumns.min.js&quot;&gt;&lt;/script&gt;</code></pre>
                  <h5 class="mb-0">Stylesheets </h5>
                  <pre class="scrollbar mt-2"><code class="language-html">&lt;script src=&quot;vendors/datatables.net-bs5/dataTables.bootstrap5.min.css&quot;&gt;&lt;/script&gt;</code></pre>
                </div>
              </div>
              <div class="card mb-3">
                <div class="bg-holder d-none d-lg-block bg-card" style="background-image:url(../../assets/img/icons/spot-illustrations/corner-4.png);">
                ...
                <div class="card-body position-relative">
                  <div class="row">
                    <div class="col-lg-8">
                      <h3 class="fs-2">Select2</h3>
                      <p class="mb-0">Select2 gives you a customizable select box with support for searching, tagging, remote data sets, infinite scrolling, and many other highly used options.</p><a class="btn btn-link btn-sm ps-0 mt-2" href="https://select2.org/" target="_blank">Select2 documentation<span class="fas fa-chevron-right ms-1 fs--2"></span></a>
                    </div>
                  </div>
                </div>
              </div>
              <div class="card mb-3">
                <div class="card-header">
                  <div class="row flex-between-end">
                    ...
                    <div class="col-auto ms-auto">
                      <div class="nav nav-pills nav-pills-falcon flex-grow-1" role="tablist">
                        <button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-82eb50bd-9661-4025-b20e-0b2c4b5b8e8f" type="button" role="tab" aria-controls="dom-82eb50bd-9661-4025-b20e-0b2c4b5b8e8f" aria-selected="true" id="tab-dom-82eb50bd-9661-4025-b20e-0b2c4b5b8e8f">Preview</button>
                        <button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-9b0b93db-be3a-4546-af33-722a144ef6ce" type="button" role="tab" aria-controls="dom-9b0b93db-be3a-4546-af33-722a144ef6ce" aria-selected="false" id="tab-dom-9b0b93db-be3a-4546-af33-722a144ef6ce">Code</button>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="card-body bg-light">
                  <div class="tab-content">
                    <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-82eb50bd-9661-4025-b20e-0b2c4b5b8e8f" id="dom-82eb50bd-9661-4025-b20e-0b2c4b5b8e8f">
                      <div class="form-group">
                        <label for="basic-example">Select an option</label>
                        <select class="form-select selectpicker" id="basic-example" data-options='{"placeholder":"Select country..."}'>
                    ...
                    <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-9b0b93db-be3a-4546-af33-722a144ef6ce" id="dom-9b0b93db-be3a-4546-af33-722a144ef6ce">
                      <pre class="scrollbar rounded-1" style="max-height:420px"><code class="language-html">&lt;div class=&quot;form-group&quot;&gt;
  &lt;label for=&quot;basic-example&quot;&gt;Select an option&lt;/label&gt;
  &lt;select class=&quot;form-select selectpicker&quot; id=&quot;basic-example&quot; data-options='{&quot;placeholder&quot;:&quot;Select country...&quot;}'&gt;
    &lt;option&gt;Select country...&lt;/option&gt;
    &lt;option&gt;Afghanistan&lt;/option&gt;
              ...
              <div class="card mb-3">
                <div class="card-header">
                  <div class="row flex-between-end">
                    ...
                    <div class="col-auto ms-auto">
                      <div class="nav nav-pills nav-pills-falcon flex-grow-1" role="tablist">
                        <button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-442b6d72-b745-4bf7-85fa-69fe90868f19" type="button" role="tab" aria-controls="dom-442b6d72-b745-4bf7-85fa-69fe90868f19" aria-selected="true" id="tab-dom-442b6d72-b745-4bf7-85fa-69fe90868f19">Preview</button>
                        <button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-45d25e8e-49d7-4603-af29-a21d85e5c551" type="button" role="tab" aria-controls="dom-45d25e8e-49d7-4603-af29-a21d85e5c551" aria-selected="false" id="tab-dom-45d25e8e-49d7-4603-af29-a21d85e5c551">Code</button>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="card-body bg-light">
                  <div class="tab-content">
                    <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-442b6d72-b745-4bf7-85fa-69fe90868f19" id="dom-442b6d72-b745-4bf7-85fa-69fe90868f19">
                      <div class="form-group">
                        <label for="multiple-select">Select options</label>
                        <select class="form-select selectpicker" id="multiple-select" multiple="multiple" data-options='{"placeholder":"Select your options"}'>
                          <option>Afghanistan</option>
                          <option>Albania</option>
                          <option>Algeria</option>
                          <option>American Samoa</option>
                    ...
                    <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-45d25e8e-49d7-4603-af29-a21d85e5c551" id="dom-45d25e8e-49d7-4603-af29-a21d85e5c551">
                      <pre class="scrollbar rounded-1" style="max-height:420px"><code class="language-html">&lt;div class=&quot;form-group&quot;&gt;
  &lt;label for=&quot;multiple-select&quot;&gt;Select options&lt;/label&gt;
  &lt;select class=&quot;form-select selectpicker&quot; id=&quot;multiple-select&quot; multiple=&quot;multiple&quot; data-options='{&quot;placeholder&quot;:&quot;Select your options&quot;}'&gt;
    &lt;option&gt;Afghanistan&lt;/option&gt;
...
&lt;script src=&quot;vendors/select2/select2.full.min.js&quot;&gt;&lt;/script&gt;</code></pre>
                  <h5 class="mb-0">Stylesheets </h5>
                  <pre class="scrollbar mt-2"><code class="language-html">&lt;script src=&quot;vendors/select2/select2.min.css&quot;&gt;&lt;/script&gt;
