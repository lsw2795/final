              ...
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                ...
                <li class="nav-item">
                  ...
                  <ul class="nav collapse show" id="components">
                    <li class="nav-item"><a class="nav-link active" href="../../modules/components/accordion.jsp">
          ...
          <div class="card mb-3">
            ...
            <div class="card-body position-relative">
              <div class="row">
                <div class="col-lg-8">
                  <h3>Accordion</h3>
                  <p class="mb-0">An accordion allows users to toggle the display of sections of content</p><a class="btn btn-link btn-sm ps-0 mt-2" href="https://getbootstrap.com/docs/5.3/components/accordion" target="_blank">Accordion on Bootstrap<span class="fas fa-chevron-right ms-1 fs--2"></span></a>
                </div>
              </div>
            </div>
          </div>
          <div class="card">
              ...
              <div class="row flex-between-end">
                ...
                <div class="col-auto ms-auto">
                  <div class="nav nav-pills nav-pills-falcon flex-grow-1 mt-2" role="tablist">
                    <button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-56da4d99-0191-4d75-961b-bac8cf7bea0f" type="button" role="tab" aria-controls="dom-56da4d99-0191-4d75-961b-bac8cf7bea0f" aria-selected="true" id="tab-dom-56da4d99-0191-4d75-961b-bac8cf7bea0f">Preview</button>
                    <button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-5a0a3a84-39fe-4f7c-b979-a4bf03b9877f" type="button" role="tab" aria-controls="dom-5a0a3a84-39fe-4f7c-b979-a4bf03b9877f" aria-selected="false" id="tab-dom-5a0a3a84-39fe-4f7c-b979-a4bf03b9877f">Code</button>
                  </div>
                </div>
              </div>
            </div>
            <div class="card-body bg-light">
              <div class="tab-content">
                <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-56da4d99-0191-4d75-961b-bac8cf7bea0f" id="dom-56da4d99-0191-4d75-961b-bac8cf7bea0f">
                ...
                <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-5a0a3a84-39fe-4f7c-b979-a4bf03b9877f" id="dom-5a0a3a84-39fe-4f7c-b979-a4bf03b9877f">
