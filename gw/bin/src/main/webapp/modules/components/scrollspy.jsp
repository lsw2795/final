...
<html data-bs-theme="light" lang="en-US" dir="ltr">
  ...
  <body data-bs-spy="scroll" data-bs-target="#v-pills" data-bs-offset="100" tabindex="0">
              ...
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                ...
                <li class="nav-item">
                  ...
                  <ul class="nav collapse show" id="components">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="../../modules/components/scrollspy.jsp">
          ...
          <div class="card mb-3">
            ...
            <div class="card-body position-relative">
              <div class="row">
                <div class="col-lg-8">
                  <h3>Scrollspy</h3>
                  <p class="mb-0">Automatically update Bootstrap navigation or list group components based on scroll position to indicate which link is currently active in the viewport.</p><a class="btn btn-link btn-sm ps-0 mt-2" href="https://getbootstrap.com/docs/5.3/components/scrollspy/" target="_blank">Scrollspy on Bootstrap<span class="fas fa-chevron-right ms-1 fs--2"></span></a>
                </div>
              </div>
            </div>
          </div>
              ...
              <div class="row">
                <div class="col-sm-auto">
                  <div class="sticky-top pt-sm-7 mb-3">
                    <div class="nav flex-column nav-pills" id="v-pills"><a class="nav-link ps-0 ps-sm-3" href="#v-pills-home">Home</a><a class="nav-link ps-0 ps-sm-3" href="#v-pills-profile">Profile</a><a class="nav-link ps-0 ps-sm-3" href="#v-pills-messages">Messages</a><a class="nav-link ps-0 ps-sm-3" href="#v-pills-settings">Settings</a>
                    </div>
                  </div>
                </div>
                <div class="col-sm">
