              ...
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                ...
                <li class="nav-item">
                  ...
                  <ul class="nav collapse show" id="components">
                    ...
                    <li class="nav-item"><a class="nav-link dropdown-indicator" href="#navs-_and_-Tabs" data-bs-toggle="collapse" aria-expanded="true" aria-controls="components">
                        <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Navs &amp; Tabs</span>
                        </div>
                      </a>
                      <!-- more inner pages-->
                      <ul class="nav collapse show" id="navs-_and_-Tabs">
                        ...
                        <li class="nav-item"><a class="nav-link active" href="../../../modules/components/navs-and-tabs/vertical-navbar.jsp">
                            <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Navbar vertical</span>
                            </div>
                          </a>
                          <!-- more inner pages-->
...
navbarVerticalToggle.addEventListener('navbar.vertical.toggle', function () {
  // do something...
          ...
          <div class="card mb-3">
            <div class="card-body">
              <div class="d-flex align-items-start"><img class="me-3 border border-2 rounded-3 bg-200" src="../../../assets/img/generic/default.png" alt="" width="100" />
                <div class="flex-1">
                  <h5 class="mb-0" data-anchor="data-anchor">Navbar Vertical Default</h5>
                  <p class="mb-1">Falcon lets you choose your own custom colors and customize Default Navbar Vertical.</p><a class="btn btn-link btn-sm ps-0" href="../../../demo/navbar-vertical.jsp" target="_blank"> See the implementation here <span class="fas fa-chevron-right ms-1 fs--2"></span></a>
                </div>
              </div>
            </div>
          </div>
          <div class="card mb-3">
            ...
            <div class="card-body bg-light">
              <p>Class <code>.navbar-vertical </code>represents the default Transparent Vertical Navbar.</p>
              <pre class="scrollbar mt-2 mb-3"><code class="language-html">&lt;nav class=&quot;navbar navbar-vertical navbar-expand-xl navbar-light&quot;&gt;
  ...
  &lt;/div&gt;
&lt;/nav&gt;</code></pre>
              <p>You can change <code>background-color </code>by adding <code>.bg-* </code>utility classes in <code>.navbar-collapse </code>element or you can update globally using the SCSS or CSS variable which is described in Customize section below.</p>
 ...
 &lt;/div&gt;</code></pre>
          ...
          <div class="card mb-3">
            ...
            <div class="card-body bg-light">
              <p>Falcon allow you to customize your Navbar Vertical with SCSS or CSS variables. The available options are listed below: </p>
              <h6 class="fs-0">Background color</h6>
              <p class="mb-2">To change the background color
                of the
                Navbar Vertical
                , update the SCSS variable <code>$navbar-vertical-default-bg-color</code> in your <code>_user-variables.scss </code>or CSS variable <code>--falcon-navbar-vertical-default-bg-color</code> in your <code>public/assets/css/user.css</code>. Example:
              </p>
              <pre class="scrollbar mt-2 mb-4"><code class="language-css">//- _user-variables.scss
$navbar-vertical-default-bg-color: #ff0000;
or,
//- public/assets/css/user.css
--falcon-navbar-vertical-default-bg-color: #ff0000;</code></pre>
              <h6 class="fs-0">Link color</h6>
              <p class="mb-2">To change the link color
                of the
                Navbar Vertical
                , update the SCSS variable <code>$navbar-vertical-default-link-color</code> in your <code>_user-variables.scss </code>or CSS variable <code>--falcon-navbar-vertical-default-link-color</code> in your <code>public/assets/css/user.css</code>. Example:
              </p>
              <pre class="scrollbar mt-2 mb-4"><code class="language-css">//- _user-variables.scss
$navbar-vertical-default-link-color: #ff0000;
or,
//- public/assets/css/user.css
--falcon-navbar-vertical-default-link-color: #ff0000;</code></pre>
              <h6 class="fs-0">Link hover color</h6>
              <p class="mb-2">To change the link hover color
                of the
                Navbar Vertical
                , update the SCSS variable <code>$navbar-vertical-default-link-hover-color</code> in your <code>_user-variables.scss </code>or CSS variable <code>--falcon-navbar-vertical-default-link-hover-color</code> in your <code>public/assets/css/user.css</code>. Example:
              </p>
              <pre class="scrollbar mt-2 mb-4"><code class="language-css">//- _user-variables.scss
$navbar-vertical-default-link-hover-color: #ff0000;
or,
//- public/assets/css/user.css
--falcon-navbar-vertical-default-link-hover-color: #ff0000;</code></pre>
              <h6 class="fs-0">Link active color</h6>
              <p class="mb-2">To change the link active color
                of the
                Navbar Vertical
                , update the SCSS variable <code>$navbar-vertical-default-link-active-color</code> in your <code>_user-variables.scss </code>or CSS variable <code>--falcon-navbar-vertical-default-link-active-color</code> in your <code>public/assets/css/user.css</code>. Example:
              </p>
              <pre class="scrollbar mt-2 mb-4"><code class="language-css">//- _user-variables.scss
$navbar-vertical-default-link-active-color: #ff0000;
or,
//- public/assets/css/user.css
--falcon-navbar-vertical-default-link-active-color: #ff0000;</code></pre>
              <h6 class="fs-0">Divider color</h6>
              <p class="mb-2">To change the divider color
                of the
                Navbar Vertical
                , update the SCSS variable <code>$navbar-vertical-default-hr-color</code> in your <code>_user-variables.scss </code>or CSS variable <code>--falcon-navbar-vertical-default-hr-color</code> in your <code>public/assets/css/user.css</code>. Example:
              </p>
              <pre class="scrollbar mt-2 mb-4"><code class="language-css">//- _user-variables.scss
$navbar-vertical-default-hr-color: #ff0000;
or,
//- public/assets/css/user.css
--falcon-navbar-vertical-default-hr-color: #ff0000;</code></pre>
              <h6 class="fs-0">Scrollbar color</h6>
              <p class="mb-2">To change the scrollbar color
                of the
                Navbar Vertical
                , update the SCSS variable <code>$navbar-vertical-default-scrollbar-color</code> in your <code>_user-variables.scss </code>or CSS variable <code>--falcon-navbar-vertical-default-scrollbar-color</code> in your <code>public/assets/css/user.css</code>. Example:
              </p>
              <pre class="scrollbar mt-2 mb-4"><code class="language-css">//- _user-variables.scss
$navbar-vertical-default-scrollbar-color: #ff0000;
or,
//- public/assets/css/user.css
--falcon-navbar-vertical-default-scrollbar-color: #ff0000;</code></pre>
            </div>
          </div>
          <div class="card mb-3">
            <div class="card-body">
              <div class="d-flex align-items-start"><img class="me-3 border border-2 rounded-3 bg-200" src="../../../assets/img/generic/inverted.png" alt="" width="100" />
                <div class="flex-1">
                  <h5 class="mb-0" data-anchor="data-anchor">Navbar Vertical Inverted</h5>
                  <p class="mb-1">You can update your Navbar Vertical <code>background-color</code> with Navbar Vertical Inverted.</p><a class="btn btn-link btn-sm ps-0" href="../../../demo/navbar-vertical-inverted.jsp" target="_blank"> See the implementation here <span class="fas fa-chevron-right ms-1 fs--2"></span></a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="card mb-3">
            ...
            <div class="card-body bg-light">
              ...
              <p class="mb-2">To change the background color
                ...
                , update the SCSS variable <code>$navbar-vertical-inverted-bg-color</code> in your <code>_user-variables.scss </code>or CSS variable <code>--falcon-navbar-vertical-inverted-bg-color</code> in your <code>public/assets/css/user.css</code>. Example:
              </p>
              <pre class="scrollbar mt-2 mb-4"><code class="language-css">//- _user-variables.scss
$navbar-vertical-inverted-bg-color: #ff0000;
or,
//- public/assets/css/user.css
--falcon-navbar-vertical-inverted-bg-color: #ff0000;</code></pre>
              <h6 class="fs-0">Link color</h6>
              <p class="mb-2">To change the link color
                of the
                Navbar Vertical Inverted
                , update the SCSS variable <code>$navbar-vertical-inverted-link-color</code> in your <code>_user-variables.scss </code>or CSS variable <code>--falcon-navbar-vertical-inverted-link-color</code> in your <code>public/assets/css/user.css</code>. Example:
              </p>
              <pre class="scrollbar mt-2 mb-4"><code class="language-css">//- _user-variables.scss
$navbar-vertical-inverted-link-color: #ff0000;
or,
//- public/assets/css/user.css
--falcon-navbar-vertical-inverted-link-color: #ff0000;</code></pre>
              <h6 class="fs-0">Link hover color</h6>
              <p class="mb-2">To change the link hover color
                of the
                Navbar Vertical Inverted
                , update the SCSS variable <code>$navbar-vertical-inverted-link-hover-color</code> in your <code>_user-variables.scss </code>or CSS variable <code>--falcon-navbar-vertical-inverted-link-hover-color</code> in your <code>public/assets/css/user.css</code>. Example:
              </p>
              <pre class="scrollbar mt-2 mb-4"><code class="language-css">//- _user-variables.scss
$navbar-vertical-inverted-link-hover-color: #ff0000;
or,
//- public/assets/css/user.css
--falcon-navbar-vertical-inverted-link-hover-color: #ff0000;</code></pre>
              <h6 class="fs-0">Link active color</h6>
              <p class="mb-2">To change the link active color
                of the
                Navbar Vertical Inverted
                , update the SCSS variable <code>$navbar-vertical-inverted-link-active-color</code> in your <code>_user-variables.scss </code>or CSS variable <code>--falcon-navbar-vertical-inverted-link-active-color</code> in your <code>public/assets/css/user.css</code>. Example:
              </p>
              <pre class="scrollbar mt-2 mb-4"><code class="language-css">//- _user-variables.scss
$navbar-vertical-inverted-link-active-color: #ff0000;
or,
//- public/assets/css/user.css
--falcon-navbar-vertical-inverted-link-active-color: #ff0000;</code></pre>
              <h6 class="fs-0">Divider color</h6>
              <p class="mb-2">To change the divider color
                of the
                Navbar Vertical Inverted
                , update the SCSS variable <code>$navbar-vertical-inverted-hr-color</code> in your <code>_user-variables.scss </code>or CSS variable <code>--falcon-navbar-vertical-inverted-hr-color</code> in your <code>public/assets/css/user.css</code>. Example:
              </p>
              <pre class="scrollbar mt-2 mb-4"><code class="language-css">//- _user-variables.scss
$navbar-vertical-inverted-hr-color: #ff0000;
or,
//- public/assets/css/user.css
--falcon-navbar-vertical-inverted-hr-color: #ff0000;</code></pre>
              <h6 class="fs-0">Scrollbar color</h6>
              <p class="mb-2">To change the scrollbar color
                of the
                Navbar Vertical Inverted
                , update the SCSS variable <code>$navbar-vertical-inverted-scrollbar-color</code> in your <code>_user-variables.scss </code>or CSS variable <code>--falcon-navbar-vertical-inverted-scrollbar-color</code> in your <code>public/assets/css/user.css</code>. Example:
              </p>
              <pre class="scrollbar mt-2 mb-4"><code class="language-css">//- _user-variables.scss
$navbar-vertical-inverted-scrollbar-color: #ff0000;
or,
//- public/assets/css/user.css
--falcon-navbar-vertical-inverted-scrollbar-color: #ff0000;</code></pre>
            </div>
          </div>
          <div class="card mb-3">
            <div class="card-body">
              <div class="d-flex align-items-start"><img class="me-3 border border-2 rounded-3 bg-200" src="../../../assets/img/generic/vibrant.png" alt="" width="100" />
                <div class="flex-1">
                  <h5 class="mb-0" data-anchor="data-anchor">Navbar Vertical Vibrant</h5>
                  <p class="mb-1">Make your Navbar Vertical more live and awesome with Falcon Navbar Vibrant.</p><a class="btn btn-link btn-sm ps-0" href="../../../demo/navbar-vertical-vibrant.jsp" target="_blank"> See the implementation here <span class="fas fa-chevron-right ms-1 fs--2"></span></a>
                </div>
              </div>
            </div>
          </div>
...
&lt;/div&gt;</code></pre>
          ...
          <div class="card mb-3">
            ...
            <div class="card-body bg-light">
              ...
              <p class="mb-2">To change the background
                of the
                Navbar Vertical Vibrant
                , update the SCSS variable <code>$navbar-vertical-vibrant-bg-image</code> in your <code>_user-variables.scss </code>or CSS variable <code>--falcon-navbar-vertical-vibrant-bg-image</code> in your <code>public/assets/css/user.css</code>. Example:
              </p>
              <pre class="scrollbar mt-2 mb-4"><code class="language-css">//- _user-variables.scss
$navbar-vertical-vibrant-bg-image: linear-gradient(-45deg,rgba(0, 160, 255, 0.86),#0048a2);
or,
//- public/assets/css/user.css
--falcon-navbar-vertical-vibrant-bg-image: linear-gradient(-45deg,rgba(0, 160, 255, 0.86),#0048a2);</code></pre>
              <h6 class="fs-0">Link color</h6>
              <p class="mb-2">To change the link color
                of the
                Navbar Vertical Vibrant
                , update the SCSS variable <code>$navbar-vertical-vibrant-link-color</code> in your <code>_user-variables.scss </code>or CSS variable <code>--falcon-navbar-vertical-vibrant-link-color</code> in your <code>public/assets/css/user.css</code>. Example:
              </p>
              <pre class="scrollbar mt-2 mb-4"><code class="language-css">//- _user-variables.scss
$navbar-vertical-vibrant-link-color: #ff0000;
or,
//- public/assets/css/user.css
--falcon-navbar-vertical-vibrant-link-color: #ff0000;</code></pre>
              <h6 class="fs-0">Link hover color</h6>
              <p class="mb-2">To change the link hover color
                of the
                Navbar Vertical Vibrant
                , update the SCSS variable <code>$navbar-vertical-vibrant-link-hover-color</code> in your <code>_user-variables.scss </code>or CSS variable <code>--falcon-navbar-vertical-vibrant-link-hover-color</code> in your <code>public/assets/css/user.css</code>. Example:
              </p>
              <pre class="scrollbar mt-2 mb-4"><code class="language-css">//- _user-variables.scss
$navbar-vertical-vibrant-link-hover-color: #ff0000;
or,
//- public/assets/css/user.css
--falcon-navbar-vertical-vibrant-link-hover-color: #ff0000;</code></pre>
              <h6 class="fs-0">Link active color</h6>
              <p class="mb-2">To change the link active color
                of the
                Navbar Vertical Vibrant
                , update the SCSS variable <code>$navbar-vertical-vibrant-link-active-color</code> in your <code>_user-variables.scss </code>or CSS variable <code>--falcon-navbar-vertical-vibrant-link-active-color</code> in your <code>public/assets/css/user.css</code>. Example:
              </p>
              <pre class="scrollbar mt-2 mb-4"><code class="language-css">//- _user-variables.scss
$navbar-vertical-vibrant-link-active-color: #ff0000;
or,
//- public/assets/css/user.css
--falcon-navbar-vertical-vibrant-link-active-color: #ff0000;</code></pre>
              <h6 class="fs-0">Divider color</h6>
              <p class="mb-2">To change the divider color
                of the
                Navbar Vertical Vibrant
                , update the SCSS variable <code>$navbar-vertical-vibrant-hr-color</code> in your <code>_user-variables.scss </code>or CSS variable <code>--falcon-navbar-vertical-vibrant-hr-color</code> in your <code>public/assets/css/user.css</code>. Example:
              </p>
              <pre class="scrollbar mt-2 mb-4"><code class="language-css">//- _user-variables.scss
$navbar-vertical-vibrant-hr-color: #ff0000;
or,
//- public/assets/css/user.css
--falcon-navbar-vertical-vibrant-hr-color: #ff0000;</code></pre>
              <h6 class="fs-0">Scrollbar color</h6>
              <p class="mb-2">To change the scrollbar color
                of the
                Navbar Vertical Vibrant
                , update the SCSS variable <code>$navbar-vertical-vibrant-scrollbar-color</code> in your <code>_user-variables.scss </code>or CSS variable <code>--falcon-navbar-vertical-vibrant-scrollbar-color</code> in your <code>public/assets/css/user.css</code>. Example:
              </p>
              <pre class="scrollbar mt-2 mb-4"><code class="language-css">//- _user-variables.scss
$navbar-vertical-vibrant-scrollbar-color: #ff0000;
or,
//- public/assets/css/user.css
--falcon-navbar-vertical-vibrant-scrollbar-color: #ff0000;</code></pre>
            </div>
          </div>
          <div class="card mb-3">
            <div class="card-body">
              <div class="d-flex align-items-start"><img class="me-3 border border-2 rounded-3 bg-200" src="../../../assets/img/generic/card.png" alt="" width="100" />
                <div class="flex-1">
                  <h5 class="mb-0" data-anchor="data-anchor">Navbar Vertical Card</h5>
                  <p class="mb-1">Make your navbar vertical like Falcon card by using Navbar Vertical Card.</p><a class="btn btn-link btn-sm ps-0" href="../../../demo/navbar-vertical-card.jsp" target="_blank"> See the implementation here <span class="fas fa-chevron-right ms-1 fs--2"></span></a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="card">
            ...
            <div class="card-body bg-light">
              ...
              <p class="mb-2">To change the background color
                ...
                , update the SCSS variable <code>$navbar-vertical-card-bg-color</code> in your <code>_user-variables.scss </code>or CSS variable <code>--falcon-navbar-vertical-card-bg-color</code> in your <code>public/assets/css/user.css</code>. Example:
              </p>
              <pre class="scrollbar mt-2 mb-4"><code class="language-css">//- _user-variables.scss
$navbar-vertical-card-bg-color: #ff0000;
or,
//- public/assets/css/user.css
--falcon-navbar-vertical-card-bg-color: #ff0000;</code></pre>
              <h6 class="fs-0">Link color</h6>
              <p class="mb-2">To change the link color
                of the
                Navbar Vertical Card
                , update the SCSS variable <code>$navbar-vertical-card-link-color</code> in your <code>_user-variables.scss </code>or CSS variable <code>--falcon-navbar-vertical-card-link-color</code> in your <code>public/assets/css/user.css</code>. Example:
              </p>
              <pre class="scrollbar mt-2 mb-4"><code class="language-css">//- _user-variables.scss
$navbar-vertical-card-link-color: #ff0000;
or,
//- public/assets/css/user.css
--falcon-navbar-vertical-card-link-color: #ff0000;</code></pre>
              <h6 class="fs-0">Link hover color</h6>
              <p class="mb-2">To change the link hover color
                of the
                Navbar Vertical Card
                , update the SCSS variable <code>$navbar-vertical-card-link-hover-color</code> in your <code>_user-variables.scss </code>or CSS variable <code>--falcon-navbar-vertical-card-link-hover-color</code> in your <code>public/assets/css/user.css</code>. Example:
              </p>
              <pre class="scrollbar mt-2 mb-4"><code class="language-css">//- _user-variables.scss
$navbar-vertical-card-link-hover-color: #ff0000;
or,
//- public/assets/css/user.css
--falcon-navbar-vertical-card-link-hover-color: #ff0000;</code></pre>
              <h6 class="fs-0">Link active color</h6>
              <p class="mb-2">To change the link active color
                of the
                Navbar Vertical Card
                , update the SCSS variable <code>$navbar-vertical-card-link-active-color</code> in your <code>_user-variables.scss </code>or CSS variable <code>--falcon-navbar-vertical-card-link-active-color</code> in your <code>public/assets/css/user.css</code>. Example:
              </p>
              <pre class="scrollbar mt-2 mb-4"><code class="language-css">//- _user-variables.scss
$navbar-vertical-card-link-active-color: #ff0000;
or,
//- public/assets/css/user.css
--falcon-navbar-vertical-card-link-active-color: #ff0000;</code></pre>
              <h6 class="fs-0">Divider color</h6>
              <p class="mb-2">To change the divider color
                of the
                Navbar Vertical Card
                , update the SCSS variable <code>$navbar-vertical-card-hr-color</code> in your <code>_user-variables.scss </code>or CSS variable <code>--falcon-navbar-vertical-card-hr-color</code> in your <code>public/assets/css/user.css</code>. Example:
              </p>
              <pre class="scrollbar mt-2 mb-4"><code class="language-css">//- _user-variables.scss
$navbar-vertical-card-hr-color: #ff0000;
or,
//- public/assets/css/user.css
--falcon-navbar-vertical-card-hr-color: #ff0000;</code></pre>
              <h6 class="fs-0">Scrollbar color</h6>
              <p class="mb-2">To change the scrollbar color
                of the
                Navbar Vertical Card
                , update the SCSS variable <code>$navbar-vertical-card-scrollbar-color</code> in your <code>_user-variables.scss </code>or CSS variable <code>--falcon-navbar-vertical-card-scrollbar-color</code> in your <code>public/assets/css/user.css</code>. Example:
              </p>
              <pre class="scrollbar mt-2 mb-4"><code class="language-css">//- _user-variables.scss
$navbar-vertical-card-scrollbar-color: #ff0000;
or,
//- public/assets/css/user.css
--falcon-navbar-vertical-card-scrollbar-color: #ff0000;</code></pre>
            </div>
          </div>
          <footer class="footer">
