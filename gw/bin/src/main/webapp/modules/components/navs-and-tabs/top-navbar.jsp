                  ...
                  <ul class="nav collapse show" id="components">
                    ...
                    <li class="nav-item"><a class="nav-link dropdown-indicator" href="#navs-_and_-Tabs" data-bs-toggle="collapse" aria-expanded="true" aria-controls="components">
                      ...
                      <ul class="nav collapse show" id="navs-_and_-Tabs">
                        ...
                        <li class="nav-item"><a class="nav-link active" href="../../../modules/components/navs-and-tabs/top-navbar.jsp">
                            <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Top nav</span>
                            </div>
                          </a>
                          <!-- more inner pages-->
          ...
          <div class="card mb-3">
            ...
            <div class="card-body position-relative">
              <div class="row">
                <div class="col-lg-8">
                  <h3>Navbar Top</h3>
                  <p class="mb-0">Navbar Top is a different user friendly layout system in Falcon.</p><a class="btn btn-link btn-sm ps-0 mt-2" href="../../../demo/navbar-top.jsp" target="_blank">Navbar top example page<span class="fas fa-chevron-right ms-1 fs--2"></span></a>
                </div>
              </div>
            </div>
          </div>
