                  ...
                  <ul class="nav collapse show" id="components">
                    ...
                    <li class="nav-item"><a class="nav-link dropdown-indicator" href="#navs-_and_-Tabs" data-bs-toggle="collapse" aria-expanded="true" aria-controls="components">
                      ...
                      <ul class="nav collapse show" id="navs-_and_-Tabs">
                        ...
                        <li class="nav-item"><a class="nav-link active" href="../../../modules/components/navs-and-tabs/combo-navbar.jsp">
                            <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Combo nav</span>
                            </div>
                          </a>
                          <!-- more inner pages-->
        ...
        <div class="content">
          ...
          <div class="card mb-3">
            ...
            <div class="card-body position-relative">
              <div class="row">
                <div class="col-lg-8">
                  <h3>Combo Nav</h3>
                  <p class="mb-0">Combo Nav is an additional layout system of Falcon where you can place both Navbar Top and Navbar Vertical in a same page.</p><a class="btn btn-link btn-sm ps-0 mt-2" href="../../../demo/combo-nav.jsp" target="_blank">Combo Nav Example Page<span class="fas fa-chevron-right ms-1 fs--2"></span></a>
                </div>
              </div>
            </div>
          </div>
          <div class="card mb-3">
            ...
            <div class="card-body bg-light">
              <p>Convert any page to Combo Nav layout easily by using Falcon's <a href="../../../modules/components/navs-and-tabs/vertical-navbar.jsp" target="_blank">Navbar Vertical </a>and <a href="../../../modules/components/navs-and-tabs/top-navbar.jsp" target="_blank">Navbar Top </a>. The structure of combo nav layout will like this:</p>
