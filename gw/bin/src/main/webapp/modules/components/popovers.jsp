              ...
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                ...
                <li class="nav-item">
                  ...
                  <ul class="nav collapse show" id="components">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="../../modules/components/popovers.jsp">
          ...
          <div class="card mb-3">
              ...
              <div class="row flex-between-end">
                ...
                <div class="col-auto ms-auto">
                  <div class="nav nav-pills nav-pills-falcon flex-grow-1" role="tablist">
                    <button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-115ee862-d396-42d8-9b0e-57eb7e07782d" type="button" role="tab" aria-controls="dom-115ee862-d396-42d8-9b0e-57eb7e07782d" aria-selected="true" id="tab-dom-115ee862-d396-42d8-9b0e-57eb7e07782d">Preview</button>
                    <button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-06dfe7f0-c388-4637-bb3e-928a5f8936c2" type="button" role="tab" aria-controls="dom-06dfe7f0-c388-4637-bb3e-928a5f8936c2" aria-selected="false" id="tab-dom-06dfe7f0-c388-4637-bb3e-928a5f8936c2">Code</button>
                  </div>
                </div>
              </div>
            </div>
            <div class="card-body bg-light">
              <div class="tab-content">
                <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-115ee862-d396-42d8-9b0e-57eb7e07782d" id="dom-115ee862-d396-42d8-9b0e-57eb7e07782d">
                  <div class="row g-1">
                    <div class="col-auto">
                ...
                <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-06dfe7f0-c388-4637-bb3e-928a5f8936c2" id="dom-06dfe7f0-c388-4637-bb3e-928a5f8936c2">
...
&lt;/div&gt;</code></pre>
          ...
          <div class="card mb-3">
            <div class="card-header">
              <div class="row flex-between-end">
                <div class="col-auto align-self-center">
                  <h5 class="mb-0" data-anchor="data-anchor">Examples</h5>
                  <div class="mt-2">
                    <p class='mt-2 mb-0'>Use the <code>data-bs-trigger="focus"</code> to dismiss popovers on the user’s next click of a different element than the toggle element.</p>
                  </div>
                </div>
                <div class="col-auto ms-auto">
                  <div class="nav nav-pills nav-pills-falcon flex-grow-1" role="tablist">
                    <button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-13800c77-c554-4368-b21c-cae061f9103d" type="button" role="tab" aria-controls="dom-13800c77-c554-4368-b21c-cae061f9103d" aria-selected="true" id="tab-dom-13800c77-c554-4368-b21c-cae061f9103d">Preview</button>
                    <button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-5a2b35b3-42cf-413d-8149-70c5975b2036" type="button" role="tab" aria-controls="dom-5a2b35b3-42cf-413d-8149-70c5975b2036" aria-selected="false" id="tab-dom-5a2b35b3-42cf-413d-8149-70c5975b2036">Code</button>
                  </div>
                </div>
              </div>
            </div>
            <div class="card-body bg-light">
              <div class="tab-content">
                <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-13800c77-c554-4368-b21c-cae061f9103d" id="dom-13800c77-c554-4368-b21c-cae061f9103d"><a class="btn btn-lg btn-danger" tabindex="0" role="button" data-bs-toggle="popover" title="Dismissible popover" data-bs-content="And here's some amazing content. It's very engaging. Right?">Dismissible popover</a>

                </div>
                <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-5a2b35b3-42cf-413d-8149-70c5975b2036" id="dom-5a2b35b3-42cf-413d-8149-70c5975b2036">
