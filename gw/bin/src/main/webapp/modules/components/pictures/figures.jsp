                  ...
                  <ul class="nav collapse show" id="components">
                    ...
                    <li class="nav-item"><a class="nav-link dropdown-indicator" href="#pictures" data-bs-toggle="collapse" aria-expanded="true" aria-controls="components">
                      ...
                      <ul class="nav collapse show" id="pictures">
                        ...
                        <li class="nav-item"><a class="nav-link active" href="../../../modules/components/pictures/figures.jsp">
          ...
          <div class="card mb-3">
            ...
            <div class="card-body position-relative">
              <div class="row">
                <div class="col-lg-8">
                  <h3>Figures</h3>
                  <p class="mb-0">Documentation and examples for displaying related images and text with the figure component in Bootstrap.</p><a class="btn btn-link btn-sm ps-0 mt-2" href="https://getbootstrap.com/docs/5.3/content/figures/" target="_blank">Figures on Bootstrap<span class="fas fa-chevron-right ms-1 fs--2"></span></a>
                </div>
              </div>
            </div>
          </div>
          <div class="card mb-3">
            <div class="card-header">
              <div class="row flex-between-end">
                <div class="col-auto align-self-center">
                  ...
                  <p class="mb-0 pt-1 mt-2 mb-0">Anytime you need to display a piece of content—like an image with an optional caption, consider using a <code>figure</code>.</p>
                </div>
                <div class="col-auto ms-auto">
                  <div class="nav nav-pills nav-pills-falcon flex-grow-1 mt-2" role="tablist">
                    <button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-9227b8a5-9914-4da4-bb13-ffded4668fd1" type="button" role="tab" aria-controls="dom-9227b8a5-9914-4da4-bb13-ffded4668fd1" aria-selected="true" id="tab-dom-9227b8a5-9914-4da4-bb13-ffded4668fd1">Preview</button>
                    <button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-343a14ac-a662-4b67-a0b5-8ec782989b01" type="button" role="tab" aria-controls="dom-343a14ac-a662-4b67-a0b5-8ec782989b01" aria-selected="false" id="tab-dom-343a14ac-a662-4b67-a0b5-8ec782989b01">Code</button>
                  </div>
                </div>
              </div>
            </div>
            <div class="card-body bg-light">
              <div class="tab-content">
                <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-9227b8a5-9914-4da4-bb13-ffded4668fd1" id="dom-9227b8a5-9914-4da4-bb13-ffded4668fd1">
                  <figure class="figure"><img class="figure-img img-fluid rounded" src="../../../assets/img/team/24.jpg" alt="..." />
                    <figcaption class="figure-caption">A caption for the above image.</figcaption>
                  </figure>
                </div>
                <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-343a14ac-a662-4b67-a0b5-8ec782989b01" id="dom-343a14ac-a662-4b67-a0b5-8ec782989b01">
                  <pre class="scrollbar rounded-1" style="max-height:420px"><code class="language-html">&lt;figure class=&quot;figure&quot;&gt;&lt;img class=&quot;figure-img img-fluid rounded&quot; src=&quot;../../../assets/img/team/24.jpg&quot; alt=&quot;...&quot; /&gt;
  &lt;figcaption class=&quot;figure-caption&quot;&gt;A caption for the above image.&lt;/figcaption&gt;
&lt;/figure&gt;</code></pre>
                </div>
              </div>
          ...
          <div class="card mb-3">
            <div class="card-header">
              <div class="row flex-between-end">
                <div class="col-auto align-self-center">
                  ...
                  <p class="mb-0 pt-1 mt-2 mb-0">Aligning the figure’s caption is easy with bootstrap <a href="https://getbootstrap.com/docs/5.3/utilities/text/#text-alignment">text utilities</a></p>
                </div>
                <div class="col-auto ms-auto">
                  <div class="nav nav-pills nav-pills-falcon flex-grow-1 mt-2" role="tablist">
                    <button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-dfab8711-a122-4fad-8ac5-f667e4bffc0b" type="button" role="tab" aria-controls="dom-dfab8711-a122-4fad-8ac5-f667e4bffc0b" aria-selected="true" id="tab-dom-dfab8711-a122-4fad-8ac5-f667e4bffc0b">Preview</button>
                    <button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-543cddbe-d503-497c-90e9-f5ffe94be0e8" type="button" role="tab" aria-controls="dom-543cddbe-d503-497c-90e9-f5ffe94be0e8" aria-selected="false" id="tab-dom-543cddbe-d503-497c-90e9-f5ffe94be0e8">Code</button>
                  </div>
                </div>
              </div>
            </div>
            <div class="card-body bg-light">
              <div class="tab-content">
                <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-dfab8711-a122-4fad-8ac5-f667e4bffc0b" id="dom-dfab8711-a122-4fad-8ac5-f667e4bffc0b">
                  <figure class="figure"><img class="figure-img img-fluid rounded" src="../../../assets/img/team/25.jpg" alt="" />
                    <figcaption class="figure-caption text-end">A caption for the above image.</figcaption>
                  </figure>
                </div>
                <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-543cddbe-d503-497c-90e9-f5ffe94be0e8" id="dom-543cddbe-d503-497c-90e9-f5ffe94be0e8">
                  <pre class="scrollbar rounded-1" style="max-height:420px"><code class="language-html">&lt;figure class=&quot;figure&quot;&gt;&lt;img class=&quot;figure-img img-fluid rounded&quot; src=&quot;../../../assets/img/team/25.jpg&quot; alt=&quot;&quot; /&gt;
  &lt;figcaption class=&quot;figure-caption text-end&quot;&gt;A caption for the above image.&lt;/figcaption&gt;
&lt;/figure&gt;</code></pre>
                </div>
              </div>
