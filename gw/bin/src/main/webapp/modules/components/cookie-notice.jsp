              ...
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                ...
                <li class="nav-item">
                  ...
                  <ul class="nav collapse show" id="components">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="../../modules/components/cookie-notice.jsp">
                ...
                <table class="table table-bordered border border-200 fs--1 mb-0">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="white-space-nowrap">After how many time <i>(ms) </i>the cookie will expired. Count down starts after the user hits the “Close” or “OK, I UNDERSTAND” button on the cookie notice.</td>
                    </tr>
                  </tbody>
                </table>
              </div>
              ...
              <div class="card-body">
                <div class="d-flex">
                  ...
                  <div>
                    ...
                    <button class="btn btn-sm btn-falcon-primary me-3" type="button" data-bs-dismiss="toast" aria-label="Close">Okay</button><a class="learn-more me-3" href="#">Learn more<span class="fas fa-chevron-right ms-1 fs--2"></span></a>
                  </div>
                </div>
              </div>
            </div>
