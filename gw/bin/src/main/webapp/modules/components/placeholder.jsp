              ...
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                ...
                <li class="nav-item">
                  ...
                  <ul class="nav collapse show" id="components">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="../../modules/components/placeholder.jsp">
          ...
          <div class="card mb-3">
            ...
            <div class="card-body position-relative">
              <div class="row">
                <div class="col-lg-8">
                  <h3>Placeholder</h3>
                  <p class="mb-0">Use loading placeholders for your components or pages to indicate something may still be loading</p><a class="btn btn-link btn-sm ps-0 mt-2" href="https://getbootstrap.com/docs/5.3/components/placeholders/" target="_blank">Placeholders on Bootstrap<span class="fas fa-chevron-right ms-1 fs--2"></span></a>
                </div>
              </div>
            </div>
          </div>
          <div class="card mb-3">
            <div class="card-header">
              <div class="row flex-between-end">
                <div class="col-auto align-self-center">
                  ...
                  <div class="mt-2">
                    <p class='mt-2 mb-0'>In the example below, we take a typical card component and recreate it with placeholders applied to create a “loading card”. Size and proportions are the same between the two.</p>
                  </div>
                </div>
                <div class="col-auto ms-auto">
                  <div class="nav nav-pills nav-pills-falcon flex-grow-1" role="tablist">
                    <button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-0817ec4b-04ac-4fdb-9ea2-448108d01937" type="button" role="tab" aria-controls="dom-0817ec4b-04ac-4fdb-9ea2-448108d01937" aria-selected="true" id="tab-dom-0817ec4b-04ac-4fdb-9ea2-448108d01937">Preview</button>
                    <button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-1a0528bb-8c2e-43a9-b915-c0e9a66a5546" type="button" role="tab" aria-controls="dom-1a0528bb-8c2e-43a9-b915-c0e9a66a5546" aria-selected="false" id="tab-dom-1a0528bb-8c2e-43a9-b915-c0e9a66a5546">Code</button>
                  </div>
                </div>
              </div>
            </div>
            <div class="card-body bg-light">
              <div class="tab-content">
                <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-0817ec4b-04ac-4fdb-9ea2-448108d01937" id="dom-0817ec4b-04ac-4fdb-9ea2-448108d01937">
                ...
                <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-1a0528bb-8c2e-43a9-b915-c0e9a66a5546" id="dom-1a0528bb-8c2e-43a9-b915-c0e9a66a5546">
          ...
          <div class="card mb-3">
            <div class="card-header">
              <div class="row flex-between-end">
                ...
                <div class="col-auto ms-auto">
                  <div class="nav nav-pills nav-pills-falcon flex-grow-1" role="tablist">
                    <button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-d976188e-2e1f-441c-b44e-dd2bf8394935" type="button" role="tab" aria-controls="dom-d976188e-2e1f-441c-b44e-dd2bf8394935" aria-selected="true" id="tab-dom-d976188e-2e1f-441c-b44e-dd2bf8394935">Preview</button>
                    <button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-ddfcacd6-95ec-4e7e-b220-39229a032b03" type="button" role="tab" aria-controls="dom-ddfcacd6-95ec-4e7e-b220-39229a032b03" aria-selected="false" id="tab-dom-ddfcacd6-95ec-4e7e-b220-39229a032b03">Code</button>
                  </div>
                </div>
              </div>
            </div>
            <div class="card-body bg-light">
              <div class="tab-content">
                <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-d976188e-2e1f-441c-b44e-dd2bf8394935" id="dom-d976188e-2e1f-441c-b44e-dd2bf8394935"><span class="placeholder col-6"></span>
                  <span class="placeholder w-75"></span>
                  <span class="placeholder" style="width: 25%;"></span>
                </div>
                <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-ddfcacd6-95ec-4e7e-b220-39229a032b03" id="dom-ddfcacd6-95ec-4e7e-b220-39229a032b03">
          ...
          <div class="card mb-3">
            <div class="card-header">
              <div class="row flex-between-end">
                ...
                <div class="col-auto ms-auto">
                  <div class="nav nav-pills nav-pills-falcon flex-grow-1" role="tablist">
                    <button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-44ec26a3-e2b5-4b49-9e63-097ee8cc1040" type="button" role="tab" aria-controls="dom-44ec26a3-e2b5-4b49-9e63-097ee8cc1040" aria-selected="true" id="tab-dom-44ec26a3-e2b5-4b49-9e63-097ee8cc1040">Preview</button>
                    <button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-cbf6dc07-b858-4a16-b01a-1363b519e974" type="button" role="tab" aria-controls="dom-cbf6dc07-b858-4a16-b01a-1363b519e974" aria-selected="false" id="tab-dom-cbf6dc07-b858-4a16-b01a-1363b519e974">Code</button>
                  </div>
                </div>
              </div>
            </div>
            <div class="card-body bg-light">
              <div class="tab-content">
                <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-44ec26a3-e2b5-4b49-9e63-097ee8cc1040" id="dom-44ec26a3-e2b5-4b49-9e63-097ee8cc1040"><span class="placeholder col-12 bg-primary"></span>
                ...
                <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-cbf6dc07-b858-4a16-b01a-1363b519e974" id="dom-cbf6dc07-b858-4a16-b01a-1363b519e974">
          ...
          <div class="card mb-3">
            <div class="card-header">
              <div class="row flex-between-end">
                ...
                <div class="col-auto ms-auto">
                  <div class="nav nav-pills nav-pills-falcon flex-grow-1" role="tablist">
                    <button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-0222bddd-8566-4f4f-965f-7e0ef9c18b2a" type="button" role="tab" aria-controls="dom-0222bddd-8566-4f4f-965f-7e0ef9c18b2a" aria-selected="true" id="tab-dom-0222bddd-8566-4f4f-965f-7e0ef9c18b2a">Preview</button>
                    <button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-2e7182ab-b845-44a8-886b-7f83f3e62227" type="button" role="tab" aria-controls="dom-2e7182ab-b845-44a8-886b-7f83f3e62227" aria-selected="false" id="tab-dom-2e7182ab-b845-44a8-886b-7f83f3e62227">Code</button>
                  </div>
                </div>
              </div>
            </div>
            <div class="card-body bg-light">
              <div class="tab-content">
                <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-0222bddd-8566-4f4f-965f-7e0ef9c18b2a" id="dom-0222bddd-8566-4f4f-965f-7e0ef9c18b2a"><span class="placeholder col-12 placeholder-lg"></span>
                  <span class="placeholder col-12"></span>
                  <span class="placeholder col-12 placeholder-sm"></span>
                  <span class="placeholder col-12 placeholder-xs"></span>
                </div>
                <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-2e7182ab-b845-44a8-886b-7f83f3e62227" id="dom-2e7182ab-b845-44a8-886b-7f83f3e62227">
          ...
          <div class="card mb-3">
            <div class="card-header">
              <div class="row flex-between-end">
                ...
                <div class="col-auto ms-auto">
                  <div class="nav nav-pills nav-pills-falcon flex-grow-1" role="tablist">
                    <button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-cfe3076d-c8ac-4fe9-8b51-154ead3102ab" type="button" role="tab" aria-controls="dom-cfe3076d-c8ac-4fe9-8b51-154ead3102ab" aria-selected="true" id="tab-dom-cfe3076d-c8ac-4fe9-8b51-154ead3102ab">Preview</button>
                    <button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-8650298d-e200-48ba-9493-b64ded56e617" type="button" role="tab" aria-controls="dom-8650298d-e200-48ba-9493-b64ded56e617" aria-selected="false" id="tab-dom-8650298d-e200-48ba-9493-b64ded56e617">Code</button>
                  </div>
                </div>
              </div>
            </div>
            <div class="card-body bg-light">
              <div class="tab-content">
                <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-cfe3076d-c8ac-4fe9-8b51-154ead3102ab" id="dom-cfe3076d-c8ac-4fe9-8b51-154ead3102ab">
                ...
                <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-8650298d-e200-48ba-9493-b64ded56e617" id="dom-8650298d-e200-48ba-9493-b64ded56e617">
