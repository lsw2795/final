              ...
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                ...
                <li class="nav-item">
                  ...
                  <ul class="nav collapse show" id="components">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="../../modules/components/calendar.jsp">
          ...
          <div class="card mb-3">
            <div class="card-header">
              <div class="row flex-between-end">
                <div class="col-auto align-self-center">
                  ...
                  <p class="mb-0 pt-1 mt-2 mb-0">Basic example of FullCalendar with default options in Falcon. You can also pass the extra options using <code>data-calendar </code> attribute.<a href="../../app/calendar.jsp" target="_blank">See advanced implementation of fullCalendar </a></p>
                </div>
                <div class="col-auto ms-auto">
                  <div class="nav nav-pills nav-pills-falcon flex-grow-1 mt-2" role="tablist">
                    <button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-40110135-6fbf-4076-94b7-24895524c693" type="button" role="tab" aria-controls="dom-40110135-6fbf-4076-94b7-24895524c693" aria-selected="true" id="tab-dom-40110135-6fbf-4076-94b7-24895524c693">Preview</button>
                    <button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-c27bc163-3425-445c-b26e-aa9338733d13" type="button" role="tab" aria-controls="dom-c27bc163-3425-445c-b26e-aa9338733d13" aria-selected="false" id="tab-dom-c27bc163-3425-445c-b26e-aa9338733d13">Code</button>
                  </div>
                </div>
              </div>
            </div>
            <div class="card-body bg-light">
              <div class="tab-content">
                <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-40110135-6fbf-4076-94b7-24895524c693" id="dom-40110135-6fbf-4076-94b7-24895524c693">
                  <div data-calendar='{"events":[{"title":"Bootcamp","start":"2023-05-10"}]}'></div>
                </div>
                <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-c27bc163-3425-445c-b26e-aa9338733d13" id="dom-c27bc163-3425-445c-b26e-aa9338733d13">
                  <pre class="scrollbar rounded-1" style="max-height:420px"><code class="language-html">&lt;div data-calendar='{&quot;events&quot;:[{&quot;title&quot;:&quot;Bootcamp&quot;,&quot;start&quot;:&quot;2023-05-10&quot;}]}'&gt;&lt;/div&gt;</code></pre>
                </div>
              </div>
            </div>
          </div>
