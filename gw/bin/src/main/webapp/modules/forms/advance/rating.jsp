                  ...
                  <ul class="nav collapse show" id="forms">
                    ...
                    <li class="nav-item"><a class="nav-link dropdown-indicator" href="#advance" data-bs-toggle="collapse" aria-expanded="true" aria-controls="forms">
                      ...
                      <ul class="nav collapse show" id="advance">
                        ...
                        <li class="nav-item"><a class="nav-link active" href="../../../modules/forms/advance/rating.jsp">
          ...
          <div class="card mb-3">
              ...
              <div class="row flex-between-end">
                ...
                <div class="col-auto ms-auto">
                  <div class="nav nav-pills nav-pills-falcon flex-grow-1" role="tablist">
                    <button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-e9a19bf1-9d2f-4824-8396-75b615a1ff34" type="button" role="tab" aria-controls="dom-e9a19bf1-9d2f-4824-8396-75b615a1ff34" aria-selected="true" id="tab-dom-e9a19bf1-9d2f-4824-8396-75b615a1ff34">Preview</button>
                    <button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-48790c03-327e-43cf-9efa-1853118d5b35" type="button" role="tab" aria-controls="dom-48790c03-327e-43cf-9efa-1853118d5b35" aria-selected="false" id="tab-dom-48790c03-327e-43cf-9efa-1853118d5b35">Code</button>
                  </div>
                </div>
              </div>
            </div>
            <div class="card-body bg-light">
              <div class="tab-content">
                <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-e9a19bf1-9d2f-4824-8396-75b615a1ff34" id="dom-e9a19bf1-9d2f-4824-8396-75b615a1ff34">
                  <div class="d-block" data-rater='{"starSize":32,"step":0.5}'></div>
                </div>
                <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-48790c03-327e-43cf-9efa-1853118d5b35" id="dom-48790c03-327e-43cf-9efa-1853118d5b35">
