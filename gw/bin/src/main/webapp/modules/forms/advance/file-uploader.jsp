                  ...
                  <ul class="nav collapse show" id="forms">
                    ...
                    <li class="nav-item"><a class="nav-link dropdown-indicator" href="#advance" data-bs-toggle="collapse" aria-expanded="true" aria-controls="forms">
                      ...
                      <ul class="nav collapse show" id="advance">
                        ...
                        <li class="nav-item"><a class="nav-link active" href="../../../modules/forms/advance/file-uploader.jsp">
          ...
          <div class="card mb-3">
              ...
              <div class="row flex-between-end">
                ...
                <div class="col-auto ms-auto">
                  <div class="nav nav-pills nav-pills-falcon flex-grow-1 mt-2" role="tablist">
                    <button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-de3277e0-b361-4003-8201-748bdd387c48" type="button" role="tab" aria-controls="dom-de3277e0-b361-4003-8201-748bdd387c48" aria-selected="true" id="tab-dom-de3277e0-b361-4003-8201-748bdd387c48">Preview</button>
                    <button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-5be77135-0aa9-4bc0-99d5-ea9ecad90d46" type="button" role="tab" aria-controls="dom-5be77135-0aa9-4bc0-99d5-ea9ecad90d46" aria-selected="false" id="tab-dom-5be77135-0aa9-4bc0-99d5-ea9ecad90d46">Code</button>
                  </div>
                </div>
              </div>
            </div>
            <div class="card-body bg-light">
              <div class="tab-content">
                <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-de3277e0-b361-4003-8201-748bdd387c48" id="dom-de3277e0-b361-4003-8201-748bdd387c48">
                ...
                <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-5be77135-0aa9-4bc0-99d5-ea9ecad90d46" id="dom-5be77135-0aa9-4bc0-99d5-ea9ecad90d46">
...
&lt;/div&gt;</code></pre>
          ...
          <div class="card mb-3">
              ...
              <div class="row flex-between-end">
                ...
                <div class="col-auto ms-auto">
                  <div class="nav nav-pills nav-pills-falcon flex-grow-1" role="tablist">
                    <button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-b54cac7d-8a0c-4206-a38c-b29691243655" type="button" role="tab" aria-controls="dom-b54cac7d-8a0c-4206-a38c-b29691243655" aria-selected="true" id="tab-dom-b54cac7d-8a0c-4206-a38c-b29691243655">Preview</button>
                    <button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-62ef271f-8f8a-4fa9-8deb-15885437183b" type="button" role="tab" aria-controls="dom-62ef271f-8f8a-4fa9-8deb-15885437183b" aria-selected="false" id="tab-dom-62ef271f-8f8a-4fa9-8deb-15885437183b">Code</button>
                  </div>
                </div>
              </div>
            </div>
            <div class="card-body bg-light">
              <div class="tab-content">
                <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-b54cac7d-8a0c-4206-a38c-b29691243655" id="dom-b54cac7d-8a0c-4206-a38c-b29691243655">
                ...
                <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-62ef271f-8f8a-4fa9-8deb-15885437183b" id="dom-62ef271f-8f8a-4fa9-8deb-15885437183b">
