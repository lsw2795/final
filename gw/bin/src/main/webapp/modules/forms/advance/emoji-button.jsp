...
<html data-bs-theme="light" lang="en-US" dir="ltr">
  ...
  <body class="overflow-hidden">
    ...
    <main class="main" id="top">
      <div class="vh-100 container" data-layout="container">
        <script>
                  ...
                  <ul class="nav collapse show" id="forms">
                    ...
                    <li class="nav-item"><a class="nav-link dropdown-indicator" href="#advance" data-bs-toggle="collapse" aria-expanded="true" aria-controls="forms">
                      ...
                      <ul class="nav collapse show" id="advance">
                        ...
                        <li class="nav-item"><a class="nav-link active" href="../../../modules/forms/advance/emoji-button.jsp">
          ...
          <div class="card mb-3">
            ...
            <div class="card-body position-relative">
              <div class="row">
                <div class="col-lg-8">
                  <h3>Emoji Button</h3>
                  <p class="mb-0">Falcon uses Picmo as a emoji picker component. It displays a panel of emojis where one can be selected. What is done with the selected emoji is up to you.</p><a class="btn btn-link btn-sm ps-0 mt-2" href="https://picmojs.com/docs/api/overview" target="_blank">Documentation for Picmo<span class="fas fa-chevron-right ms-1 fs--2"></span></a>
                </div>
              </div>
            </div>
          </div>
          <div class="card mb-3">
              ...
              <div class="row flex-between-end">
                ...
                <div class="col-auto ms-auto">
                  <div class="nav nav-pills nav-pills-falcon flex-grow-1" role="tablist">
                    <button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-716da211-005c-49db-96ef-9df4343833a3" type="button" role="tab" aria-controls="dom-716da211-005c-49db-96ef-9df4343833a3" aria-selected="true" id="tab-dom-716da211-005c-49db-96ef-9df4343833a3">Preview</button>
                    <button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-f92333f9-20ec-4182-bac9-fd5608d17c0f" type="button" role="tab" aria-controls="dom-f92333f9-20ec-4182-bac9-fd5608d17c0f" aria-selected="false" id="tab-dom-f92333f9-20ec-4182-bac9-fd5608d17c0f">Code</button>
                  </div>
                </div>
              </div>
            </div>
            <div class="card-body bg-light">
              <div class="tab-content">
                <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-716da211-005c-49db-96ef-9df4343833a3" id="dom-716da211-005c-49db-96ef-9df4343833a3">
                  <div class="position-relative" id="emoji-button">
                    <div class="btn btn-info" data-picmo='{"position":"bottom-start"}'><span class="far fa-laugh-beam"></span></div>
                  </div>
                </div>
                <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-f92333f9-20ec-4182-bac9-fd5608d17c0f" id="dom-f92333f9-20ec-4182-bac9-fd5608d17c0f">
...
&lt;/div&gt;</code></pre>
          ...
          <div class="card mb-3">
            ...
            <div class="card-body bg-light">
              <pre class="scrollbar mt-2"><code class="language-html">&lt;script src=&quot;https://unpkg.com/picmo@5.7.6/dist/umd/index.js&quot;&gt;&lt;/script&gt;
