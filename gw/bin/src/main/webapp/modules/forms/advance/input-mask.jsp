                  ...
                  <ul class="nav collapse show" id="forms">
                    ...
                    <li class="nav-item"><a class="nav-link dropdown-indicator" href="#advance" data-bs-toggle="collapse" aria-expanded="true" aria-controls="forms">
                      ...
                      <ul class="nav collapse show" id="advance">
                        ...
                        <li class="nav-item"><a class="nav-link active" href="../../../modules/forms/advance/input-mask.jsp">
          ...
          <div class="card mb-3">
            ...
            <div class="card-body position-relative">
              <div class="row">
                <div class="col-lg-8">
                  <h3>Input Mask</h3>
                  <p class="mb-0">Falcon uses <b>inputmask</b> for advance input masking. Inputmask is a javascript library that creates an input mask. Inputmask can run against vanilla javascript, jQuery, and jqlite.</p><a class="btn btn-link btn-sm ps-0 mt-2" href="https://github.com/RobinHerbots/Inputmask" target="_blank">Documentation for inputmask<span class="fas fa-chevron-right ms-1 fs--2"></span></a>
                </div>
              </div>
            </div>
          </div>
          <div class="card mb-3">
            <div class="card-header">
              <div class="row flex-between-end">
                <div class="col-auto align-self-center">
                  <h5 class="mb-0" data-anchor="data-anchor">Inputmask Examples</h5>
                </div>
                <div class="col-auto ms-auto">
                  <div class="nav nav-pills nav-pills-falcon flex-grow-1" role="tablist">
                    <button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-85a09e6f-95b0-4cdf-98f3-e9725886b5fe" type="button" role="tab" aria-controls="dom-85a09e6f-95b0-4cdf-98f3-e9725886b5fe" aria-selected="true" id="tab-dom-85a09e6f-95b0-4cdf-98f3-e9725886b5fe">Preview</button>
                    <button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-792c916a-907d-4d06-872c-ce9f302332aa" type="button" role="tab" aria-controls="dom-792c916a-907d-4d06-872c-ce9f302332aa" aria-selected="false" id="tab-dom-792c916a-907d-4d06-872c-ce9f302332aa">Code</button>
                  </div>
                </div>
              </div>
            </div>
            <div class="card-body bg-light">
              <div class="tab-content">
                <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-85a09e6f-95b0-4cdf-98f3-e9725886b5fe" id="dom-85a09e6f-95b0-4cdf-98f3-e9725886b5fe">
                  <div class="mb-3">
                ...
                <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-792c916a-907d-4d06-872c-ce9f302332aa" id="dom-792c916a-907d-4d06-872c-ce9f302332aa">
...
&lt;/div&gt;</code></pre>
          ...
          <div class="card mb-3">
            ...
            <div class="card-body bg-light">
              <pre class="scrollbar mt-2"><code class="language-html">&lt;script src=&quot;vendors/inputmask/inputmask.min.js&quot;&gt;&lt;/script&gt;</code></pre>
            </div>
          </div>
          <footer class="footer">
