              ...
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                ...
                <li class="nav-item">
                  ...
                  <ul class="nav collapse show" id="icons">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="../../modules/icons/material-icons.jsp">
          ...
          <div class="card mb-3">
              ...
              <div class="row flex-between-end">
                ...
                <div class="col-auto ms-auto">
                  <div class="nav nav-pills nav-pills-falcon flex-grow-1 mt-2" role="tablist">
                    <button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-ea8cc4f4-51af-4a9b-901e-2a81c01acb93" type="button" role="tab" aria-controls="dom-ea8cc4f4-51af-4a9b-901e-2a81c01acb93" aria-selected="true" id="tab-dom-ea8cc4f4-51af-4a9b-901e-2a81c01acb93">Preview</button>
                    <button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-1c4086dd-d81f-40e5-861c-ce8b9f5794b2" type="button" role="tab" aria-controls="dom-1c4086dd-d81f-40e5-861c-ce8b9f5794b2" aria-selected="false" id="tab-dom-1c4086dd-d81f-40e5-861c-ce8b9f5794b2">Code</button>
                  </div>
                </div>
              </div>
            </div>
            <div class="card-body bg-light">
              <div class="tab-content">
                <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-ea8cc4f4-51af-4a9b-901e-2a81c01acb93" id="dom-ea8cc4f4-51af-4a9b-901e-2a81c01acb93"><span class="material-icons text-secondary fs-5">notifications</span>
                </div>
                <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-1c4086dd-d81f-40e5-861c-ce8b9f5794b2" id="dom-1c4086dd-d81f-40e5-861c-ce8b9f5794b2">
