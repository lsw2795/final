              ...
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                <li class="nav-item">
                  ...
                  <ul class="nav collapse show" id="dashboard">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="../dashboard/e-commerce.jsp">
                    ...
                    <div class="col-md-6">
                      <div class="card h-md-100 ecommerce-card-min-width">
                        ...
                        <div class="card-body d-flex flex-column justify-content-end">
                          <div class="row">
                            <div class="col">
                              <p class="font-sans-serif lh-1 mb-1 fs-2">$47K</p><span class="badge badge-subtle-success rounded-pill fs--2">+3.5%</span>
                            </div>
                        ...
                        <div class="card-body">
                          <div class="row align-items-end">
                            <div class="col">
                              ...
                              <div class="badge badge-subtle-primary rounded-pill fs--2"><span class="fas fa-caret-up me-1"></span>13.6%</div>
                            </div>
                            <div class="col-auto ps-0">
