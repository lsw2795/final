              ...
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                <li class="nav-item">
                  ...
                  <ul class="nav collapse show" id="dashboard">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="../dashboard/saas.jsp">
                  ...
                  <div class="card">
                    ...
                    <div class="card-body py-2">
                      ...
                      <div class="d-flex align-items-center position-relative false">
                        ...
                        <div class="flex-1 ms-3">
                          <h6 class="mb-0 fw-semi-bold"><a class="stretched-link text-900" href="../pages/user/profile.jsp">Tom Hanks</a></h6>
                          <p class="text-500 fs--2 mb-0">Editor</p>
                        </div>
                      </div>
                    </div>
