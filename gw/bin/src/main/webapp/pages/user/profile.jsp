              ...
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                ...
                <li class="nav-item">
                  ...
                  <ul class="nav collapse show" id="user">
                    <li class="nav-item"><a class="nav-link active" href="../../pages/user/profile.jsp">
            ...
            <div class="col-lg-8 pe-lg-2">
              ...
              <div class="card mb-3">
                <div class="card-header bg-light d-flex justify-content-between">
                  <h5 class="mb-0">Associations</h5><a class="font-sans-serif" href="../../pages/miscellaneous/associations.jsp">All Associations</a>
                </div>
          ...
          <div class="card mt-3">
            <div class="card-header bg-light">
              <div class="row align-items-center">
                ...
                <div class="col text-end"><a class="font-sans-serif" href="../../app/social/followers.jsp">All Members</a>
                </div>
              </div>
            </div>
