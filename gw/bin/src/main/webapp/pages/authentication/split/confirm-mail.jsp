                ...
                <div class="card">
                  ...
                  <div class="card-body p-4">
                    <div class="text-center"><img class="d-block mx-auto mb-4" src="../../../assets/img/icons/spot-illustrations/16.png" alt="Email" width="100" />
                      ...
                      </p><a class="btn btn-primary btn-sm mt-3" href="../../../pages/authentication/split/login.jsp"><span class="fas fa-chevron-left me-1" data-fa-transform="shrink-4 down-1"></span>Return to login</a>
                    </div>
                  </div>
                </div>
              </div>
