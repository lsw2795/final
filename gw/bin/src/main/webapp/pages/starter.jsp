            ...
            <div class="navbar-vertical-content scrollbar">
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                ...
                <li class="nav-item">
                  ...
                  <!-- parent pages--><a class="nav-link active" href="../pages/starter.jsp" role="button">
            ...
            <div class="card-body overflow-hidden p-lg-6">
              <div class="row align-items-center">
                ...
                <div class="col-lg-6 ps-lg-4 my-5 text-center text-lg-start">
                  ...
                  <p class="lead">Create Something Beautiful.</p><a class="btn btn-falcon-primary" href="../documentation/getting-started.jsp">Getting started</a>
                </div>
              </div>
            </div>
          </div>
