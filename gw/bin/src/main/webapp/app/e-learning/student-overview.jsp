            ...
            <div class="navbar-vertical-content scrollbar">
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                ...
                <li class="nav-item">
                  ...
                  <!-- parent pages--><a class="nav-link dropdown-indicator" href="#e-learning" role="button" data-bs-toggle="collapse" aria-expanded="true" aria-controls="e-learning">
                  ...
                  <ul class="nav collapse show" id="e-learning">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="../../app/e-learning/student-overview.jsp">
                      ...
                      <table class="table table-borderless fs--1 fw-medium mb-0">
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td class="p-1"><a class="text-600 text-decoration-none" href="mailto:goodguy@nicemail.com">goodguy@nicemail.com </a><span class="badge rounded-pill badge-subtle-success d-none d-md-inline-block ms-2"><span>Verified</span><span class="fas fa-check ms-1" data-fa-transform="shrink-4"></span></span>
                            </td>
                          </tr>
                          <tr>
                            <td class="p-1" style="width: 35%;">Mobile No:</td>
                            <td class="p-1"><a class="text-600 text-decoration-none" href="tel:+01234567890 ">+012-345-67890 </a><span class="badge rounded-pill badge-subtle-primary d-none d-md-inline-block ms-2"><span>2-step verification</span><span class="fas fa-link ms-1" data-fa-transform="shrink-4"></span></span>
                            </td>
                          </tr>
                        </tbody>
                      </table>
                      ...
                      <div class="row g-0">
                        <div class="col-6">
                          <h4 class="text-700 lh-1 mb-1">
                            $1971.52</h4><span class="badge rounded-pill badge-subtle-danger fs--2 align-bottom"><span class="fas fa-caret-down me-1" data-fa-transform="shrink-4"></span><span>5.1% last month</span></span>
                        </div>
                  ...
                  <div class="card font-sans-serif">
                    ...
                    <div class="card-body">
                      <div class="row g-0">
                        <div class="col-6">
                          <h4 class="text-700 lh-1 mb-1">
                            121h 11m</h4><span class="badge rounded-pill badge-subtle-success fs--2 align-bottom"><span class="fas fa-caret-up me-1" data-fa-transform="shrink-4"></span><span>3.6% last month</span></span>
                        </div>
                        <div class="col-6 mt-n4 d-flex justify-content-end">
                    ...
                    <div class="col-sm-7 order-1 order-sm-0">
                      <div class="row g-sm-0 gy-4 row-cols-2 h-100 align-content-between">
                        <div class="col">
                          ...
                          <h6 class="mb-0"><span class="text-500 me-2">this week</span><span class="badge rounded-pill badge-subtle-success"><span class="fas fa-caret-up me-1" data-fa-transform="shrink-4"></span><span>2.1%</span></span>
                          </h6>
                        </div>
                        <div class="col">
                          <div class="d-flex gap-2 mb-3">
                          ...
                          <h6 class="mb-0"><span class="text-500 me-2">this week</span><span class="badge rounded-pill badge-subtle-danger"><span class="fas fa-caret-down me-1" data-fa-transform="shrink-4"></span><span>5.1%</span></span>
                          </h6>
                        </div>
                        <div class="col">
                          <div class="d-flex gap-2 mb-3">
                          ...
                          <h6 class="mb-0"><span class="text-500 me-2">this week</span><span class="badge rounded-pill badge-subtle-secondary"><span>0.0%</span><span class=" ms-1" data-fa-transform="shrink-4"></span></span>
                          </h6>
                        </div>
                        <div class="col">
                          <div class="d-flex gap-2 mb-3">
                          ...
                          <h6 class="mb-0"><span class="text-500 me-2">this week</span><span class="badge rounded-pill badge-subtle-primary"><span class="fas fa-plus me-1" data-fa-transform="shrink-4"></span><span>3.5%</span></span>
                          </h6>
                        </div>
                      </div>
                    </div>
                ...
                <div class="card-body p-0 d-flex flex-column justify-content-between">
                  ...
                  <ul class="list-unstyled mb-0">
                    <li class="d-flex gap-2 flex-between-center flex-wrap fs--2 p-x1 bg-light">
                      <h6 class="fs-xxl--1 fs-lg--2 mb-0 d-flex align-items-center gap-2"><span class="fas fa-circle text-primary" data-fa-transform="shrink-4"></span>Completed Courses<span class="badge rounded-pill badge-subtle-success"><span class="fas fa-caret-up me-1" data-fa-transform="shrink-4"></span><span>2.1%</span></span>
                      </h6>
                      <p class="text-600 mb-0">13 Courses</p>
                    </li>
                    <li class="d-flex gap-2 flex-between-center flex-wrap fs--2 p-x1">
                      <h6 class="fs-xxl--1 fs-lg--2 mb-0 d-flex align-items-center gap-2"><span class="fas fa-circle text-warning" data-fa-transform="shrink-4"></span>Dropped Courses<span class="badge rounded-pill badge-subtle-primary"><span class="fas fa-caret-up me-1" data-fa-transform="shrink-4"></span><span>3.5%</span></span>
                      </h6>
                      <p class="text-600 mb-0">10 Courses</p>
                    </li>
                    <li class="d-flex gap-2 flex-between-center flex-wrap fs--2 p-x1 bg-light">
                      <h6 class="fs-xxl--1 fs-lg--2 mb-0 d-flex align-items-center gap-2"><span class="fas fa-circle text-success" data-fa-transform="shrink-4"></span>Refund Claimed<span class="badge rounded-pill badge-subtle-secondary"><span class=" me-1" data-fa-transform="shrink-4"></span><span>0.00%</span></span>
                      </h6>
                      <p class="text-600 mb-0">7 Courses</p>
                    </li>
                    <li class="d-flex gap-2 flex-between-center flex-wrap fs--2 p-x1">
                      <h6 class="fs-xxl--1 fs-lg--2 mb-0 d-flex align-items-center gap-2"><span class="fas fa-circle text-info" data-fa-transform="shrink-4"></span>On-going Courses<span class="badge rounded-pill badge-subtle-danger"><span class="fas fa-caret-down me-1" data-fa-transform="shrink-4"></span><span>5.1%</span></span>
                      </h6>
