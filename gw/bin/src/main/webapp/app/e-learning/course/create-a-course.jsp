              ...
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                ...
                <li class="nav-item">
                  ...
                  <ul class="nav collapse show" id="e-learning">
                    <li class="nav-item"><a class="nav-link dropdown-indicator" href="#course" data-bs-toggle="collapse" aria-expanded="true" aria-controls="e-learning">
                        <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Course</span>
                        </div>
                      </a>
                      <!-- more inner pages-->
                      <ul class="nav collapse show" id="course">
                        ...
                        <li class="nav-item"><a class="nav-link active" href="../../../app/e-learning/course/create-a-course.jsp">
                ...
                <div class="card-body bg-light">
                  <form class="row gx-2">
                    ...
                    <div class="col-sm-6 mb-3">
                      ...
                      <select class="form-select" id="course-category" name="course-category">
                    ...
                    <div class="col-sm-6 mb-3">
                      ...
                      <select class="form-select" id="course-subcategory" name="course-sub-category">
                  ...
                  <ul class="list-unstyled mb-0">
                    ...
                    <li>
                      <div class="d-flex hover-actions-trigger align-items-center py-3 border-top border-300"><span class="fas fa-grip-lines fs--2 text-secondary me-3"></span>
                        <p class="mb-0 fs--1 me-6">Learners with following skills might be more benefited, but little extra work is all that’ll take.</p>
                        <div class="hover-actions end-0 top-50 translate-middle-y">
                          <button class="btn btn-link me-3 fs--2 p-0 text-700" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit"><span class="fas fa-pencil-alt"></span></button>
                          <button class="btn btn-light icon-item rounded-3 fs--2 icon-item-sm" data-bs-toggle="tooltip" data-bs-placement="top" title="Remove"><span class="fas fa-times"></span></button>
                        </div>
                ...
                <div class="card mb-3">
                  ...
                  <div class="card-body bg-light">
                    <form class="dropzone dropzone-single p-0" data-dropzone="data-dropzone" data-options='{"maxFiles":1,"acceptedFiles":".mp4,.mkv,.avi"}'>
                      ...
                      <div class="dz-message fs--1" data-dz-message="data-dz-message"><img class="me-2" src="../../../assets/img/icons/cloud-upload.svg" width="20" alt="" /><span class="d-none d-lg-inline">Drag your .mp4 or .mkv file here<br/>or, </span><span class="btn btn-link p-0 fs--1">Browse</span></div>
                    </form>
              ...
              <div class="modal-body p-4 bg-light">
                <form class="row gx-3">
                  ...
                  <div class="col-lg-6 mb-3">
                    ...
                    <input class="form-control datetimepicker" id="start-date" type="text" placeholder="dd/mm/yyyy" data-options='{"dateFormat":"d/m/y","disableMobile":true}' />
                  </div>
                  <div class="col-lg-6 mb-3">
                    <label class="form-label" for="start-time">Start Time</label>
                    <input class="form-control datetimepicker" id="start-time" type="text" placeholder="23 : 45" data-options='{"enableTime":true,"noCalendar":true,"dateFormat":"H:i","disableMobile":true}' />
                  </div>
                  <div class="col-lg-6 mb-3">
                    <label class="form-label" for="end-date">End Date</label>
                    <input class="form-control datetimepicker" id="end-date" type="text" placeholder="dd/mm/yyyy" data-options='{"dateFormat":"d/m/y","disableMobile":true}' />
                  </div>
                  <div class="col-lg-6 mb-3">
                    <label class="form-label" for="end-time">End Time</label>
                    <input class="form-control datetimepicker" id="end-time" type="text" placeholder="23 : 45" data-options='{"enableTime":true,"noCalendar":true,"dateFormat":"H:i","disableMobile":true}' />
                  </div>
                </form>
              </div>
