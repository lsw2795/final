        ...
        <div class="content">
          <div class="card overflow-hidden mb-3" data-bs-theme="light">
            <div class="card-body bg-black">
              <div class="bg-holder rounded-3" style="background-image:url(../../../assets/img/icons/spot-illustrations/course-details-bg.png);">
              </div>
              <!--/.bg-holder-->
                  ...
                  <div class="row g-3 align-items-center">
                    <div class="col-lg-5">
                      <div class="position-relative">
                        <div class="bg-holder rounded-1 overlay" style="background-image:url(../../../assets/img/elearning/courses/course-details.png);">
                        </div>
                        <!--/.bg-holder-->
                    ...
                    <div class="col-lg-7">
                      <h6 class="fw-semi-bold text-400">A course by <a class="text-info" href="../../../app/e-learning/trainer-profile.jsp">Bill Finger</a></h6>
            ...
            <div class="col-lg-8 order-1 order-lg-0">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body position-relative">
                  <div class="bg-holder bg-card d-none d-md-block" style="background-image:url(../../../assets/img/icons/spot-illustrations/corner-6.png);">
                  </div>
                  <!--/.bg-holder-->
              ...
              <div class="card mb-3">
                ...
                <div class="card-body p-0">
                  <div class="d-flex align-items-center px-x1 py-2 border-bottom border-200">
                    <div class="hoverbox me-3 my-1"><a class="text-decoration-none" href="../../../assets/video/beach.mp4" data-gallery="attachment-bg">
                        <div class="bg-attachment bg-attachment-square">
                          <div class="bg-holder" style="background-image:url(../../../assets/img/elearning/lessons/intro.png);">
                          </div>
                          <!--/.bg-holder-->
                  ...
                  <div class="d-flex align-items-center px-x1 py-2 border-bottom border-200">
                    <div class="hoverbox me-3 my-1"><a class="text-decoration-none" href="../../../assets/video/beach.mp4" data-gallery="attachment-bg">
                        <div class="bg-attachment bg-attachment-square">
                          <div class="bg-holder" style="background-image:url(../../../assets/img/elearning/lessons/chapter1.png);">
                          </div>
                          <!--/.bg-holder-->
                  ...
                  <div class="d-flex align-items-center px-x1 py-2 border-bottom border-200">
                    <div class="hoverbox me-3 my-1"><a class="text-decoration-none" href="../../../assets/video/beach.mp4" data-gallery="attachment-bg">
                        <div class="bg-attachment bg-attachment-square">
                          <div class="bg-holder" style="background-image:url(../../../assets/img/elearning/lessons/chapter2.png);">
                          </div>
                          <!--/.bg-holder-->
                  ...
                  <div class="d-flex align-items-center px-x1 py-2 border-bottom border-200">
                    <div class="hoverbox me-3 my-1"><a class="text-decoration-none" href="../../../assets/video/beach.mp4" data-gallery="attachment-bg">
                        <div class="bg-attachment bg-attachment-square">
                          <div class="bg-holder" style="background-image:url(../../../assets/img/elearning/lessons/chapter3.png);">
                          </div>
                          <!--/.bg-holder-->
                  ...
                  <div class="d-flex align-items-center px-x1 py-2">
                    <div class="hoverbox me-3 my-1"><a class="text-decoration-none" href="../../../assets/video/beach.mp4" data-gallery="attachment-bg">
                        <div class="bg-attachment bg-attachment-square">
                          <div class="bg-holder" style="background-image:url(../../../assets/img/elearning/lessons/chapter4.png);">
                          </div>
                          <!--/.bg-holder-->
              ...
              <div class="card mb-3">
                ...
                <div class="card-body bg-light">
                  <div class="row g-4 text-center text-md-start">
                    <div class="col-md-auto"><a href="../../../app/e-learning/trainer-profile.jsp">
                    ...
                    <div class="col">
                      <h5 class="mb-2"> <a href="../../../app/e-learning/trainer-profile.jsp">Bill Finger</a></h5>
                ...
                <div class="card-footer text-end py-1"><a class="btn btn-link btn-sm fw-medium py-2 px-0" href="../../../app/e-learning/course/course-list.jsp">View all his courses<span class="fas fa-external-link-alt ms-1"></span></a></div>
              </div>
              <div class="card mb-3">
              ...
              <div class="card">
                ...
                <div class="card-footer text-end py-1"><a class="btn btn-link btn-sm py-2 px-0" href="../../../app/e-learning/course/course-grid.jsp">All courses<span class="fas fa-external-link-alt ms-1"></span></a></div>
              </div>
            </div>
            <div class="col-lg-4">
