              ...
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                ...
                <li class="nav-item">
                  ...
                  <ul class="nav collapse show" id="social">
                    <li class="nav-item"><a class="nav-link active" href="../../app/social/feed.jsp">
                  ...
                  <div class="row justify-content-between">
                    <div class="col">
                      <div class="d-flex">
                        ...
                        <div class="flex-1 align-self-center ms-2">
                          <p class="mb-1 lh-1"><a class="fw-semi-bold" href="../../pages/user/profile.jsp">Margot Robbie</a></p>
                    ...
                    <div class="col">
                      <div class="d-flex">
                        ...
                        <div class="flex-1 fs--1">
                          <h5 class="fs-0"><a href="../../app/events/event-detail.jsp">FREE New Year's Eve Midnight Harbor Fireworks</a></h5>
                  ...
                  <div class="row justify-content-between">
                    <div class="col">
                      <div class="d-flex">
                        ...
                        <div class="flex-1 align-self-center ms-2">
                          <p class="mb-1 lh-1"><a class="fw-semi-bold" href="../../pages/user/profile.jsp">Leonardo DiCaprio</a> shared a <a href="#!">photo</a></p>
                  ...
                  <div class="row justify-content-between">
                    <div class="col">
                      <div class="d-flex">
                        ...
                        <div class="flex-1 align-self-center ms-2">
                          <p class="mb-1 lh-1"><a class="fw-semi-bold" href="../../pages/user/profile.jsp">Emilia Clarke</a> shared a <a href="#!">url</a></p>
