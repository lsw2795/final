      ...
      <div class="container" data-layout="container">
              ...
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                ...
                <li class="nav-item">
                  ...
                  <ul class="nav collapse show" id="support-desk">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="../../app/support-desk/quick-links.jsp">
        ...
        <div class="content">
          ...
          <div class="card">
            ...
            <div class="card-body">
              <h5 class="fs-0 mb-2">Analysis of the Helpdesk</h5>
              <div class="row g-3">
                <div class="col-xxl-4 col-lg-6">
                  <div class="d-flex align-items-center px-4 py-x1 bg-light rounded-3 border position-relative"><img src="../../assets/img/tickets/reports/1.png" alt="" width="39" />
                    <div class="ms-3 my-x1">
                      <h5 class="fs-0 fw-semi-bold mb-2"><a class="text-900 hover-primary stretched-link" href="#!">In-Depth Helpdesk</a></h5>
                      <h6 class="mb-0 text-600">an overview of your helpdesk system</h6>
                    </div>
                  </div>
                </div>
                <div class="col-xxl-4 col-lg-6">
                  <div class="d-flex align-items-center px-4 py-x1 bg-light rounded-3 border position-relative"><img src="../../assets/img/tickets/reports/2.png" alt="" width="39" />
                    <div class="ms-3 my-x1">
                      <h5 class="fs-0 fw-semi-bold mb-2"><a class="text-900 hover-primary stretched-link" href="#!">Trends in Ticket Volume</a></h5>
                      <h6 class="mb-0 text-600">an overview of the number of tickets</h6>
                    </div>
                  </div>
                </div>
              </div>
              <h5 class="fs-0 mb-2 mt-5">Customer Satisfaction</h5>
              <div class="row g-3">
                <div class="col-xxl-4 col-lg-6">
                  <div class="d-flex align-items-center px-4 py-x1 bg-light rounded-3 border position-relative"><img src="../../assets/img/tickets/reports/3.png" alt="" width="39" />
                    <div class="ms-3 my-x1">
                      <h5 class="fs-0 fw-semi-bold mb-2"><a class="text-900 hover-primary stretched-link" href="#!">Analysis of the Top Customers</a></h5>
                      <h6 class="mb-0 text-600">Check out our customer stories</h6>
                    </div>
                  </div>
                </div>
                <div class="col-xxl-4 col-lg-6">
                  <div class="d-flex align-items-center px-4 py-x1 bg-light rounded-3 border position-relative"><img src="../../assets/img/tickets/reports/4.png" alt="" width="39" />
                    <div class="ms-3 my-x1">
                      <h5 class="fs-0 fw-semi-bold mb-2"><a class="text-900 hover-primary stretched-link" href="#!">Customer Satisfaction Survey</a></h5>
                      <h6 class="mb-0 text-600">Check out the report details</h6>
                    </div>
                  </div>
                </div>
              </div>
              <h5 class="fs-0 mb-2 mt-5">Productivity</h5>
              <div class="row g-3">
                <div class="col-xxl-4 col-lg-6">
                  <div class="d-flex align-items-center px-4 py-x1 bg-light rounded-3 border position-relative"><img src="../../assets/img/tickets/reports/5.png" alt="" width="39" />
                    <div class="ms-3 my-x1">
                      <h5 class="fs-0 fw-semi-bold mb-2"><a class="text-900 hover-primary stretched-link" href="#!">Performance of Agents</a></h5>
                      <h6 class="mb-0 text-600">Check out the report details</h6>
                    </div>
                  </div>
                </div>
                <div class="col-xxl-4 col-lg-6">
                  <div class="d-flex align-items-center px-4 py-x1 bg-light rounded-3 border position-relative"><img src="../../assets/img/tickets/reports/6.png" alt="" width="39" />
                    <div class="ms-3 my-x1">
                      <h5 class="fs-0 fw-semi-bold mb-2"><a class="text-900 hover-primary stretched-link" href="#!">Performance in a Group</a></h5>
                      <h6 class="mb-0 text-600">Check out the report details</h6>
                    </div>
                  </div>
                </div>
                <div class="col-xxl-4 col-lg-6">
                  <div class="d-flex align-items-center px-4 py-x1 bg-light rounded-3 border position-relative"><img src="../../assets/img/tickets/reports/7.png" alt="" width="39" />
                    <div class="ms-3 my-x1">
                      <h5 class="fs-0 fw-semi-bold mb-2"><a class="text-900 hover-primary stretched-link" href="#!">Distribution of Performance</a></h5>
                      <h6 class="mb-0 text-600">Check out the report details</h6>
                    </div>
                  </div>
                </div>
