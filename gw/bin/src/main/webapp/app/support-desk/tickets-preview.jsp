              ...
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                ...
                <li class="nav-item">
                  ...
                  <ul class="nav collapse show" id="support-desk">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="../../app/support-desk/tickets-preview.jsp">
          ...
          <div class="row g-3">
            <div class="col-xxl-9 col-xl-8">
              <div class="card">
                <div class="card-header d-flex flex-between-center">
                  ...
                  <div class="d-flex">
                    <button class="btn btn-falcon-default btn-sm" type="button"><span class="fas fa-object-ungroup" data-fa-transform="shrink-2"></span><span class="d-none d-md-inline-block ms-1">Merge</span></button>
                ...
                <div class="card-body">
                  ...
                  <div class="my-5 position-relative text-center">
                    <hr class="position-absolute top-50 border-300 w-100 my-0" /><span class="position-relative bg-white dark__bg-card-dark px-3 z-1">
                      <button class="btn btn-sm btn-outline-secondary rounded-pill border-300 px-lg-5">Conversions 5+</button></span>
                  </div>
                  <div class="d-md-flex d-xl-inline-block d-xxl-flex align-items-center justify-content-between mb-x1">
                    <div class="d-flex align-items-center gap-2"><a href="../../app/support-desk/contact-details.jsp">
                        <div class="avatar avatar-2xl">
            ...
            <div class="col-xxl-3 col-xl-4">
              <div class="row g-3 position-sticky top-0">
                ...
                <div class="col-12">
                  <div class="card">
                    <div class="card-header d-flex flex-between-center py-2 bg-light">
                    ...
                    <div class="card-body">
                      <div class="row g-0 border-bottom pb-x1 mb-x1 align-items-sm-center align-items-xl-start">
                        ...
                        <div class="col-12 col-sm-auto col-xl-12">
                          <p class="fw-semi-bold text-800 mb-0">Emma Watson</p><a class="btn btn-link btn-sm p-0 fe-medium fs--1" href="../../app/support-desk/contact-details.jsp">View more details</a>
                        </div>
                      </div>
                      <div class="row g-0 justify-content-lg-between">
                        <div class="col-auto col-md-6 col-lg-auto">
                          <div class="row">
                            <div class="col-md-auto mb-4 mb-md-0 mb-xl-4">
                              <h6 class="mb-1">Email</h6><a class="fs--1" href="mailto:mattrogers@gmail.com">mattrogers@gmail.com</a>
                            </div>
                            <div class="col-md-auto mb-4 mb-md-0 mb-xl-4">
                              <h6 class="mb-1">Phone Number</h6><a class="fs--1" href="tel:+6(855)747677">+6(855) 747 677</a>
                            </div>
                          </div>
                        </div>
                        <div class="col-auto col-md-6 col-lg-auto ps-md-5 ps-xl-0">
                          ...
                          <h6 class="d-flex align-items-center mb-1"><span class="me-2">Previous Tickets</span><span class="badge badge-subtle-info">Responded</span></h6><a class="text-truncate fs--1 font-sans-serif mb-1 d-block text-700" href="../../app/support-desk/tickets-preview.jsp">When I unboxed my TV, I found a broken TV</a>
                          <p class="fs--1 mb-0 text-600 fw-semi-bold">01 March, 2020<span class="mx-1">|</span><span class="fst-italic">8:40 AM</span></p>
                        </div>
                      </div>
                    </div>
                  </div>
