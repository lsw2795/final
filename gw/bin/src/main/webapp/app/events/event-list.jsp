              ...
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                ...
                <li class="nav-item">
                  ...
                  <ul class="nav collapse show" id="events">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="../../app/events/event-list.jsp">
              ...
              <div class="row">
                <div class="col-md-6 h-100">
                  <div class="d-flex btn-reveal-trigger">
                    ...
                    <div class="flex-1 position-relative ps-3">
                      <h6 class="fs-0 mb-0"><a href="../../app/events/event-detail.jsp">Crain's New York Business <span class="badge badge-subtle-success rounded-pill">Free</span></a></h6>
                ...
                <div class="col-md-6 h-100">
                  <div class="d-flex btn-reveal-trigger">
                    ...
                    <div class="flex-1 position-relative ps-3">
                      <h6 class="fs-0 mb-0"><a href="../../app/events/event-detail.jsp">Film Festival</a></h6>
