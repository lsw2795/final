              ...
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                ...
                <li class="nav-item">
                  ...
                  <ul class="nav collapse show" id="e-commerce">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="../../app/e-commerce/billing.jsp">
              ...
              <div class="card h-100">
                ...
                <div class="card-body bg-light">
                  <div class="form-check mb-0">
                    ...
                    <label class="form-check-label mb-0 d-block" for="paypal"><img src="../../assets/img/icons/icon-paypal-full.png" height="20" alt="" />
                    </label>
                  </div>
