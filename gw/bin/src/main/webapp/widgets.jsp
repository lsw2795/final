      ...
      <div class="container" data-layout="container">
            ...
            <div class="navbar-vertical-content scrollbar">
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                ...
                <li class="nav-item">
                  ...
                  <!-- parent pages--><a class="nav-link active" href="widgets.jsp" role="button">
        ...
        <div class="content">
          ...
          <div class="d-flex mb-4 mt-3"><span class="fa-stack me-2 ms-n1"><i class="fas fa-circle fa-stack-2x text-300"></i><i class="fa-inverse fa-stack-1x text-primary fas fa-percentage"></i></span>
            <div class="col">
              <h5 class="mb-0 text-primary position-relative"><span class="bg-200 dark__bg-1100 pe-3">Number Stats &amp; Charts</span><span class="border position-absolute top-50 translate-middle-y w-100 start-0 z-n1"></span></h5>
            ...
            <div class="col-md-4">
              <div class="card overflow-hidden" style="min-width: 12rem">
                ...
                <div class="card-body position-relative">
                  ...
                  <div class="display-4 fs-4 mb-2 fw-normal font-sans-serif" data-countup='{"endValue":43594,"prefix":"$"}'>0</div><a class="fw-semi-bold fs--1 text-nowrap" href="index.jsp">Statistics<span class="fas fa-angle-right ms-1" data-fa-transform="down-1"></span></a>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="col-md-6 col-lg-4 col-xl-6 col-xxl-4">
              <div class="card h-md-100 ecommerce-card-min-width">
                ...
                <div class="card-body d-flex flex-column justify-content-end">
                  <div class="row">
                    <div class="col">
                      <p class="font-sans-serif lh-1 mb-1 fs-4">$47K</p><span class="badge badge-subtle-success rounded-pill fs--2">+3.5%</span>
                    </div>
              ...
              <div class="card h-100">
                ...
                <div class="card-body d-flex flex-column justify-content-end">
                  <div class="row align-items-end">
                    <div class="col">
                      <p class="font-sans-serif lh-1 mb-1 fs-2">34.6%</p><span class="badge badge-subtle-success rounded-pill"><span class="fas fa-caret-up me-1"></span>3.5%</span>
                    </div>
                    <div class="col-auto ps-0">
                  ...
                  <div class="w-100">
                    ...
                    <div class="progress-stacked mb-3 rounded-3" style="height: 10px;">
                      <div class="progress" style="width: 43.72%;" role="progressbar" aria-valuenow="43.72" aria-valuemin="0" aria-valuemax="100">
                        <div class="progress-bar bg-progress-gradient border-end border-white border-2"></div>
                      </div>
          ...
          <div class="row g-3 mb-3">
            ...
            <div class="col-xxl-4 col-md-6">
              <div class="card h-100 bg-line-chart-gradient">
                ...
                <div class="card-body text-white fs--1 pb-0" data-bs-theme="light">
                ...
                <div class="card-footer text-end bg-transparent" data-bs-theme="light"><a class="text-white" href="#!">Real-time data<span class="fa fa-chevron-right ms-1 fs--1"></span></a></div>
              </div>
            </div>
            <div class="col-xxl-8">
              <div class="card mb-3">
              ...
              <div class="row g-3">
                <div class="col-12">
                  <div class="card font-sans-serif">
                    <div class="card-body d-flex gap-3 flex-column flex-sm-row align-items-center"><img class="rounded-3" src="assets/img/elearning/avatar/student.png" alt="" width="112" />
                      <table class="table table-borderless fs--1 fw-medium mb-0">
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td class="p-1"><a class="text-600 text-decoration-none" href="mailto:goodguy@nicemail.com">goodguy@nicemail.com </a><small class="badge rounded badge-subtle-success false">Verified</small>
                            </td>
                          </tr>
                          <tr>
                            <td class="p-1" style="width: 35%;">Mobile No:</td>
                            <td class="p-1"><a class="text-600 text-decoration-none" href="tel:+01234567890 ">+012-345-67890 </a><small class="badge rounded badge-subtle-primary false">2-step verification</small>
                            </td>
                          </tr>
                        </tbody>
                      </table>
                      ...
                      <div class="row g-0">
                        <div class="col-6">
                          <h4 class="text-700 lh-1 mb-1">
                            $1971.52</h4><small class="badge rounded badge-subtle-danger false">5.1% last month</small>
                        </div>
                  ...
                  <div class="card font-sans-serif">
                    ...
                    <div class="card-body">
                      <div class="row g-0">
                        <div class="col-6">
                          <h4 class="text-700 lh-1 mb-1">
                            121h 11m</h4><small class="badge rounded badge-subtle-success false">3.6% last month</small>
                        </div>
                        <div class="col-6 mt-n4 d-flex justify-content-end">
                    ...
                    <div class="col-sm-7 order-1 order-sm-0">
                      <div class="row g-sm-0 gy-4 row-cols-2 h-100 align-content-between">
                        <div class="col">
                          ...
                          <h6 class="mb-0"><span class="text-500 me-2">this week</span><small class="badge rounded badge-subtle-success false">2.1%</small>
                          </h6>
                        </div>
                        <div class="col">
                          <div class="d-flex gap-2 mb-3">
                          ...
                          <h6 class="mb-0"><span class="text-500 me-2">this week</span><small class="badge rounded badge-subtle-danger false">5.1%</small>
                          </h6>
                        </div>
                        <div class="col">
                          <div class="d-flex gap-2 mb-3">
                          ...
                          <h6 class="mb-0"><span class="text-500 me-2">this week</span><small class="badge rounded badge-subtle-secondary dark__bg-1000">0.0%</small>
                          </h6>
                        </div>
                        <div class="col">
                          <div class="d-flex gap-2 mb-3">
                          ...
                          <h6 class="mb-0"><span class="text-500 me-2">this week</span><small class="badge rounded badge-subtle-primary false">3.5%</small>
                          </h6>
                        </div>
                      </div>
                    </div>
          ...
          <div class="row g-3 mb-3">
            ...
            <div class="col-12 col-md-6 col-xxl-4 order-xxl-1">
              <div class="card">
                    ...
                    <table class="table fs--1 mb-0">
                      ...
                      <tbody class="list">
                        <tr class="fw-semi-bold">
                          ...
                          <td class="align-middle pe-x1 text-end native-support"><small class="badge rounded badge-subtle-undefined false"></small>
                          </td>
                        </tr>
                        <tr class="fw-semi-bold">
                          <td class="align-middle py-3"><a href="#!">
          ...
          <div class="d-flex mb-4 mt-6"><span class="fa-stack me-2 ms-n1"><i class="fas fa-circle fa-stack-2x text-300"></i><i class="fa-inverse fa-stack-1x text-primary fas fa-list" data-fa-transform="shrink-2"></i></span>
            <div class="col">
              <h5 class="mb-0 text-primary position-relative"><span class="bg-200 dark__bg-1100 pe-3">Tables, Files, and Lists</span><span class="border position-absolute top-50 translate-middle-y w-100 start-0 z-n1"></span></h5>
              <p class="mb-0">Falcon's styled components are dedicatedly made for displaying your contents and lists.</p>
            </div>
          </div>
                ...
                <table class="table table-sm fs--1 mb-0 overflow-hidden">
                  ...
                  <tbody class="list" id="table-purchase-body">
                    <tr class="btn-reveal-trigger">
                      ...
                      <th class="align-middle white-space-nowrap name"><a href="app/e-commerce/customer-details.jsp">Sylvia Plath</a></th>
                      ...
                      <td class="align-middle text-center fs-0 white-space-nowrap payment"><small class="badge rounded badge-subtle-success false">Success</small>
                      </td>
                    ...
                    <tr class="btn-reveal-trigger">
                      ...
                      <th class="align-middle white-space-nowrap name"><a href="app/e-commerce/customer-details.jsp">Homer</a></th>
                    ...
                    <tr class="btn-reveal-trigger">
                      ...
                      <th class="align-middle white-space-nowrap name"><a href="app/e-commerce/customer-details.jsp">Edgar Allan Poe</a></th>
                      ...
                      <td class="align-middle text-center fs-0 white-space-nowrap payment"><small class="badge rounded badge-subtle-secondary dark__bg-1000">Blocked</small>
                      </td>
                    ...
                    <tr class="btn-reveal-trigger">
                      ...
                      <th class="align-middle white-space-nowrap name"><a href="app/e-commerce/customer-details.jsp">William Butler Yeats</a></th>
                    ...
                    <tr class="btn-reveal-trigger">
                      ...
                      <th class="align-middle white-space-nowrap name"><a href="app/e-commerce/customer-details.jsp">Rabindranath Tagore</a></th>
                    ...
                    <tr class="btn-reveal-trigger">
                      ...
                      <th class="align-middle white-space-nowrap name"><a href="app/e-commerce/customer-details.jsp">Emily Dickinson</a></th>
                      ...
                      <td class="align-middle text-center fs-0 white-space-nowrap payment"><small class="badge rounded badge-subtle-warning false">Pending</small>
                      </td>
                    ...
                    <tr class="btn-reveal-trigger">
                      ...
                      <th class="align-middle white-space-nowrap name"><a href="app/e-commerce/customer-details.jsp">Giovanni Boccaccio</a></th>
                    ...
                    <tr class="btn-reveal-trigger">
                      ...
                      <th class="align-middle white-space-nowrap name"><a href="app/e-commerce/customer-details.jsp">Oscar Wilde</a></th>
                    ...
                    <tr class="btn-reveal-trigger">
                      ...
                      <th class="align-middle white-space-nowrap name"><a href="app/e-commerce/customer-details.jsp">John Doe</a></th>
                    ...
                    <tr class="btn-reveal-trigger">
                      ...
                      <th class="align-middle white-space-nowrap name"><a href="app/e-commerce/customer-details.jsp">Emma Watson</a></th>
                    ...
                    <tr class="btn-reveal-trigger">
                      ...
                      <th class="align-middle white-space-nowrap name"><a href="app/e-commerce/customer-details.jsp">Anila Wilde</a></th>
                    ...
                    <tr class="btn-reveal-trigger">
                      ...
                      <th class="align-middle white-space-nowrap name"><a href="app/e-commerce/customer-details.jsp">Jack Watson </a></th>
                ...
                <table class="table table-sm table-striped fs--1 mb-0 overflow-hidden">
                  ...
                  <tbody class="list" id="table-customers-body">
                    <tr class="btn-reveal-trigger">
                      ...
                      <td class="name align-middle white-space-nowrap py-2"><a href="app/e-commerce/customer-details.jsp">
          ...
          <div class="card mb-3" id="enrolledCoursesTable" data-list='{"valueNames":["title","trainer","date","time","progress","price"]}'>
            <div class="card-header d-flex flex-between-center">
                  ...
                  <tbody class="list">
                    <tr class="btn-reveal-trigger fw-semi-bold">
                      <td class="align-middle white-space-nowrap title" style="max-width: 23rem;">
                        <div class="d-flex gap-3 align-items-center position-relative"><img class="rounded-1 border border-200" src="assets/img/elearning/courses/course3.png" width="60" alt="" /><a class="stretched-link text-truncate" href="app/e-learning/course/course-details.jsp">Advanced Design Tools for Modern Designs</a></div>
                      </td>
                      <td class="align-middle text-nowrap trainer"><a class="text-800" href="app/e-learning/trainer-profile.jsp">Bill finger</a></td>
                    ...
                    <tr class="btn-reveal-trigger fw-semi-bold">
                      <td class="align-middle white-space-nowrap title" style="max-width: 23rem;">
                        <div class="d-flex gap-3 align-items-center position-relative"><img class="rounded-1 border border-200" src="assets/img/elearning/courses/course8.png" width="60" alt="" /><a class="stretched-link text-truncate" href="app/e-learning/course/course-details.jsp">Character Design Masterclass: Your First Superhero</a></div>
                      </td>
                      <td class="align-middle text-nowrap trainer"><a class="text-800" href="app/e-learning/trainer-profile.jsp">Bruce Timm</a></td>
                      <td class="align-middle date">01/10/21</td>
                    ...
                    <tr class="btn-reveal-trigger fw-semi-bold">
                      <td class="align-middle white-space-nowrap title" style="max-width: 23rem;">
                        <div class="d-flex gap-3 align-items-center position-relative"><img class="rounded-1 border border-200" src="assets/img/elearning/courses/course5.png" width="60" alt="" /><a class="stretched-link text-truncate" href="app/e-learning/course/course-details.jsp">Abstract Painting: Zero to Mastery in Traditional Medium</a></div>
                      </td>
                      <td class="align-middle text-nowrap trainer"><a class="text-800" href="app/e-learning/trainer-profile.jsp">J. H. Williams III</a></td>
                    ...
                    <tr class="btn-reveal-trigger fw-semi-bold">
                      <td class="align-middle white-space-nowrap title" style="max-width: 23rem;">
                        <div class="d-flex gap-3 align-items-center position-relative"><img class="rounded-1 border border-200" src="assets/img/elearning/courses/course7.png" width="60" alt="" /><a class="stretched-link text-truncate" href="app/e-learning/course/course-details.jsp">Character Design Masterclass: Your First Supervillain</a></div>
                      </td>
                      <td class="align-middle text-nowrap trainer"><a class="text-800" href="app/e-learning/trainer-profile.jsp">Bill finger</a></td>
                      <td class="align-middle date">01/10/21</td>
                    ...
                    <tr class="btn-reveal-trigger fw-semi-bold">
                      <td class="align-middle white-space-nowrap title" style="max-width: 23rem;">
                        <div class="d-flex gap-3 align-items-center position-relative"><img class="rounded-1 border border-200" src="assets/img/elearning/courses/course2.png" width="60" alt="" /><a class="stretched-link text-truncate" href="app/e-learning/course/course-details.jsp">Composition in Comics: Easy to Read Between Panels</a></div>
                      </td>
                      <td class="align-middle text-nowrap trainer"><a class="text-800" href="app/e-learning/trainer-profile.jsp">Bill finger</a></td>
          ...
          <div class="card overflow-hidden mb-3">
                    ...
                    <div class="px-0 py-0">
                      <div class="table-responsive scrollbar">
                        <table class="table fs--1 mb-0 overflow-hidden">
                          ...
                          <tbody class="list">
                            <tr class="btn-reveal-trigger fw-semi-bold">
                              <td class="align-middle white-space-nowrap title"><a href="app/e-learning/course/course-details.jsp">Advanced Design Tools for Modern Designs</a></td>
                              <td class="align-middle text-nowrap name"><a class="text-800" href="app/e-learning/trainer-profile.jsp">Bill finger</a></td>
                            ...
                            <tr class="btn-reveal-trigger fw-semi-bold">
                              <td class="align-middle white-space-nowrap title"><a href="app/e-learning/course/course-details.jsp">Photograpy Basics: Get Familiar Standing Behind Lens</a></td>
                              <td class="align-middle text-nowrap name"><a class="text-800" href="app/e-learning/trainer-profile.jsp">Bruce Timm</a></td>
                            ...
                            <tr class="btn-reveal-trigger fw-semi-bold">
                              <td class="align-middle white-space-nowrap title"><a href="app/e-learning/course/course-details.jsp">Abstract Painting: Zero to Mastery in Traditional Medium</a></td>
                              <td class="align-middle text-nowrap name"><a class="text-800" href="app/e-learning/trainer-profile.jsp">J. H. Williams III</a></td>
                            ...
                            <tr class="btn-reveal-trigger fw-semi-bold">
                              <td class="align-middle white-space-nowrap title"><a href="app/e-learning/course/course-details.jsp">Character Design Masterclass: Your First Supervillain</a></td>
                              <td class="align-middle text-nowrap name"><a class="text-800" href="app/e-learning/trainer-profile.jsp">Bill finger</a></td>
                    ...
                    <div class="px-0 py-0">
                      <div class="table-responsive scrollbar">
                        <table class="table fs--1 mb-0 overflow-hidden">
                          ...
                          <tbody class="list">
                            <tr class="btn-reveal-trigger fw-semi-bold">
                              <td class="align-middle white-space-nowrap title"><a href="app/e-learning/course/course-details.jsp">Script Writing Masterclass: Introdution to Industry Cliches</a></td>
                              <td class="align-middle text-nowrap name"><a class="text-800" href="app/e-learning/trainer-profile.jsp">Bill finger</a></td>
                            ...
                            <tr class="btn-reveal-trigger fw-semi-bold">
                              <td class="align-middle white-space-nowrap title"><a href="app/e-learning/course/course-details.jsp">Composition in Comics: Easy to Read Between Panels</a></td>
                              <td class="align-middle text-nowrap name"><a class="text-800" href="app/e-learning/trainer-profile.jsp">Bill finger</a></td>
                            ...
                            <tr class="btn-reveal-trigger fw-semi-bold">
                              <td class="align-middle white-space-nowrap title"><a href="app/e-learning/course/course-details.jsp">Comic Page Layout: Analysing The Classics</a></td>
                              <td class="align-middle text-nowrap name"><a class="text-800" href="app/e-learning/trainer-profile.jsp">Bill finger</a></td>
                            ...
                            <tr class="btn-reveal-trigger fw-semi-bold">
                              <td class="align-middle white-space-nowrap title"><a href="app/e-learning/course/course-details.jsp">Inking: Choosing Between Analog vs Digital</a></td>
                              <td class="align-middle text-nowrap name"><a class="text-800" href="app/e-learning/trainer-profile.jsp">Bill finger</a></td>
                              <td class="align-middle white-space-nowrap text-end published">09/06/21</td>
                    ...
                    <div class="px-0 py-0">
                      <div class="table-responsive scrollbar">
                        <table class="table fs--1 mb-0 overflow-hidden">
                          ...
                          <tbody class="list">
                            <tr class="btn-reveal-trigger fw-semi-bold">
                              <td class="align-middle white-space-nowrap title"><a href="app/e-learning/course/course-details.jsp">Character Art School: Character Drawing Course</a></td>
                              <td class="align-middle text-nowrap name"><a class="text-800" href="app/e-learning/trainer-profile.jsp">Bruce Timm</a></td>
                            ...
                            <tr class="btn-reveal-trigger fw-semi-bold">
                              <td class="align-middle white-space-nowrap title"><a href="app/e-learning/course/course-details.jsp">User Experience Design Essentials</a></td>
                              <td class="align-middle text-nowrap name"><a class="text-800" href="app/e-learning/trainer-profile.jsp">Bill finger</a></td>
                            ...
                            <tr class="btn-reveal-trigger fw-semi-bold">
                              <td class="align-middle white-space-nowrap title"><a href="app/e-learning/course/course-details.jsp">The Art &amp; Science of Drawing</a></td>
                              <td class="align-middle text-nowrap name"><a class="text-800" href="app/e-learning/trainer-profile.jsp">J. H. Williams III</a></td>
                              <td class="align-middle white-space-nowrap text-end published">03/09/21</td>
                              <td class="align-middle text-end enrolled">35,666</td>
                              <td class="align-middle text-end price">$45.49</td>
                            ...
                            <tr class="btn-reveal-trigger fw-semi-bold">
                              <td class="align-middle white-space-nowrap title"><a href="app/e-learning/course/course-details.jsp">Abstract Painting: One-to-One</a></td>
                              <td class="align-middle text-nowrap name"><a class="text-800" href="app/e-learning/trainer-profile.jsp">Bill finger</a></td>
                              <td class="align-middle white-space-nowrap text-end published">03/09/21</td>
                    ...
                    <div class="px-0 py-0">
                      <div class="table-responsive scrollbar">
                        <table class="table fs--1 mb-0 overflow-hidden">
                          ...
                          <tbody class="list">
                            <tr class="btn-reveal-trigger fw-semi-bold">
                              <td class="align-middle white-space-nowrap title"><a href="app/e-learning/course/course-details.jsp">Portrait Drawing Fundamentals Made Simple</a></td>
                              <td class="align-middle text-nowrap name"><a class="text-800" href="app/e-learning/trainer-profile.jsp">Bill finger</a></td>
                            ...
                            <tr class="btn-reveal-trigger fw-semi-bold">
                              <td class="align-middle white-space-nowrap title"><a href="app/e-learning/course/course-details.jsp">Anatomy for Figure Drawing</a></td>
                              <td class="align-middle text-nowrap name"><a class="text-800" href="app/e-learning/trainer-profile.jsp">J. H. Williams</a></td>
                            ...
                            <tr class="btn-reveal-trigger fw-semi-bold">
                              <td class="align-middle white-space-nowrap title"><a href="app/e-learning/course/course-details.jsp">Complete Perspective Drawing Course</a></td>
                              <td class="align-middle text-nowrap name"><a class="text-800" href="app/e-learning/trainer-profile.jsp">Bruce Timm</a></td>
                            ...
                            <tr class="btn-reveal-trigger fw-semi-bold">
                              <td class="align-middle white-space-nowrap title"><a href="app/e-learning/course/course-details.jsp">The Ultimate Animal Drawing Course</a></td>
                              <td class="align-middle text-nowrap name"><a class="text-800" href="app/e-learning/trainer-profile.jsp">Bruce Timm</a></td>
            ...
            <div class="card-footer bg-light py-2">
              <div class="row flex-between-center g-0">
                ...
                <div class="col-auto"><a class="btn btn-link btn-sm px-0 fw-medium" href="app/e-learning/course/course-list.jsp">All Courses<span class="fas fa-chevron-right ms-1 fs--2"></span></a></div>
              </div>
            </div>
          </div>
          <div class="row g-3 mb-3">
                ...
                <div class="card-body">
                  <div class="row g-3 h-100">
                    ...
                    <div class="col-sm-6 col-lg-12">
                      ...
                      </table><small class="badge rounded badge-subtle-success false">Verified</small><small class="badge rounded badge-subtle-warning false">Non Billable</small>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="card-body p-0">
                  <div class="table-responsive scrollbar">
                    <table class="table mb-0 fs--1 border-200 overflow-hidden">
                      ...
                      <tbody class="list">
                        <tr class="fw-semi-bold">
                          <td class="align-middle pe-5 py-3 course"><a href="app/e-learning/course/course-details.jsp">Course#123232</a></td>
                        ...
                        <tr class="fw-semi-bold">
                          <td class="align-middle pe-5 py-3 course"><a href="app/e-learning/course/course-details.jsp">Course#147832</a></td>
                        ...
                        <tr class="fw-semi-bold">
                          <td class="align-middle pe-5 py-3 course"><a href="app/e-learning/course/course-details.jsp">Course#965473</a></td>
                        ...
                        <tr class="fw-semi-bold">
                          <td class="align-middle pe-5 py-3 course"><a href="app/e-learning/course/course-details.jsp">Course#854763</a></td>
                        ...
                        <tr class="fw-semi-bold">
                          <td class="align-middle pe-5 py-3 course"><a href="app/e-learning/course/course-details.jsp">Course#232645</a></td>
                        ...
                        <tr class="fw-semi-bold">
                          <td class="align-middle pe-5 py-3 course"><a href="app/e-learning/course/course-details.jsp">Course#232471</a></td>
                        ...
                        <tr class="fw-semi-bold">
                          <td class="align-middle pe-5 py-3 course"><a href="app/e-learning/course/course-details.jsp">Course#232558</a></td>
          ...
          <div class="row g-3 mb-3">
              ...
              <div class="card h-lg-100">
                ...
                <div class="card-body pb-0">
                  <div class="d-flex mb-3 hover-actions-trigger align-items-center">
                    <div class="file-thumbnail"><img class="border h-100 w-100 object-fit-cover rounded-2" src="assets/img/products/3-thumb.png" alt="" />
                    </div>
                  ...
                  <hr class="text-200" />
                  <div class="d-flex mb-3 hover-actions-trigger align-items-center">
                    <div class="file-thumbnail"><img class="border h-100 w-100 object-fit-cover rounded-2" src="assets/img/products/2-thumb.png" alt="" />
                    </div>
                    <div class="ms-3 flex-shrink-1 flex-grow-1">
                  ...
                  <div class="d-flex mb-3 hover-actions-trigger align-items-center">
                    ...
                    <div class="ms-3 flex-shrink-1 flex-grow-1">
                      <h6 class="mb-1"><a class="stretched-link text-900 fw-semi-bold" href="#!">Boots4-v1.0.0.zip</a></h6>
                      <div class="fs--1"><span class="fw-semi-bold">Anna</span><span class="fw-medium text-600 ms-2">5 Oct at 4:30 PM</span></div>
                      <div class="hover-actions end-0 top-50 translate-middle-y"><a class="btn btn-light border-300 btn-sm me-1 text-600" data-bs-toggle="tooltip" data-bs-placement="top" title="Download" href="assets/img/icons/cloud-download.svg" download="download"><img src="assets/img/icons/cloud-download.svg" alt="" width="15" /></a>
                        <button class="btn btn-light border-300 btn-sm me-1 text-600 shadow-none" type="button" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit"><img src="assets/img/icons/edit-alt.svg" alt="" width="15" /></button>
                      </div>
                    </div>
            ...
            <div class="col-lg-7 col-xxl-8">
              <div class="card" id="table" data-list='{"valueNames":["path","views","time","exitRate"],"page":6,"pagination":true,"fallback":"pages-table-fallback"}'>
                <div class="card-header">
                  <div class="row flex-between-center">
                    ...
                    <table class="table fs--1 mb-0 overflow-hidden">
                      <thead class="bg-200 text-900">
                        <tr>
                          ...
                          <th class="sort pe-x1 align-middle white-space-nowrap text-end" data-sort="exitRate">Exit Rate</th>
                        </tr>
                      </thead>
                      <tbody class="list">
                        <tr class="btn-reveal-trigger">
                        ...
                        <tr class="btn-reveal-trigger">
                          <td class="align-middle white-space-nowrap path"><a class="text-primary fw-semi-bold" href="#!">/falcon/pages/starter.jsp</a></td>
                  ...
                  <div class="table-responsive scrollbar">
                    <table class="table table-dashboard mb-0 fs--1">
                      <tr>
                        ...
                        <td class="align-middle px-4" style="width:1%;"><span class="badge fs--1 w-100 badge-subtle-success">Completed</span></td>
                        ...
                        <td class="align-middle ps-4 pe-1" style="width: 130px; min-width: 130px;">
                          <select class="form-select form-select-sm px-2">
                      ...
                      <tr>
                        ...
                        <td class="align-middle px-4" style="width:1%;"><span class="badge fs--1 w-100 badge-subtle-warning">Pending</span></td>
                        <td class="align-middle px-4 text-end text-nowrap" style="width:1%;">
                      ...
                      <tr class="border-0">
                        ...
                        <td class="align-middle px-4 border-0" style="width:1%;"><span class="badge fs--1 w-100 badge-subtle-danger">Rejected</span></td>
                ...
                <div class="tab-content" id="ticketViewContent">
                  <div class="fade tab-pane active show" id="table-view" role="tabpanel" aria-labelledby="tableView" data-list='{"valueNames":["client","subject","status","priority","agent"],"page":6,"pagination":true}'>
                    ...
                    <div class="card-footer">
                      <div class="row align-items-center">
                        <div class="pagination d-none"></div>
                        <div class="col"><span class="d-none d-sm-inline-block me-2 fs--1" data-list-info="data-list-info"></span></div>
                        <div class="col-auto d-flex">
                          <button class="btn btn-sm btn-primary" type="button" data-list-pagination="prev"><span>Previous</span></button>
                          <button class="btn btn-sm btn-primary px-4 ms-2" type="button" data-list-pagination="next"><span>Next</span></button>
                        </div>
          ...
          <div class="d-flex mb-4 mt-6"><span class="fa-stack me-2 ms-n1"><i class="fas fa-circle fa-stack-2x text-300"></i><i class="fa-inverse fa-stack-1x text-primary fas fa-cart-plus" data-fa-transform="shrink-4"></i></span>
            <div class="col">
              <h5 class="mb-0 text-primary position-relative"><span class="bg-200 dark__bg-1100 pe-3">E-commerce</span><span class="border position-absolute top-50 translate-middle-y w-100 start-0 z-n1"></span></h5>
          ...
          <div class="card mb-3">
            <div class="card-header">
              <div class="row justify-content-between">
                ...
                <div class="col-md-auto"><a class="btn btn-sm btn-outline-secondary border-300 me-2 shadow-none" href="app/e-commerce/product/product-list.jsp"> <span class="fas fa-chevron-left me-1" data-fa-transform="shrink-4"></span>Continue Shopping</a><a class="btn btn-sm btn-primary" href="app/e-commerce/checkout.jsp">Checkout</a></div>
              </div>
            </div>
            <div class="card-body p-0">
              ...
              <div class="row gx-card mx-0 align-items-center border-bottom border-200">
                <div class="col-8 py-3">
                  <div class="d-flex align-items-center"><a href="app/e-commerce/product/product-details.jsp"><img class="img-fluid rounded-1 me-3 d-none d-md-block" src="assets/img/products/1.jpg" alt="" width="60" /></a>
                    <div class="flex-1">
                      <h5 class="fs-0"><a class="text-900" href="app/e-commerce/product/product-details.jsp">Apple MacBook Pro 15&quot; Z0V20008N: 2.9GHz 6-core 8th-Gen Intel Core i9, 32GB RAM</a></h5>
              ...
              <div class="row gx-card mx-0 align-items-center border-bottom border-200">
                <div class="col-8 py-3">
                  <div class="d-flex align-items-center"><a href="app/e-commerce/product/product-details.jsp"><img class="img-fluid rounded-1 me-3 d-none d-md-block" src="assets/img/products/2.jpg" alt="" width="60" /></a>
                    <div class="flex-1">
                      <h5 class="fs-0"><a class="text-900" href="app/e-commerce/product/product-details.jsp">Apple iMac Pro (27-inch with Retina 5K Display, 3.0GHz 10-core Intel Xeon W, 1TB SSD)</a></h5>
                      <div class="fs--2 fs-md--1"><a class="text-danger" href="#!">Remove</a></div>
                    </div>
                  </div>
                </div>
              ...
              <div class="row gx-card mx-0 align-items-center border-bottom border-200">
                <div class="col-8 py-3">
                  <div class="d-flex align-items-center"><a href="app/e-commerce/product/product-details.jsp"><img class="img-fluid rounded-1 me-3 d-none d-md-block" src="assets/img/products/4.jpg" alt="" width="60" /></a>
                    <div class="flex-1">
                      <h5 class="fs-0"><a class="text-900" href="app/e-commerce/product/product-details.jsp">Apple iPad Air 2019 (3GB RAM, 128GB ROM, 8MP Main Camera)</a></h5>
                      <div class="fs--2 fs-md--1"><a class="text-danger" href="#!">Remove</a></div>
                    </div>
                  </div>
                </div>
              ...
              <div class="row gx-card mx-0 align-items-center border-bottom border-200">
                <div class="col-8 py-3">
                  <div class="d-flex align-items-center"><a href="app/e-commerce/product/product-details.jsp"><img class="img-fluid rounded-1 me-3 d-none d-md-block" src="assets/img/products/3.jpg" alt="" width="60" /></a>
                    <div class="flex-1">
                      <h5 class="fs-0"><a class="text-900" href="app/e-commerce/product/product-details.jsp">Apple iPhone XS Max (4GB RAM, 512GB ROM, 12MP Main Camera)</a></h5>
                      <div class="fs--2 fs-md--1"><a class="text-danger" href="#!">Remove</a></div>
                    </div>
                  </div>
                </div>
              ...
              <div class="row gx-card mx-0 align-items-center border-bottom border-200">
                <div class="col-8 py-3">
                  <div class="d-flex align-items-center"><a href="app/e-commerce/product/product-details.jsp"><img class="img-fluid rounded-1 me-3 d-none d-md-block" src="assets/img/products/5.jpg" alt="" width="60" /></a>
                    <div class="flex-1">
                      <h5 class="fs-0"><a class="text-900" href="app/e-commerce/product/product-details.jsp">Apple Watch Series 4 44mm GPS Only</a></h5>
                      <div class="fs--2 fs-md--1"><a class="text-danger" href="#!">Remove</a></div>
                    </div>
                  </div>
                </div>
              ...
              <div class="row gx-card mx-0 align-items-center border-bottom border-200">
                <div class="col-8 py-3">
                  <div class="d-flex align-items-center"><a href="app/e-commerce/product/product-details.jsp"><img class="img-fluid rounded-1 me-3 d-none d-md-block" src="assets/img/products/7.jpg" alt="" width="60" /></a>
                    <div class="flex-1">
                      <h5 class="fs-0"><a class="text-900" href="app/e-commerce/product/product-details.jsp">Nikon D3200 Digital DSLR Camera</a></h5>
                      <div class="fs--2 fs-md--1"><a class="text-danger" href="#!">Remove</a></div>
                    </div>
                  </div>
                </div>
              ...
              <div class="row gx-card mx-0 align-items-center border-bottom border-200">
                <div class="col-8 py-3">
                  <div class="d-flex align-items-center"><a href="app/e-commerce/product/product-details.jsp"><img class="img-fluid rounded-1 me-3 d-none d-md-block" src="assets/img/products/8.jpg" alt="" width="60" /></a>
                    <div class="flex-1">
                      <h5 class="fs-0"><a class="text-900" href="app/e-commerce/product/product-details.jsp">Canon Standard Zoom Lens</a></h5>
                      <div class="fs--2 fs-md--1"><a class="text-danger" href="#!">Remove</a></div>
                    </div>
                  </div>
                </div>
            ...
            <div class="card-footer bg-light d-flex justify-content-end">
              ...
              </form><a class="btn btn-sm btn-primary" href="app/e-commerce/checkout.jsp">Checkout</a>
            </div>
          </div>
          <div class="row g-3 mb-3">
            <div class="col-lg-6">
            ...
            <div class="col-lg-6">
              <div class="card">
                <div class="card-header bg-light btn-reveal-trigger d-flex flex-between-center">
                  <h5 class="mb-0">Order Summary</h5><a class="btn btn-link btn-sm btn-reveal text-600" href="app/e-commerce/shopping-cart.jsp"><span class="fas fa-pencil-alt"></span></a>
                </div>
                <div class="card-body">
          ...
          <div class="d-flex mb-4 mt-6"><span class="fa-stack me-2 ms-n1"><i class="fas fa-circle fa-stack-2x text-300"></i><i class="fa-inverse fa-stack-1x text-primary fas fa-user-friends" data-fa-transform="shrink-4"></i></span>
            <div class="col">
              <h5 class="mb-0 text-primary position-relative"><span class="bg-200 dark__bg-1100 pe-3">Users &amp; Feed</span><span class="border position-absolute top-50 translate-middle-y w-100 start-0 z-n1"></span></h5>
              <p class="mb-0"></p>
            </div>
          </div>
          <div class="row g-0 align-items-stretch h-100">
              ...
              <div class="card mb-3 mb-lg-0 h-100">
                ...
                <div class="card-body fs--1">
                  <div class="d-flex btn-reveal-trigger">
                    ...
                    <div class="flex-1 position-relative ps-3">
                      <h6 class="fs-0 mb-0"><a href="app/events/event-detail.jsp">Newmarket Nights</a></h6>
                  ...
                  <div class="d-flex btn-reveal-trigger">
                    ...
                    <div class="flex-1 position-relative ps-3">
                      <h6 class="fs-0 mb-0"><a href="app/events/event-detail.jsp">31st Night Celebration</a></h6>
                  ...
                  <div class="d-flex btn-reveal-trigger">
                    ...
                    <div class="flex-1 position-relative ps-3">
                      <h6 class="fs-0 mb-0"><a href="app/events/event-detail.jsp">Folk Festival</a></h6>
                ...
                <div class="card-footer bg-light p-0 border-top"><a class="btn btn-link d-block w-100" href="app/events/event-list.jsp">All Events<span class="fas fa-chevron-right ms-1 fs--2"></span></a></div>
              </div>
            </div>
            <div class="col-lg-6 ps-lg-2 mb-3">
              <div class="card h-100">
                ...
                <div class="card-footer bg-light py-0 border-top"><a class="btn btn-link d-block w-100" href="app/social/notifications.jsp">All Notifications</a></div>
              </div>
            </div>
          </div>
          <div class="row g-0">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body fs--1 pb-0">
                  <div class="row">
                    ...
                    <div class="col-sm-6 col-md-4 mb-3">
                      <div class="d-flex position-relative align-items-center mb-2"><img class="d-flex align-self-center me-2 rounded-3" src="assets/img/logos/mailbluster.png" alt="" width="50" />
                        <div class="flex-1">
                    ...
                    <div class="col-sm-6 col-md-4 mb-3">
                      <div class="d-flex position-relative align-items-center mb-2"><img class="d-flex align-self-center me-2 rounded-3" src="assets/img/logos/digitalocean.png" alt="" width="50" />
                        <div class="flex-1">
                    ...
                    <div class="col-sm-6 col-md-4 mb-3">
                      <div class="d-flex position-relative align-items-center mb-2"><img class="d-flex align-self-center me-2 rounded-3" src="assets/img/logos/nvidia.png" alt="" width="50" />
                        <div class="flex-1">
                    ...
                    <div class="col-sm-6 col-md-4 mb-3">
                      <div class="d-flex position-relative align-items-center mb-2"><img class="d-flex align-self-center me-2 rounded-3" src="assets/img/logos/hp.png" alt="" width="50" />
                        <div class="flex-1">
                    ...
                    <div class="col-sm-6 col-md-4 mb-3">
                      <div class="d-flex position-relative align-items-center mb-2"><img class="d-flex align-self-center me-2 rounded-3" src="assets/img/logos/spotify.png" alt="" width="50" />
                        <div class="flex-1">
                ...
                <div class="card-body bg-light px-1 py-0">
                  <div class="row g-0 text-center fs--1">
                    <div class="col-6 col-md-4">
                      <div class="bg-white dark__bg-1100 p-3 h-100"><a href="pages/user/profile.jsp"><img class="img-thumbnail img-fluid rounded-circle mb-3 shadow-sm" src="assets/img/team/1.jpg" alt="" width="100" /></a>
                        <h6 class="mb-1"><a href="pages/user/profile.jsp">Emilia Clarke</a>
                        </h6>
                        <p class="fs--2 mb-1"><a class="text-700" href="#!">Technext limited</a></p>
                      </div>
                    </div>
                    <div class="col-6 col-md-4">
                      <div class="bg-white dark__bg-1100 p-3 h-100"><a href="pages/user/profile.jsp"><img class="img-thumbnail img-fluid rounded-circle mb-3 shadow-sm" src="assets/img/team/2.jpg" alt="" width="100" /></a>
                        <h6 class="mb-1"><a href="pages/user/profile.jsp">Kit Harington</a>
                        </h6>
                        <p class="fs--2 mb-1"><a class="text-700" href="#!">Harvard Korea Society</a></p>
                      </div>
                    </div>
                    <div class="col-6 col-md-4">
                      <div class="bg-white dark__bg-1100 p-3 h-100"><a href="pages/user/profile.jsp"><img class="img-thumbnail img-fluid rounded-circle mb-3 shadow-sm" src="assets/img/team/3.jpg" alt="" width="100" /></a>
                        <h6 class="mb-1"><a href="pages/user/profile.jsp">Sophie Turner</a>
                        </h6>
                        <p class="fs--2 mb-1"><a class="text-700" href="#!">Graduate Student Council</a></p>
                      </div>
                    </div>
                    <div class="col-6 col-md-4">
                      <div class="bg-white dark__bg-1100 p-3 h-100"><a href="pages/user/profile.jsp"><img class="img-thumbnail img-fluid rounded-circle mb-3 shadow-sm" src="assets/img/team/4.jpg" alt="" width="100" /></a>
                        <h6 class="mb-1"><a href="pages/user/profile.jsp">Peter Dinklage</a>
                        </h6>
                        <p class="fs--2 mb-1"><a class="text-700" href="#!">Art Club, MIT</a></p>
                      </div>
                    </div>
                    <div class="col-6 col-md-4">
                      <div class="bg-white dark__bg-1100 p-3 h-100"><a href="pages/user/profile.jsp"><img class="img-thumbnail img-fluid rounded-circle mb-3 shadow-sm" src="assets/img/team/5.jpg" alt="" width="100" /></a>
                        <h6 class="mb-1"><a href="pages/user/profile.jsp">Nikolaj Coster</a>
                        </h6>
                        <p class="fs--2 mb-1"><a class="text-700" href="#!">Archery Club, MIT</a></p>
                      </div>
                    </div>
                    <div class="col-6 col-md-4">
                      <div class="bg-white dark__bg-1100 p-3 h-100"><a href="pages/user/profile.jsp"><img class="img-thumbnail img-fluid rounded-circle mb-3 shadow-sm" src="assets/img/team/6.jpg" alt="" width="100" /></a>
                        <h6 class="mb-1"><a href="pages/user/profile.jsp">Isaac Hempstead</a>
                        </h6>
            ...
            <div class="col-lg-5 ps-lg-2 mb-3">
              <div class="card h-100">
                <div class="card-body text-center py-5">
                  ...
                  <h3 class="mt-3 fw-normal fs-2">Invite a friend, you both get $100</h3>
                  <p class="lead mb-5">Invite your friends and start working together in seconds. Everyone you invite will receive a welcome email.
                  </p>
                  <div class="row justify-content-center">
                    <div class="col">
                      <form class="row gx-2">
                ...
                <div class="card-footer bg-light text-center pt-4">
                  <div class="row justify-content-center">
                    <div class="col-11 col-sm-10">
                      <h4 class="fw-normal mb-0 fs-1">More ways to <br class="d-sm-none" /> invite your friends</h4>
                      <div class="row gx-2 my-4">
                        <div class="col-12">
                          <button class="btn btn-falcon-default d-block w-100 mb-2"><img src="assets/img/logos/gmail.png" width="20" alt="" /><span class="fw-medium ms-2">Invite from Gmail</span></button>
                        </div>
                        <div class="col-12">
                          <button class="btn btn-falcon-default d-block w-100 mb-2" data-bs-toggle="modal" data-bs-target="#copyLinkModal"><span class="fas fa-link text-700"></span><span class="fw-medium ms-2">Copy Link</span></button>
                        ...
                        <div class="col-12">
                          <button class="btn btn-falcon-default d-block w-100 ms-0"><span class="fab fa-facebook-square text-facebook" data-fa-transform="grow-2"></span><span class="fw-medium ms-2">Share on Facebook</span></button>
                        </div>
                      </div>
                        ...
                        <div class="col">
                          <div class="d-flex">
                            ...
                            <div class="flex-1 align-self-center ms-2">
                              <p class="mb-1 lh-1"><a class="fw-semi-bold" href="pages/user/profile.jsp">Johnny Depp</a> shared a <a href="#!">video</a></p>
                  ...
                  <div class="card h-100">
                      ...
                      <div class="row justify-content-between">
                        <div class="col">
                          <div class="d-flex">
                            ...
                            <div class="flex-1 align-self-center ms-2">
                              <p class="mb-1 lh-1"><a class="fw-semi-bold" href="pages/user/profile.jsp">Rowan Atkinson</a> shared an <a href="#!">album</a></p>
                    ...
                    <div class="card-footer bg-light pt-0">
                      ...
                      <div class="d-flex mt-3">
                        ...
                        <div class="flex-1 ms-2 fs--1">
                          <p class="mb-1 bg-200 rounded-3 p-2"><a class="fw-semi-bold" href="pages/user/profile.jsp">Jessalyn Gilsig</a> Jessalyn Sarah Gilsig is a Canadian-American actress known for her roles in television series, e.g., as Lauren Davis in Boston Public, Gina Russo in Nip/Tuck, Terri Schuester in Glee, and as Siggy Haraldson on the History Channel series Vikings. 🏆</p>
            ...
            <div class="col-lg-4 ps-lg-2 mb-3">
              <div class="card mb-3">
                <div class="card-header bg-light d-flex justify-content-between">
                  <h5 class="mb-0">Activity log</h5><a class="font-sans-serif" href="app/social/activity-log.jsp">All logs</a>
                </div>
                ...
                <div class="card-body">
                  <div class="d-flex">
                    ...
                    <div class="flex-1 ms-2">
                      <h6 class="mb-0"><a href="pages/user/profile.jsp">Katheryn Winnick</a></h6>
                  ...
                  <div class="d-flex">
                    ...
                    <div class="flex-1 ms-2">
                      <h6 class="mb-0"><a href="pages/user/profile.jsp">Travis Fimmel</a></h6>
                  ...
                  <div class="d-flex">
                    ...
                    <div class="flex-1 ms-2">
                      <h6 class="mb-0"><a href="pages/user/profile.jsp">Gustaf Skarsgård</a></h6>
                  ...
                  <div class="d-flex">
                    ...
                    <div class="flex-1 ms-2">
                      <h6 class="mb-0"><a href="pages/user/profile.jsp">Clive Standen</a></h6>
                  ...
                  <div class="d-flex">
                    ...
                    <div class="flex-1 ms-2">
                      <h6 class="mb-0"><a href="pages/user/profile.jsp">Jennie Jacques</a></h6>
                      <button class="btn btn-light btn-sm py-0 mt-1 border" type="button"><span class="fas fa-user-plus" data-fa-transform="shrink-5 left-2"></span><span class="fs--1">Follow</span></button>
                      <div class="border-bottom border-dashed my-3"></div>
                    </div>
                  </div>
                  <div class="d-flex">
                    ...
                    <div class="flex-1 ms-2">
                      <h6 class="mb-0"><a href="pages/user/profile.jsp">Isaac Hempstead</a></h6>
                      <button class="btn btn-light btn-sm py-0 mt-1 border" type="button"><span class="fas fa-user-plus" data-fa-transform="shrink-5 left-2"></span><span class="fs--1">Follow</span></button>
                      <div class="border-bottom border-dashed my-3"></div>
                    </div>
                  </div>
                  <div class="d-flex">
                    ...
                    <div class="flex-1 ms-2">
                      <h6 class="mb-0"><a href="pages/user/profile.jsp">Antony Hopkins</a></h6>
                      <button class="btn btn-light btn-sm py-0 mt-1 border" type="button"><span class="fas fa-user-plus" data-fa-transform="shrink-5 left-2"></span><span class="fs--1">Follow</span></button>
                      <div class="border-bottom border-dashed my-3"></div>
                    </div>
                  </div>
                  <div class="d-flex">
                    ...
                    <div class="flex-1 ms-2">
                      <h6 class="mb-0"><a href="pages/user/profile.jsp">Sophie Turner</a></h6>
                      <button class="btn btn-light btn-sm py-0 mt-1 border" type="button"><span class="fas fa-user-plus" data-fa-transform="shrink-5 left-2"></span><span class="fs--1">Follow</span></button>
                    </div>
                  </div>
                </div>
              ...
              <div class="card">
                ...
                <div class="card-body py-2">
                  <div class="d-flex align-items-center position-relative mb-3">
                    ...
                    <div class="flex-1 ms-3">
                      <h6 class="mb-0 fw-semi-bold"><a class="stretched-link text-900" href="pages/user/profile.jsp">Emma Watson</a></h6>
                  ...
                  <div class="d-flex align-items-center position-relative mb-3">
                    ...
                    <div class="flex-1 ms-3">
                      <h6 class="mb-0 fw-semi-bold"><a class="stretched-link text-900" href="pages/user/profile.jsp">Antony Hopkins</a></h6>
                  ...
                  <div class="d-flex align-items-center position-relative mb-3">
                    ...
                    <div class="flex-1 ms-3">
                      <h6 class="mb-0 fw-semi-bold"><a class="stretched-link text-900" href="pages/user/profile.jsp">Anna Karinina</a></h6>
                  ...
                  <div class="d-flex align-items-center position-relative mb-3">
                    ...
                    <div class="flex-1 ms-3">
                      <h6 class="mb-0 fw-semi-bold"><a class="stretched-link text-900" href="pages/user/profile.jsp">John Lee</a></h6>
                      <p class="text-500 fs--2 mb-0">Admin</p>
                    </div>
                  </div>
                  <div class="d-flex align-items-center position-relative mb-3">
                    ...
                    <div class="flex-1 ms-3">
                      <h6 class="mb-0 fw-semi-bold"><a class="stretched-link text-900" href="pages/user/profile.jsp">Rowen Atkinson</a></h6>
                      <p class="text-500 fs--2 mb-0">Editor</p>
                    </div>
                  </div>
                  <div class="d-flex align-items-center position-relative false">
                    ...
                    <div class="flex-1 ms-3">
                      <h6 class="mb-0 fw-semi-bold"><a class="stretched-link text-900" href="pages/user/profile.jsp">Bucky Robert</a></h6>
                      <p class="text-500 fs--2 mb-0">Editor</p>
                    </div>
                  </div>
                </div>
                <div class="card-footer bg-light p-0"><a class="btn btn-sm btn-link d-block w-100 py-2" href="app/social/followers.jsp">All active users<span class="fas fa-chevron-right ms-1 fs--2"></span></a></div>
              </div>
            </div>
          </div>
          <div class="card mb-3">
          ...
          <div class="d-flex mb-4 mt-6"><span class="fa-stack me-2 ms-n1"><i class="fas fa-circle fa-stack-2x text-300"></i><i class="fa-inverse fa-stack-1x text-primary fas fa-exclamation-circle"></i></span>
            <div class="col">
              <h5 class="mb-0 text-primary position-relative"><span class="bg-200 dark__bg-1100 pe-3">Errors</span><span class="border position-absolute top-50 translate-middle-y w-100 start-0 z-n1"></span></h5>
              <p class="mb-0">Display your error pages with awesome cards.</p>
            </div>
          </div>
          <div class="row g-0">
            <div class="col-lg-6 pe-lg-2 mb-3 mb-lg-0">
              <div class="card text-center h-100">
                <div class="card-body p-4 p-sm-5">
                  ...
                  <hr />
                  <p>Make sure the address is correct and that the page hasn't moved. If you think this is a mistake, <a href="mailto:info@exmaple.com">contact us</a>.</p><a class="btn btn-primary btn-sm mt-3" href="index.jsp"><span class="fas fa-home me-2"></span>Take me home</a>
                </div>
              </div>
            </div>
          ...
          <div class="d-flex mb-4 mt-6"><span class="fa-stack me-2 ms-n1"><i class="fas fa-circle fa-stack-2x text-300"></i><i class="fa-inverse fa-stack-1x text-primary fas fa-file-alt" data-fa-transform="shrink-2"></i></span>
            <div class="col">
              <h5 class="mb-0 text-primary position-relative"><span class="bg-200 dark__bg-1100 pe-3">Forms</span><span class="border position-absolute top-50 translate-middle-y w-100 start-0 z-n1"></span></h5>
              <p class="mb-0">Get different types of data from the user by using Falcon's customizable form.</p>
            </div>
          </div>
          <div class="row g-0">
                  ...
                  <div class="card h-lg-100">
                    <div class="card-body p-4 p-sm-5">
                      <div class="row flex-between-center mb-2">
                        ...
                        <div class="col-auto fs--1 text-600"><span class="mb-0 undefined">Have an account?</span> <span><a href="pages/authentication/simple/login.jsp">Login</a></span></div>
                      </div>
                      <form>
                        <div class="mb-3">
                  ...
                  <div class="card">
                    ...
                    <div class="card-body p-4">
                      <div class="row flex-between-center">
                        ...
                        <div class="col-auto fs--1 text-600"><span class="mb-0 fw-semi-bold">New User?</span> <span><a href="pages/authentication/simple/register.jsp">Create account</a></span></div>
                      </div>
                      <form>
                        <div class="mb-3">
                        ...
                        <div class="row flex-between-center">
                          ...
                          <div class="col-auto"><a class="fs--1" href="pages/authentication/split/forgot-password.jsp">Forgot Password?</a></div>
                        </div>
                        <div class="mb-3">
              ...
              <div class="row g-0 h-100 align-items-stretch">
                <div class="col-lg-12 mb-3">
                  <div class="card h-100">
                    ...
                    <div class="card-body bg-light pb-0"><a class="mb-4 d-block d-flex align-items-center" href="#experience-form" data-bs-toggle="collapse" aria-expanded="true" aria-controls="experience-form"><span class="circle-dashed"><span class="fas fa-plus"></span></span><span class="ms-3">Add new experience</span></a>
                    ...
                    <div class="card-body bg-light pb-0">
                      <form>
                        ...
                        <div class="mb-3">
                          ...
                          <input class="form-control datetimepicker" type="text" placeholder="d/m/y" data-options='{"dateFormat":"d/m/y","disableMobile":true}' id="form-example-wizard-datepicker" />
                        </div>
                        <div class="mb-3">
                ...
                <div class="card-body p-0">
                  <form>
                    ...
                    <div class="row g-0 justify-content-between mt-3 px-x1 pb-3">
                      <div class="col">
                        <button class="btn btn-light btn-sm rounded-pill shadow-none d-inline-flex align-items-center fs--1 mb-0 me-1" type="button"><img class="cursor-pointer" src="assets/img/icons/spot-illustrations/image.svg" width="17" alt="" /><span class="ms-2 d-none d-md-inline-block">Image</span></button>
          ...
          <form class="card mb-3">
            ...
            <div class="card-body p-0">
              <div class="border border-top-0 border-200">
                <input class="form-control border-0 rounded-0 outline-none px-x1" id="email-to" type="email" aria-describedby="email-to" placeholder="To" />
              </div>
          ...
          <div class="d-flex mb-4 mt-6"><span class="fa-stack me-2 ms-n1"><i class="fas fa-circle fa-stack-2x text-300"></i><i class="fa-inverse fa-stack-1x text-primary fas fa-folder-plus" data-fa-transform="shrink-2"></i></span>
            <div class="col">
              <h5 class="mb-0 text-primary position-relative"><span class="bg-200 dark__bg-1100 pe-3">Others</span><span class="border position-absolute top-50 translate-middle-y w-100 start-0 z-n1"></span></h5>
              <p class="mb-0">Get more awesome cards for showing your different types of content..</p>
            </div>
          </div>
          <div class="row g-3 mb-3">
            <div class="col-xxl-8 d-flex flex-column align-items-stretched">
              <div class="card mb-3">
              ...
              <div class="card">
                <div class="card-body fs--1">
                  <div class="d-flex"><span class="fas fa-gift fs-0 text-warning"></span>
                    <div class="flex-1 ms-2"><a class="fw-semi-bold" href="pages/user/profile.jsp">Emma Watson</a>'s Birthday is today</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="col-xl-5 col-xxl-4">
              <div class="row g-3">
                ...
                <div class="col-lg-3 col-xl-12">
                  <div class="card h-100">
                    <div class="bg-holder d-none d-xl-block bg-card" style="background-image:url(assets/img/icons/spot-illustrations/corner-4.png);opacity: 0.7;">
                    </div>
                    <!--/.bg-holder-->
                    ...
                    <div class="card-body">
                      ...
                      <div><strong class="me-2">Status: </strong>
                        <div class="badge rounded-pill badge-subtle-success fs--2">Completed<span class="fas fa-check ms-1" data-fa-transform="shrink-2"></span></div>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="card h-100">
                <div class="card-body p-4 p-sm-5">
                  <div class="text-center"><img class="d-block mx-auto mb-4" src="assets/img/icons/spot-illustrations/45.png" alt="shield" width="100" />
                    <h4>See you again!</h4>
                    <p>Thanks for using Falcon. You are <br />now successfully signed out.</p><a class="btn btn-primary btn-sm mt-3" href="pages/authentication/simple/login.jsp"><span class="fas fa-chevron-left me-1" data-fa-transform="shrink-4 down-1"></span>Return to Login</a>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="card">
                <div class="card-body p-4 p-sm-5">
                  <div class="text-center"><img class="d-block mx-auto mb-4" src="assets/img/icons/spot-illustrations/16.png" alt="Email" width="100" />
                    ...
                    </p><a class="btn btn-primary btn-sm mt-3" href="pages/authentication/simple/login.jsp"><span class="fas fa-chevron-left me-1" data-fa-transform="shrink-4 down-1"></span>Return to login</a>
                  </div>
                </div>
              </div>
            </div>
