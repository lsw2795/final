    ...
    <main class="main" id="top">
      <div class="container" data-layout="container">
            ...
            <div class="navbar-vertical-content scrollbar">
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                ...
                <li class="nav-item">
                  ...
                  <!-- parent pages--><a class="nav-link active" href="../documentation/getting-started.jsp" role="button">
        ...
        <div class="content">
          ...
          <div class="card mb-3">
            <div class="card-header">
              <h5 class="mb-0" data-anchor="data-anchor">Quick start</h5>
            </div>
            <div class="card-body bg-light">
              <p class="mb-0">Looking to start your project quickly? Just unzip the <code>Falcon-v3.17.0.zip</code>. We have precompiled and packaged everything in the <code>public</code> directory for you. Start editing the <code>public/pages/starter.jsp</code> with a text or code editor, save it, and open the file in your favourite browser to see the changes.</p>
            </div>
          </div>
          <div class="card mb-3">
            <div class="card-header">
            ...
            <div class="card-body bg-light">
              <p>Unzip the <code>Falcon-v3.17.0.zip</code> to any folder and open a command line or terminal at that location.
              ...
              <p class="mt-4">Running gulp will compile the SCSS, transpile the javascript, copy all required libraries form <code>node_modules</code> to the corresponding <code>public/assets/vendors </code> directory and will open a browser window to <code>public/index.jsp</code></p>
...
src/js/
              ...
              <pre><code class="lang-html">public/**/*.jsp
public/assets/css/
public/assets/js/
public/vendors
</code></pre>
