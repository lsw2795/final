            ...
            <div class="navbar-vertical-content scrollbar">
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                ...
                <li class="nav-item">
                  ...
                  <!-- parent pages--><a class="nav-link dropdown-indicator" href="#Layouts" role="button" data-bs-toggle="collapse" aria-expanded="true" aria-controls="Layouts">
                  ...
                  <ul class="nav collapse show" id="Layouts">
                    <li class="nav-item"><a class="nav-link active" href="../demo/navbar-vertical.jsp" target="_blank">
