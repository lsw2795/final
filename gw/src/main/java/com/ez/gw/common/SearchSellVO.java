...
public class SearchSellVO {
   ...
   /**
     ...
     * @param bean 검색조건
     */
    public void setSearchVO(SearchSellVO bean){
    	...
    	this.checkSelflag = bean.checkSelflag;
    }

    
    
    public boolean isCheckSelflag() {
	return checkSelflag;
}



public void setCheckSelflag(boolean checkSelflag) {
	this.checkSelflag = checkSelflag;
}
	...
	public String toString() {
		return "SearchSellVO [searchCondition=" + searchCondition + ", searchKeyword=" + searchKeyword + ", searchName="
				+ searchName + ", searchComment=" + searchComment + ", searchContent=" + searchContent
				+ ", checkSelflag=" + checkSelflag + ", searchUseYn=" + searchUseYn + ", currentPage=" + currentPage
