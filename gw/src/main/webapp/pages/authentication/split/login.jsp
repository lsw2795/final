                ...
                <div class="card">
                  ...
                  <div class="card-body p-4">
                    <div class="row flex-between-center">
                      ...
                      <div class="col-auto fs--1 text-600"><span class="mb-0 fw-semi-bold">New User?</span> <span><a href="../../../pages/authentication/split/register.jsp">Create account</a></span></div>
                    </div>
                    <form>
                      <div class="mb-3">
