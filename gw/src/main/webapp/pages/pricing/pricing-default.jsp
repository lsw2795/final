              ...
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                ...
                <li class="nav-item">
                  ...
                  <ul class="nav collapse show" id="pricing">
                    <li class="nav-item"><a class="nav-link active" href="../../pages/pricing/pricing-default.jsp">
        ...
        <div class="content">
          ...
          <div class="card overflow-hidden mb-3">
            ...
            <div class="card-body position-relative">
              ...
              <p>Get the power, control, and customization you need to manage your<br class="d-none d-md-block" /> team’s and organization’s projects.</p><a class="btn btn-link ps-0 btn-sm" href="#!"> Have questions? Chat with us</a>
            </div>
          </div>
          <div class="card mb-3">
            <div class="card-body">
                ...
                <div class="col-lg-4 border-top border-bottom">
                  <div class="h-100">
                    <div class="text-center p-4">
                      ...
                      </h2><a class="btn btn-outline-primary" href="../../app/e-commerce/billing.jsp">Start free trial</a>
                    </div>
                ...
                <div class="col-lg-4 border-top border-bottom dark__bg-1000 px-4 px-lg-0" style="background-color: rgba(115, 255, 236, 0.18);">
                  <div class="h-100">
                    <div class="text-center p-4">
                      ...
                      </h2><a class="btn btn-primary" href="../../app/e-commerce/billing.jsp">Get Business</a>
                    </div>
                    <hr class="border-bottom-0 m-0" />
                    <div class="text-start px-sm-4 py-4">
                ...
                <div class="col-lg-4 border-top border-bottom">
                  <div class="h-100">
                    <div class="text-center p-4">
                      ...
                      </h2><a class="btn btn-outline-primary" href="../../app/e-commerce/billing.jsp">Purchase</a>
                    </div>
                    <hr class="border-bottom-0 m-0" />
                    <div class="text-start px-sm-4 py-4">
