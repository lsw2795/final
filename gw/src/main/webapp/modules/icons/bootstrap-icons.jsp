              ...
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                ...
                <li class="nav-item">
                  ...
                  <ul class="nav collapse show" id="icons">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="../../modules/icons/bootstrap-icons.jsp">
              ...
              <div class="card">
                  ...
                  <div class="row flex-between-end">
                    ...
                    <div class="col-auto ms-auto">
                      <div class="nav nav-pills nav-pills-falcon flex-grow-1 mt-2" role="tablist">
                        <button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-8d35b544-9f60-4096-b545-218e5a713c5e" type="button" role="tab" aria-controls="dom-8d35b544-9f60-4096-b545-218e5a713c5e" aria-selected="true" id="tab-dom-8d35b544-9f60-4096-b545-218e5a713c5e">Preview</button>
                        <button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-5f9afdb2-2fd1-4207-aaf4-810d4c7099bf" type="button" role="tab" aria-controls="dom-5f9afdb2-2fd1-4207-aaf4-810d4c7099bf" aria-selected="false" id="tab-dom-5f9afdb2-2fd1-4207-aaf4-810d4c7099bf">Code</button>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="card-body bg-light">
                  <div class="tab-content">
                    <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-8d35b544-9f60-4096-b545-218e5a713c5e" id="dom-8d35b544-9f60-4096-b545-218e5a713c5e"><span class="bi-bell-fill text-danger fs-5"></span>
                    </div>
                    <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-5f9afdb2-2fd1-4207-aaf4-810d4c7099bf" id="dom-5f9afdb2-2fd1-4207-aaf4-810d4c7099bf">
              ...
              <div class="card">
                <div class="card-header">
                  <div class="row flex-between-end">
                    ...
                    <div class="col-auto ms-auto">
                      <div class="nav nav-pills nav-pills-falcon flex-grow-1 mt-2" role="tablist">
                        <button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-6a31d351-a934-4fe2-878c-681cb7336eeb" type="button" role="tab" aria-controls="dom-6a31d351-a934-4fe2-878c-681cb7336eeb" aria-selected="true" id="tab-dom-6a31d351-a934-4fe2-878c-681cb7336eeb">Preview</button>
                        <button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-754270a8-f206-4f4a-99a4-3fc4105a9974" type="button" role="tab" aria-controls="dom-754270a8-f206-4f4a-99a4-3fc4105a9974" aria-selected="false" id="tab-dom-754270a8-f206-4f4a-99a4-3fc4105a9974">Code</button>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="card-body bg-light">
                  <div class="tab-content">
                    <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-6a31d351-a934-4fe2-878c-681cb7336eeb" id="dom-6a31d351-a934-4fe2-878c-681cb7336eeb">
                      <div class="d-inline-block notification-indicator notification-indicator-danger ms-3"><span class="bi-bell-fill fs-5"></span></div>
                    </div>
                    <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-754270a8-f206-4f4a-99a4-3fc4105a9974" id="dom-754270a8-f206-4f4a-99a4-3fc4105a9974">
