                  ...
                  <ul class="nav collapse show" id="forms">
                    <li class="nav-item"><a class="nav-link dropdown-indicator" href="#basic" data-bs-toggle="collapse" aria-expanded="true" aria-controls="forms">
                      ...
                      <ul class="nav collapse show" id="basic">
                        ...
                        <li class="nav-item"><a class="nav-link active" href="../../../modules/forms/basic/select.jsp">
          ...
          <div class="card mb-3">
            ...
            <div class="card-body position-relative">
              <div class="row">
                <div class="col-lg-8">
                  <h3>Select</h3>
                  <p class="mb-0">Customize the native selects with custom CSS that changes the element’s initial appearance.</p><a class="btn btn-link btn-sm ps-0 mt-2" href="https://getbootstrap.com/docs/5.3/forms/select" target="_blank">Select on Bootstrap<span class="fas fa-chevron-right ms-1 fs--2"></span></a>
                </div>
              </div>
            </div>
          </div>
          <div class="card mb-3">
              ...
              <div class="row flex-between-end">
                ...
                <div class="col-auto ms-auto">
                  <div class="nav nav-pills nav-pills-falcon flex-grow-1 mt-2" role="tablist">
                    <button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-7b16cc37-95c0-4ad7-8924-f9b6e67327ec" type="button" role="tab" aria-controls="dom-7b16cc37-95c0-4ad7-8924-f9b6e67327ec" aria-selected="true" id="tab-dom-7b16cc37-95c0-4ad7-8924-f9b6e67327ec">Preview</button>
                    <button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-b8bf3d76-6afb-4f3d-ba4e-81789572d4d3" type="button" role="tab" aria-controls="dom-b8bf3d76-6afb-4f3d-ba4e-81789572d4d3" aria-selected="false" id="tab-dom-b8bf3d76-6afb-4f3d-ba4e-81789572d4d3">Code</button>
                  </div>
                </div>
              </div>
            </div>
            <div class="card-body bg-light">
              <div class="tab-content">
                <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-7b16cc37-95c0-4ad7-8924-f9b6e67327ec" id="dom-7b16cc37-95c0-4ad7-8924-f9b6e67327ec">
                ...
                <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-b8bf3d76-6afb-4f3d-ba4e-81789572d4d3" id="dom-b8bf3d76-6afb-4f3d-ba4e-81789572d4d3">
          ...
          <div class="card mb-3">
            <div class="card-header">
              <div class="row flex-between-end">
                ...
                <div class="col-auto ms-auto">
                  <div class="nav nav-pills nav-pills-falcon flex-grow-1 mt-2" role="tablist">
                    <button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-231d7560-5134-4fb0-bd57-027830045755" type="button" role="tab" aria-controls="dom-231d7560-5134-4fb0-bd57-027830045755" aria-selected="true" id="tab-dom-231d7560-5134-4fb0-bd57-027830045755">Preview</button>
                    <button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-65a19b2f-8c01-418d-bc65-b255c57b4af3" type="button" role="tab" aria-controls="dom-65a19b2f-8c01-418d-bc65-b255c57b4af3" aria-selected="false" id="tab-dom-65a19b2f-8c01-418d-bc65-b255c57b4af3">Code</button>
                  </div>
                </div>
              </div>
            </div>
            <div class="card-body bg-light">
              <div class="tab-content">
                <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-231d7560-5134-4fb0-bd57-027830045755" id="dom-231d7560-5134-4fb0-bd57-027830045755">
                ...
                <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-65a19b2f-8c01-418d-bc65-b255c57b4af3" id="dom-65a19b2f-8c01-418d-bc65-b255c57b4af3">
