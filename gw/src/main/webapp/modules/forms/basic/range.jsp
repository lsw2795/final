                  ...
                  <ul class="nav collapse show" id="forms">
                    <li class="nav-item"><a class="nav-link dropdown-indicator" href="#basic" data-bs-toggle="collapse" aria-expanded="true" aria-controls="forms">
                      ...
                      <ul class="nav collapse show" id="basic">
                        ...
                        <li class="nav-item"><a class="nav-link active" href="../../../modules/forms/basic/range.jsp">
          ...
          <div class="card mb-3">
            ...
            <div class="card-body position-relative">
              <div class="row">
                <div class="col-lg-8">
                  <h3>Range</h3>
                  <p class="mb-0">Use our custom range inputs for consistent cross-browser styling and built-in customization.</p><a class="btn btn-link btn-sm ps-0 mt-2" href="https://getbootstrap.com/docs/5.3/forms/range" target="_blank">Range on Bootstrap<span class="fas fa-chevron-right ms-1 fs--2"></span></a>
                </div>
              </div>
            </div>
          </div>
          <div class="card mb-3">
            <div class="card-header">
              <div class="row flex-between-end">
                <div class="col-auto align-self-center">
                  ...
                  <p class="mb-0 pt-1 mt-2 mb-0">Create custom <code>input type="range"</code> controls with <code>.form-range</code>. The track (the background) and thumb (the value) are both styled to appear the same across browsers. As only Firefox supports “filling” their track from the left or right of the thumb as a means to visually indicate progress, we do not currently support it.</p>
                </div>
                <div class="col-auto ms-auto">
                  <div class="nav nav-pills nav-pills-falcon flex-grow-1 mt-2" role="tablist">
                    <button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-6d57960a-56e0-40ec-ae7d-d32f256870ad" type="button" role="tab" aria-controls="dom-6d57960a-56e0-40ec-ae7d-d32f256870ad" aria-selected="true" id="tab-dom-6d57960a-56e0-40ec-ae7d-d32f256870ad">Preview</button>
                    <button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-1bdb9d12-9672-47a2-852e-174eac5284d4" type="button" role="tab" aria-controls="dom-1bdb9d12-9672-47a2-852e-174eac5284d4" aria-selected="false" id="tab-dom-1bdb9d12-9672-47a2-852e-174eac5284d4">Code</button>
                  </div>
                </div>
              </div>
            </div>
            <div class="card-body bg-light">
              <div class="tab-content">
                <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-6d57960a-56e0-40ec-ae7d-d32f256870ad" id="dom-6d57960a-56e0-40ec-ae7d-d32f256870ad">
                  <label class="form-label" for="customRange1">Example range</label>
                  <input class="form-range" id="customRange1" type="range" />
                </div>
                <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-1bdb9d12-9672-47a2-852e-174eac5284d4" id="dom-1bdb9d12-9672-47a2-852e-174eac5284d4">
...
&lt;input class=&quot;form-range&quot; id=&quot;customRange1&quot; type=&quot;range&quot; /&gt;</code></pre>
          ...
          <div class="card mb-3">
            <div class="card-header">
              <div class="row flex-between-end">
                <div class="col-auto align-self-center">
                  ...
                  <p class="mb-0 pt-1 mt-2 mb-0">Range inputs have implicit values for <code>min</code> and <code>max</code>—<code>0</code> and <code>100</code>, respectively. You may specify new values for those using the <code>min</code> and <code>max</code> attributes.</p>
                </div>
                <div class="col-auto ms-auto">
                  <div class="nav nav-pills nav-pills-falcon flex-grow-1 mt-2" role="tablist">
                    <button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-eae0d7bf-9b3a-44e8-9668-91e13d60c163" type="button" role="tab" aria-controls="dom-eae0d7bf-9b3a-44e8-9668-91e13d60c163" aria-selected="true" id="tab-dom-eae0d7bf-9b3a-44e8-9668-91e13d60c163">Preview</button>
                    <button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-cf99e378-3f19-497a-98ee-14c44fd07a52" type="button" role="tab" aria-controls="dom-cf99e378-3f19-497a-98ee-14c44fd07a52" aria-selected="false" id="tab-dom-cf99e378-3f19-497a-98ee-14c44fd07a52">Code</button>
                  </div>
                </div>
              </div>
            </div>
            <div class="card-body bg-light">
              <div class="tab-content">
                <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-eae0d7bf-9b3a-44e8-9668-91e13d60c163" id="dom-eae0d7bf-9b3a-44e8-9668-91e13d60c163">
                  <label class="form-label" for="customRange2">Example range</label>
                  <input class="form-range" id="customRange2" type="range" min="0" max="5" />
                </div>
                <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-cf99e378-3f19-497a-98ee-14c44fd07a52" id="dom-cf99e378-3f19-497a-98ee-14c44fd07a52">
...
&lt;input class=&quot;form-range&quot; id=&quot;customRange2&quot; type=&quot;range&quot; min=&quot;0&quot; max=&quot;5&quot; /&gt;</code></pre>
          ...
          <div class="card mb-3">
            <div class="card-header">
              <div class="row flex-between-end">
                <div class="col-auto align-self-center">
                  ...
                  <p class="mb-0 pt-1 mt-2 mb-0">By default, range inputs “snap” to integer values. To change this, you can specify a <code>step</code> value. In the example below, we double the number of steps by using <code>step="0.5"</code>.</p>
                </div>
                <div class="col-auto ms-auto">
                  <div class="nav nav-pills nav-pills-falcon flex-grow-1 mt-2" role="tablist">
                    <button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-a53cc919-dc47-40e5-ba35-83cd0039914b" type="button" role="tab" aria-controls="dom-a53cc919-dc47-40e5-ba35-83cd0039914b" aria-selected="true" id="tab-dom-a53cc919-dc47-40e5-ba35-83cd0039914b">Preview</button>
                    <button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-5e2b21e4-e7c9-4e6a-9e52-842f7c374193" type="button" role="tab" aria-controls="dom-5e2b21e4-e7c9-4e6a-9e52-842f7c374193" aria-selected="false" id="tab-dom-5e2b21e4-e7c9-4e6a-9e52-842f7c374193">Code</button>
                  </div>
                </div>
              </div>
            </div>
            <div class="card-body bg-light">
              <div class="tab-content">
                <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-a53cc919-dc47-40e5-ba35-83cd0039914b" id="dom-a53cc919-dc47-40e5-ba35-83cd0039914b">
                ...
                <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-5e2b21e4-e7c9-4e6a-9e52-842f7c374193" id="dom-5e2b21e4-e7c9-4e6a-9e52-842f7c374193">
