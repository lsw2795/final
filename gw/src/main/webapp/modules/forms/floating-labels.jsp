              ...
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                ...
                <li class="nav-item">
                  ...
                  <ul class="nav collapse show" id="forms">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="../../modules/forms/floating-labels.jsp">
            ...
            <div class="card-body position-relative">
              <div class="row">
                <div class="col-lg-8">
                  ...
                  <p class="mb-0">Create beautifully simple form labels that float over your input fields.</p><a class="btn btn-link btn-sm ps-0 mt-2" href="https://getbootstrap.com/docs/5.3/forms/floating-labels" target="_blank">Floating labels on Bootstrap<span class="fas fa-chevron-right ms-1 fs--2"></span></a>
                </div>
              </div>
            </div>
          </div>
          <div class="card mb-3">
              ...
              <div class="row flex-between-end">
                ...
                <div class="col-auto ms-auto">
                  <div class="nav nav-pills nav-pills-falcon flex-grow-1" role="tablist">
                    <button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-ea4d5a59-a225-471f-8877-8ca481209991" type="button" role="tab" aria-controls="dom-ea4d5a59-a225-471f-8877-8ca481209991" aria-selected="true" id="tab-dom-ea4d5a59-a225-471f-8877-8ca481209991">Preview</button>
                    <button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-fff28ae4-1c77-42aa-88b8-39099e3ef271" type="button" role="tab" aria-controls="dom-fff28ae4-1c77-42aa-88b8-39099e3ef271" aria-selected="false" id="tab-dom-fff28ae4-1c77-42aa-88b8-39099e3ef271">Code</button>
                  </div>
                </div>
              </div>
            </div>
            <div class="card-body bg-light">
              <div class="tab-content">
                <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-ea4d5a59-a225-471f-8877-8ca481209991" id="dom-ea4d5a59-a225-471f-8877-8ca481209991">
                ...
                <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-fff28ae4-1c77-42aa-88b8-39099e3ef271" id="dom-fff28ae4-1c77-42aa-88b8-39099e3ef271">
          ...
          <div class="card mb-3">
            <div class="card-header">
              <div class="row flex-between-end">
                ...
                <div class="col-auto ms-auto">
                  <div class="nav nav-pills nav-pills-falcon flex-grow-1" role="tablist">
                    <button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-0bb23151-8a6a-4c59-96f4-a27fee46b60a" type="button" role="tab" aria-controls="dom-0bb23151-8a6a-4c59-96f4-a27fee46b60a" aria-selected="true" id="tab-dom-0bb23151-8a6a-4c59-96f4-a27fee46b60a">Preview</button>
                    <button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-8efffbae-4aa7-47e8-a134-3cba8e069ee1" type="button" role="tab" aria-controls="dom-8efffbae-4aa7-47e8-a134-3cba8e069ee1" aria-selected="false" id="tab-dom-8efffbae-4aa7-47e8-a134-3cba8e069ee1">Code</button>
                  </div>
                </div>
              </div>
            </div>
            <div class="card-body bg-light">
              <div class="tab-content">
                <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-0bb23151-8a6a-4c59-96f4-a27fee46b60a" id="dom-0bb23151-8a6a-4c59-96f4-a27fee46b60a">
                  <div class="form-floating mb-3">
                ...
                <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-8efffbae-4aa7-47e8-a134-3cba8e069ee1" id="dom-8efffbae-4aa7-47e8-a134-3cba8e069ee1">
                  <pre class="scrollbar rounded-1" style="max-height:420px"><code class="language-html">&lt;div class=&quot;form-floating mb-3&quot;&gt;
  &lt;input class=&quot;form-control is-valid&quot; id=&quot;floatingInputValid&quot; type=&quot;email&quot; placeholder=&quot;name@example.com&quot; value=&quot;test@example.com&quot; /&gt;
  &lt;label for=&quot;floatingInputValid&quot;&gt;Valid input&lt;/label&gt;
&lt;/div&gt;
          ...
          <div class="card mb-3">
            <div class="card-header">
              <div class="row flex-between-end">
                ...
                <div class="col-auto ms-auto">
                  <div class="nav nav-pills nav-pills-falcon flex-grow-1" role="tablist">
                    <button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-ca0ddf38-e9be-47a2-aba4-cc52da3b827a" type="button" role="tab" aria-controls="dom-ca0ddf38-e9be-47a2-aba4-cc52da3b827a" aria-selected="true" id="tab-dom-ca0ddf38-e9be-47a2-aba4-cc52da3b827a">Preview</button>
                    <button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-8824c984-30b3-425a-8876-6bba7a1048b6" type="button" role="tab" aria-controls="dom-8824c984-30b3-425a-8876-6bba7a1048b6" aria-selected="false" id="tab-dom-8824c984-30b3-425a-8876-6bba7a1048b6">Code</button>
                  </div>
                </div>
              </div>
            </div>
            <div class="card-body bg-light">
              <div class="tab-content">
                <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-ca0ddf38-e9be-47a2-aba4-cc52da3b827a" id="dom-ca0ddf38-e9be-47a2-aba4-cc52da3b827a">
                  <div class="form-floating">
                    <textarea class="form-control" id="floatingTextarea2" placeholder="Leave a comment here" style="height: 100px"></textarea>
                    <label for="floatingTextarea2">Comments</label>
                  </div>
                </div>
                <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-8824c984-30b3-425a-8876-6bba7a1048b6" id="dom-8824c984-30b3-425a-8876-6bba7a1048b6">
          ...
          <div class="card mb-3">
            <div class="card-header">
              <div class="row flex-between-end">
                ...
                <div class="col-auto ms-auto">
                  <div class="nav nav-pills nav-pills-falcon flex-grow-1" role="tablist">
                    <button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-aa8b07b9-2d62-408d-899c-fbdddf252554" type="button" role="tab" aria-controls="dom-aa8b07b9-2d62-408d-899c-fbdddf252554" aria-selected="true" id="tab-dom-aa8b07b9-2d62-408d-899c-fbdddf252554">Preview</button>
                    <button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-72f488c7-e2ee-4619-9a18-aeb38db7ae9d" type="button" role="tab" aria-controls="dom-72f488c7-e2ee-4619-9a18-aeb38db7ae9d" aria-selected="false" id="tab-dom-72f488c7-e2ee-4619-9a18-aeb38db7ae9d">Code</button>
                  </div>
                </div>
              </div>
            </div>
            <div class="card-body bg-light">
              <div class="tab-content">
                <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-aa8b07b9-2d62-408d-899c-fbdddf252554" id="dom-aa8b07b9-2d62-408d-899c-fbdddf252554">
                  <div class="form-floating">
                ...
                <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-72f488c7-e2ee-4619-9a18-aeb38db7ae9d" id="dom-72f488c7-e2ee-4619-9a18-aeb38db7ae9d">
                  <pre class="scrollbar rounded-1" style="max-height:420px"><code class="language-html">&lt;div class=&quot;form-floating&quot;&gt;
  &lt;select class=&quot;form-select&quot; id=&quot;floatingSelect&quot; aria-label=&quot;Floating label select example&quot;&gt;
    &lt;option selected=&quot;&quot;&gt;Open this select menu&lt;/option&gt;
    &lt;option value=&quot;1&quot;&gt;One&lt;/option&gt;
