                  ...
                  <ul class="nav collapse show" id="components">
                    ...
                    <li class="nav-item"><a class="nav-link dropdown-indicator" href="#videos" data-bs-toggle="collapse" aria-expanded="true" aria-controls="components">
                      ...
                      <ul class="nav collapse show" id="videos">
                        ...
                        <li class="nav-item"><a class="nav-link active" href="../../../modules/components/videos/plyr.jsp">
              ...
              <div class="card mb-3">
                  ...
                  <div class="row flex-between-end">
                    ...
                    <div class="col-auto ms-auto">
                      <div class="nav nav-pills nav-pills-falcon flex-grow-1" role="tablist">
                        <button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-a59953f5-71de-4d0e-b6d3-5bef2e2fb480" type="button" role="tab" aria-controls="dom-a59953f5-71de-4d0e-b6d3-5bef2e2fb480" aria-selected="true" id="tab-dom-a59953f5-71de-4d0e-b6d3-5bef2e2fb480">Preview</button>
                        <button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-ac0c2104-6dac-46b4-816e-73225d6875c5" type="button" role="tab" aria-controls="dom-ac0c2104-6dac-46b4-816e-73225d6875c5" aria-selected="false" id="tab-dom-ac0c2104-6dac-46b4-816e-73225d6875c5">Code</button>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="card-body bg-light">
                  <div class="tab-content">
                    <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-a59953f5-71de-4d0e-b6d3-5bef2e2fb480" id="dom-a59953f5-71de-4d0e-b6d3-5bef2e2fb480">
                      <div class="player rounded-3" data-plyr-provider="youtube" data-plyr-embed-id="bTqVqk7FSmY"> </div>
                    </div>
                    <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-ac0c2104-6dac-46b4-816e-73225d6875c5" id="dom-ac0c2104-6dac-46b4-816e-73225d6875c5">
              ...
              <div class="card mb-3">
                <div class="card-header">
                  <div class="row flex-between-end">
                    ...
                    <div class="col-auto ms-auto">
                      <div class="nav nav-pills nav-pills-falcon flex-grow-1" role="tablist">
                        <button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-6571d94a-abbc-444c-91cf-2c3844fcca5f" type="button" role="tab" aria-controls="dom-6571d94a-abbc-444c-91cf-2c3844fcca5f" aria-selected="true" id="tab-dom-6571d94a-abbc-444c-91cf-2c3844fcca5f">Preview</button>
                        <button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-d69f81b7-e09b-478c-b82f-5ed8e8fab4f7" type="button" role="tab" aria-controls="dom-d69f81b7-e09b-478c-b82f-5ed8e8fab4f7" aria-selected="false" id="tab-dom-d69f81b7-e09b-478c-b82f-5ed8e8fab4f7">Code</button>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="card-body bg-light">
                  <div class="tab-content">
                    <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-6571d94a-abbc-444c-91cf-2c3844fcca5f" id="dom-6571d94a-abbc-444c-91cf-2c3844fcca5f">
                      <div class="player rounded-3" data-plyr-provider="vimeo" data-plyr-embed-id="76979871"></div>
                    </div>
                    <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-d69f81b7-e09b-478c-b82f-5ed8e8fab4f7" id="dom-d69f81b7-e09b-478c-b82f-5ed8e8fab4f7">
