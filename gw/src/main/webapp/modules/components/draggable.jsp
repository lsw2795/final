              ...
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                ...
                <li class="nav-item">
                  ...
                  <ul class="nav collapse show" id="components">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="../../modules/components/draggable.jsp">
          ...
          <div class="card mb-3">
            <div class="card-header">
              <div class="row flex-between-end">
                <div class="col-auto align-self-center">
                  ...
                  <p class="mb-0 pt-1 mt-2 mb-0">Here is the example of the Multiple Container Sortable feature of the Draggable library. We also design <a href="../../app/kanban.jsp">Kanban Board </a>using this Draggable Library. <strong>You can drag any card in between the two columns below:</strong></p>
                </div>
                <div class="col-auto ms-auto">
                  <div class="nav nav-pills nav-pills-falcon flex-grow-1 mt-2" role="tablist">
                    <button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-9a986449-dfc1-4e31-8a30-713e547e3dc9" type="button" role="tab" aria-controls="dom-9a986449-dfc1-4e31-8a30-713e547e3dc9" aria-selected="true" id="tab-dom-9a986449-dfc1-4e31-8a30-713e547e3dc9">Preview</button>
                    <button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-18c57e02-96c8-4595-a4c7-3c5891a02f1e" type="button" role="tab" aria-controls="dom-18c57e02-96c8-4595-a4c7-3c5891a02f1e" aria-selected="false" id="tab-dom-18c57e02-96c8-4595-a4c7-3c5891a02f1e">Code</button>
                  </div>
                </div>
              </div>
            </div>
            <div class="card-body bg-light">
              <div class="tab-content">
                <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-9a986449-dfc1-4e31-8a30-713e547e3dc9" id="dom-9a986449-dfc1-4e31-8a30-713e547e3dc9">
                  <div class="row">
                    <div class="col-lg-6">
                ...
                <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-18c57e02-96c8-4595-a4c7-3c5891a02f1e" id="dom-18c57e02-96c8-4595-a4c7-3c5891a02f1e">
