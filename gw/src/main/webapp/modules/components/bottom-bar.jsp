              ...
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                ...
                <li class="nav-item">
                  ...
                  <ul class="nav collapse show" id="components">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="../../modules/components/bottom-bar.jsp">
        ...
        <div class="content">
          ...
          <div class="card mb-3">
            ...
            <div class="card-body bg-light">
              <div class="mb-3">
                <h5>Basic</h5>
                <p class="mb-0 mt-2"><code>.bottom-bar </code>class is responsible for showing the bar in the bottom of the viewport. You can control the breakpoint of visibility by simply using <a href="../../modules/utilities/display.jsp">display utilities </a>classes.</p>
...
&lt;/div&gt;</code></pre>
        ...
        <div class="card rounded-0 bottom-bar d-lg-none" data-bottom-bar='{"target":"bottom-bar-target-example-btn","breakPoint":"lg","offsetTop":60}'>
          <div class="card-body py-2 px-0">
            <div class="container">
              <div class="row flex-between-center g-0">
                <div class="col-auto">
                  <h6 class="fs-0 mb-0 text-secondary">Bottom Bar</h6>
                </div>
                <div class="col-auto">
                  <button class="btn btn-primary btn-md px-5 fw-medium" type="button">Button</button>
                </div>
              </div>
            </div>
          </div>
