                  ...
                  <ul class="nav collapse show" id="components">
                    ...
                    <li class="nav-item"><a class="nav-link dropdown-indicator" href="#navs-_and_-Tabs" data-bs-toggle="collapse" aria-expanded="true" aria-controls="components">
                      ...
                      <ul class="nav collapse show" id="navs-_and_-Tabs">
                        ...
                        <li class="nav-item"><a class="nav-link active" href="../../../modules/components/navs-and-tabs/double-top-navbar.jsp">
                            <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Double top</span><span class="badge rounded-pill ms-2 badge-subtle-success">New</span>
                            </div>
                          </a>
                          <!-- more inner pages-->
        ...
        <div class="content">
          ...
          <div class="card mb-3">
            ...
            <div class="card-body position-relative">
              <div class="row">
                <div class="col-lg-8">
                  <h3>Navbar Double Top</h3>
                  <p class="mb-0">Navbar Double Top is a different user friendly layout system in Falcon.</p><a class="btn btn-link btn-sm ps-0 mt-2" href="../../../demo/navbar-double-top.jsp" target="_blank">Navbar double top example page<span class="fas fa-chevron-right ms-1 fs--2"></span></a>
                </div>
              </div>
            </div>
          </div>
          <div class="card mb-3">
            ...
            <div class="card-body bg-light">
              <p class="mb-0">Falcon Navbar Double Top support all of <a href="https://getbootstrap.com/docs/5.3/components/navbar/">Boostrap Navbar </a>components. <code>.navbar-brand</code>, <code>.navbar-nav</code>, <code>.navbar-toggler</code>, <code>.form-inline</code>, <code>.navbar-text</code>, <code>.collapse.navbar-collapse </code>those sub-componets are used in Navbar Double Top.</p>
            </div>
          </div>
          <div class="card mb-3">
            <div class="card-header">
            ...
            <div class="card-body bg-light">
              <pre class="scrollbar mt-2"><code class="language-html">&lt;nav class=&quot;navbar navbar-light navbar-glass navbar-top&quot;&gt;
  &lt;div&gt;

    &lt;!-- Navbar Content--&gt;
  &lt;/div&gt;
  &lt;hr class=&quot;my-2 d-none d-lg-block&quot; /&gt;
  &lt;div class=&quot;collapse navbar-collapse&quot; id=&quot;triggerID&quot;&gt;
...
&lt;/nav&gt;</code></pre>
          ...
          <div class="card mb-3">
            <div class="card-header">
              ...
              <p class="mt-2 mb-0">Falcon Navbar Double Top use Bootstrap Navbar responsive behaviors.</p>
            </div>
            <div class="card-body bg-light">
              <p>Navbar Double Top can utilize <code>.navbar-toggler</code>, <code>.navbar-collapse</code>, and <code>.navbar-expand{-sm|-md|-lg|-xl} </code>classes to change when their content collapses behind a button. In combination with other utilities, you can easily choose when to show or hide particular elements.</p>
              <p class="mb-0">For navbars that never collapse, add the <code>.navbar-expand </code>class on the navbar. For navbars that always collapse, don’t add any <code>.navbar-expand </code>class.</p>
            </div>
          </div>
          <div class="card mb-3">
            <div class="card-header">
            ...
            <div class="card-body bg-light">
              <p class="mb-0">Changing the color of Navbar Double Top is very easy. Falcon uses <code>.navbar-light </code>for styling Navbar Double Top. You can use other Bootstrap utilitie classes to update the Navbar. Learn more about Bootstrap Navbar <a href="https://getbootstrap.com/docs/5.3/components/navbar/#color-schemes" target="_blank">Color Schemes.</a></p>
            </div>
          </div>
          <div class="card mb-3">
            <div class="bg-holder d-none d-lg-block bg-card" style="background-image:url(../../../assets/img/icons/spot-illustrations/corner-4.png);">
            ...
            <div class="card-body position-relative">
              <div class="row">
                <div class="col-lg-8">
                  ...
                  <p class="mb-0">Falcon's special Navbar for landing, where background color will be changed gradually transparent to darken on scroll.</p><a class="btn btn-link btn-sm ps-0 mt-2" href="../../../pages/landing.jsp" target="_blank">See the implementation here<span class="fas fa-chevron-right ms-1 fs--2"></span></a>
                </div>
              </div>
            </div>
          </div>
