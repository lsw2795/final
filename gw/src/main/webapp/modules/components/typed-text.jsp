      ...
      <div class="container" data-layout="container">
              ...
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                ...
                <li class="nav-item">
                  ...
                  <ul class="nav collapse show" id="components">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="../../modules/components/typed-text.jsp">
        ...
        <div class="content">
          ...
          <div class="card mb-3">
            ...
            <div class="card-body position-relative">
              <div class="row">
                <div class="col-lg-8">
                  <h3>Typed Text</h3>
                  <p class="mt-2">A JavaScript library that types out, deletes them, and then types again.</p><a class="btn btn-link ps-0 btn-sm" href="https://mattboldt.com/demos/typed-js/" target="_blank"> Typed.js Documentation<span class="fas fa-chevron-right ms-1 fs--2"></span></a>
                </div>
              </div>
            </div>
          </div>
          <div class="card mb-3">
              ...
              <div class="row flex-between-end">
                ...
                <div class="col-auto ms-auto">
                  <div class="nav nav-pills nav-pills-falcon flex-grow-1" role="tablist">
                    <button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-1893d002-36ff-46a9-93fb-b5072d4d751a" type="button" role="tab" aria-controls="dom-1893d002-36ff-46a9-93fb-b5072d4d751a" aria-selected="true" id="tab-dom-1893d002-36ff-46a9-93fb-b5072d4d751a">Preview</button>
                    <button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-39080a20-12df-48d4-9618-33477a5e89e2" type="button" role="tab" aria-controls="dom-39080a20-12df-48d4-9618-33477a5e89e2" aria-selected="false" id="tab-dom-39080a20-12df-48d4-9618-33477a5e89e2">Code</button>
                  </div>
                </div>
              </div>
            </div>
            <div class="card-body bg-light">
              <div class="tab-content">
                <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-1893d002-36ff-46a9-93fb-b5072d4d751a" id="dom-1893d002-36ff-46a9-93fb-b5072d4d751a">
                ...
                <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-39080a20-12df-48d4-9618-33477a5e89e2" id="dom-39080a20-12df-48d4-9618-33477a5e89e2">
                  <pre class="scrollbar rounded-1" style="max-height:420px"><code class="language-html">&lt;h3 class=&quot;fw-light overflow-hidden&quot;&gt;A smarter way to tell about &lt;span class=&quot;typed-text fw-bold ms-1&quot; data-typed-text='[&quot;new features.&quot;,&quot;product updates.&quot;,&quot;a new idea.&quot;,&quot;an announcment.&quot;]'&gt;&lt;/span&gt;&lt;/h3&gt;</code></pre>
                </div>
              </div>
            </div>
          </div>
          <div class="card mb-3">
            ...
            <div class="card-body bg-light">
              <pre class="scrollbar mt-2"><code class="language-html">&lt;script src=&quot;vendors/typed.js/typed.js&quot;&gt;&lt;/script&gt;</code></pre>
            </div>
          </div>
          <footer class="footer">
