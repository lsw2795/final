      ...
      <div class="container" data-layout="container">
                  ...
                  <ul class="nav collapse show" id="components">
                    ...
                    <li class="nav-item"><a class="nav-link dropdown-indicator" href="#pictures" data-bs-toggle="collapse" aria-expanded="true" aria-controls="components">
                      ...
                      <ul class="nav collapse show" id="pictures">
                        ...
                        <li class="nav-item"><a class="nav-link active" href="../../../modules/components/pictures/images.jsp">
        ...
        <div class="content">
          ...
          <div class="card mb-3">
            ...
            <div class="card-body position-relative">
              <div class="row">
                <div class="col-lg-8">
                  <h3>Images</h3>
                  <p class="mb-0">Documentation and examples for opting images into responsive behavior (so they never become larger than their parent elements) and add lightweight styles to them—all via classes.</p><a class="btn btn-link btn-sm ps-0 mt-2" href="https://getbootstrap.com/docs/5.3/content/images/" target="_blank">Images on Bootstrap<span class="fas fa-chevron-right ms-1 fs--2"></span></a>
                </div>
              </div>
            </div>
          </div>
          <div class="card mb-3">
              ...
              <div class="row flex-between-end">
                ...
                <div class="col-auto ms-auto">
                  <div class="nav nav-pills nav-pills-falcon flex-grow-1 mt-2" role="tablist">
                    <button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-c66c0adf-0b33-4dfd-a614-f8e89885f76e" type="button" role="tab" aria-controls="dom-c66c0adf-0b33-4dfd-a614-f8e89885f76e" aria-selected="true" id="tab-dom-c66c0adf-0b33-4dfd-a614-f8e89885f76e">Preview</button>
                    <button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-858ab245-00fb-42cf-94f2-437d179121c2" type="button" role="tab" aria-controls="dom-858ab245-00fb-42cf-94f2-437d179121c2" aria-selected="false" id="tab-dom-858ab245-00fb-42cf-94f2-437d179121c2">Code</button>
                  </div>
                </div>
              </div>
            </div>
            <div class="card-body bg-light overflow-hidden">
              <div class="tab-content">
                <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-c66c0adf-0b33-4dfd-a614-f8e89885f76e" id="dom-c66c0adf-0b33-4dfd-a614-f8e89885f76e"><img class="img-fluid rounded" src="../../../assets/img/generic/9.jpg" alt="" />
                </div>
                <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-858ab245-00fb-42cf-94f2-437d179121c2" id="dom-858ab245-00fb-42cf-94f2-437d179121c2">
                  <pre class="scrollbar rounded-1" style="max-height:420px"><code class="language-html">&lt;img class=&quot;img-fluid rounded&quot; src=&quot;../../../assets/img/generic/9.jpg&quot; alt=&quot;&quot; /&gt;</code></pre>
                </div>
              </div>
            </div>
          </div>
          <div class="card mb-3">
            <div class="card-header">
              <div class="row flex-between-end">
                <div class="col-auto align-self-center">
                  ...
                  <p class="mb-0 pt-1 mt-2 mb-0">In addition to our <a href="https://getbootstrap.com/docs/5.3/utilities/borders/">border-radius utilities</a>, you can use <code>.img-thumbnail</code> to give an image a rounded 1px border appearance.</p>
                </div>
                <div class="col-auto ms-auto">
                  <div class="nav nav-pills nav-pills-falcon flex-grow-1 mt-2" role="tablist">
                    <button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-9f1c0835-e51f-429d-b488-976334ec70f5" type="button" role="tab" aria-controls="dom-9f1c0835-e51f-429d-b488-976334ec70f5" aria-selected="true" id="tab-dom-9f1c0835-e51f-429d-b488-976334ec70f5">Preview</button>
                    <button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-d31773e7-602e-4479-8f51-8908bfa52232" type="button" role="tab" aria-controls="dom-d31773e7-602e-4479-8f51-8908bfa52232" aria-selected="false" id="tab-dom-d31773e7-602e-4479-8f51-8908bfa52232">Code</button>
                  </div>
                </div>
              </div>
            </div>
            <div class="card-body bg-light overflow-hidden">
              <div class="tab-content">
                <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-9f1c0835-e51f-429d-b488-976334ec70f5" id="dom-9f1c0835-e51f-429d-b488-976334ec70f5"><img class="img-thumbnail" src="../../../assets/img/team/6.jpg" alt="" />
                </div>
                <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-d31773e7-602e-4479-8f51-8908bfa52232" id="dom-d31773e7-602e-4479-8f51-8908bfa52232">
                  <pre class="scrollbar rounded-1" style="max-height:420px"><code class="language-html">&lt;img class=&quot;img-thumbnail&quot; src=&quot;../../../assets/img/team/6.jpg&quot; alt=&quot;&quot; /&gt;</code></pre>
                </div>
              </div>
            </div>
          </div>
          <div class="card mb-3">
              ...
              <div class="row flex-between-end">
                <div class="col-auto align-self-center">
                  ...
                  <p class="mb-0 pt-1 mt-2 mb-0">Align images with the
                    <a href="https://getbootstrap.com/docs/5.3/utilities/float/">
                      helper float classes </a> or <a href="https://getbootstrap.com/docs/5.3/utilities/text/#text-alignment/">text alignment classes</a>. <code>block</code>-level images can be centered using <a href="https://getbootstrap.com/docs/5.3/utilities/spacing/#horizontal-centering/">the <code>.mx-auto</code> margin utility class</a>.
                  </p>
                </div>
                <div class="col-auto ms-auto">
                  <div class="nav nav-pills nav-pills-falcon flex-grow-1 mt-2" role="tablist">
                    <button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-681ccd95-6323-4304-aaf2-334634641d4e" type="button" role="tab" aria-controls="dom-681ccd95-6323-4304-aaf2-334634641d4e" aria-selected="true" id="tab-dom-681ccd95-6323-4304-aaf2-334634641d4e">Preview</button>
                    <button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-914235a5-e1b9-4e2c-aaed-698f8120be5c" type="button" role="tab" aria-controls="dom-914235a5-e1b9-4e2c-aaed-698f8120be5c" aria-selected="false" id="tab-dom-914235a5-e1b9-4e2c-aaed-698f8120be5c">Code</button>
                  </div>
                </div>
              </div>
            </div>
            <div class="card-body bg-light overflow-hidden">
              <div class="tab-content">
                <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-681ccd95-6323-4304-aaf2-334634641d4e" id="dom-681ccd95-6323-4304-aaf2-334634641d4e"><img class="rounded-1 float-start w-25 mt-3" src="../../../assets/img/team/24.jpg" alt="" />
                  <img class="rounded-1 float-end w-25 mt-3" src="../../../assets/img/team/25.jpg" alt="" />
                </div>
                <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-914235a5-e1b9-4e2c-aaed-698f8120be5c" id="dom-914235a5-e1b9-4e2c-aaed-698f8120be5c">
                  <pre class="scrollbar rounded-1" style="max-height:420px"><code class="language-html">&lt;img class=&quot;rounded-1 float-start w-25 mt-3&quot; src=&quot;../../../assets/img/team/24.jpg&quot; alt=&quot;&quot; /&gt;
&lt;img class=&quot;rounded-1 float-end w-25 mt-3&quot; src=&quot;../../../assets/img/team/25.jpg&quot; alt=&quot;&quot; /&gt;</code></pre>
                </div>
              </div>
            </div>
          </div>
