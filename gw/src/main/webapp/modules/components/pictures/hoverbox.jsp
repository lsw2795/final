                  ...
                  <ul class="nav collapse show" id="components">
                    ...
                    <li class="nav-item"><a class="nav-link dropdown-indicator" href="#pictures" data-bs-toggle="collapse" aria-expanded="true" aria-controls="components">
                      ...
                      <ul class="nav collapse show" id="pictures">
                        ...
                        <li class="nav-item"><a class="nav-link active" href="../../../modules/components/pictures/hoverbox.jsp">
          ...
          <div class="card mb-3">
            ...
            <div class="card-body position-relative">
              <div class="row">
                <div class="col-lg-8">
                  <h3>Hoverbox</h3>
                  <p class="mb-0">Style your card with a different design using theme Hoverbox</p>
                </div>
              </div>
            </div>
          </div>
              ...
              <div class="card mb-3">
                  ...
                  <div class="row flex-between-end">
                    ...
                    <div class="col-auto ms-auto">
                      <div class="nav nav-pills nav-pills-falcon flex-grow-1" role="tablist">
                        <button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-9bc14951-99ae-4896-a2a9-421c339d6b42" type="button" role="tab" aria-controls="dom-9bc14951-99ae-4896-a2a9-421c339d6b42" aria-selected="true" id="tab-dom-9bc14951-99ae-4896-a2a9-421c339d6b42">Preview</button>
                        <button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-6c328e56-c86b-4826-ac35-f5c71b565fae" type="button" role="tab" aria-controls="dom-6c328e56-c86b-4826-ac35-f5c71b565fae" aria-selected="false" id="tab-dom-6c328e56-c86b-4826-ac35-f5c71b565fae">Code</button>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="card-body bg-light overflow-hidden">
                  <div class="tab-content">
                    <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-9bc14951-99ae-4896-a2a9-421c339d6b42" id="dom-9bc14951-99ae-4896-a2a9-421c339d6b42">
                    ...
                    <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-6c328e56-c86b-4826-ac35-f5c71b565fae" id="dom-6c328e56-c86b-4826-ac35-f5c71b565fae">
                      <pre class="scrollbar rounded-1" style="max-height:420px"><code class="language-html">&lt;div class=&quot;hoverbox rounded-3 text-center&quot;&gt;
  &lt;img class=&quot;img-fluid&quot; src=&quot;../../../assets/img/generic/3.jpg&quot; alt=&quot;&quot; /&gt;
  &lt;div class=&quot;hoverbox-content bg-dark p-5 flex-center&quot; data-bs-theme=&quot;light&quot;&gt;
    &lt;div&gt;
      &lt;p class=&quot;lead text-white&quot;&gt;Style your card with different design using theme Hoverbox&lt;/p&gt;
            ...
            <div class="col-lg-6 pe-lg-2">
              <div class="card mb-3">
                <div class="card-header">
                  <div class="row flex-between-end">
                    <div class="col-auto align-self-center">
                      <h5 class="mb-0" data-anchor="data-anchor">Change Image</h5>
                    </div>
                    <div class="col-auto ms-auto">
                      <div class="nav nav-pills nav-pills-falcon flex-grow-1" role="tablist">
                        <button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-e315d821-76e0-4f8c-bf98-d04b8ad2a879" type="button" role="tab" aria-controls="dom-e315d821-76e0-4f8c-bf98-d04b8ad2a879" aria-selected="true" id="tab-dom-e315d821-76e0-4f8c-bf98-d04b8ad2a879">Preview</button>
                        <button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-d067f754-962d-4b5e-9f83-12b93004f27a" type="button" role="tab" aria-controls="dom-d067f754-962d-4b5e-9f83-12b93004f27a" aria-selected="false" id="tab-dom-d067f754-962d-4b5e-9f83-12b93004f27a">Code</button>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="card-body bg-light overflow-hidden">
                  <div class="tab-content">
                    <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-e315d821-76e0-4f8c-bf98-d04b8ad2a879" id="dom-e315d821-76e0-4f8c-bf98-d04b8ad2a879"><a class="color-white" href="#!">
                    ...
                    <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-d067f754-962d-4b5e-9f83-12b93004f27a" id="dom-d067f754-962d-4b5e-9f83-12b93004f27a">
                      <pre class="scrollbar rounded-1" style="max-height:420px"><code class="language-html">&lt;a class=&quot;color-white&quot; href=&quot;#!&quot;&gt;
  &lt;div class=&quot;hoverbox rounded-3&quot;&gt;
    &lt;img class=&quot;img-fluid&quot; src=&quot;../../../assets/img/generic/1.jpg&quot; alt=&quot;&quot; /&gt;
    &lt;div class=&quot;hoverbox-content&quot;&gt;
      &lt;img class=&quot;img-fluid&quot; src=&quot;../../../assets/img/generic/2.jpg&quot; alt=&quot;&quot; /&gt;
