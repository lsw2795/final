              ...
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                ...
                <li class="nav-item">
                  ...
                  <ul class="nav collapse show" id="utilities">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="../../modules/utilities/colored-links.jsp">
          ...
          <div class="card mb-3">
            ...
            <div class="card-body position-relative">
              <div class="row">
                <div class="col-lg-8">
                  <h3>Colored links</h3>
                  <p class="mb-0">Colored links with hover states</p><a class="btn btn-link btn-sm ps-0 mt-2" href="https://getbootstrap.com/docs/5.3/helpers/colored-links/" target="_blank">Colored links on Bootstrap<span class="fas fa-chevron-right ms-1 fs--2"></span></a>
                </div>
              </div>
            </div>
          </div>
          <div class="card mb-3">
            <div class="card-header">
              <div class="row flex-between-end">
                <div class="col-auto align-self-center">
                  ...
                  <p class="mb-0 pt-1 mt-2">You can use the <code>.link-*</code> classes to colorize links. Unlike the <a href='https://getbootstrap.com/docs/5.3/helpers/colored-links/' target="_blank"><code>.text-*</code> classes</a>, these classes have a <code>:hover</code> and <code>:focus</code> state.</p>
                </div>
                <div class="col-auto ms-auto">
                  <div class="nav nav-pills nav-pills-falcon flex-grow-1 mt-2" role="tablist">
                    <button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-036bd072-b901-4a65-a7b8-05ca60d7510b" type="button" role="tab" aria-controls="dom-036bd072-b901-4a65-a7b8-05ca60d7510b" aria-selected="true" id="tab-dom-036bd072-b901-4a65-a7b8-05ca60d7510b">Preview</button>
                    <button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-6f6d2211-b323-46bc-b508-cfccec94c993" type="button" role="tab" aria-controls="dom-6f6d2211-b323-46bc-b508-cfccec94c993" aria-selected="false" id="tab-dom-6f6d2211-b323-46bc-b508-cfccec94c993">Code</button>
                  </div>
                </div>
              </div>
            </div>
            <div class="card-body bg-light">
              <div class="tab-content">
                <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-036bd072-b901-4a65-a7b8-05ca60d7510b" id="dom-036bd072-b901-4a65-a7b8-05ca60d7510b"><a class="link-primary d-block" href="#!">Primary link</a>
                ...
                <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-6f6d2211-b323-46bc-b508-cfccec94c993" id="dom-6f6d2211-b323-46bc-b508-cfccec94c993">
...
&lt;a class=&quot;link-dark d-block&quot; href=&quot;#!&quot;&gt;Dark link&lt;/a&gt;</code></pre>
          ...
          <div class="card">
              ...
              <div class="row flex-between-end">
                ...
                <div class="col-auto ms-auto">
                  <div class="nav nav-pills nav-pills-falcon flex-grow-1" role="tablist">
                    <button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-f47a8cc2-b779-4dfe-9795-64bfca7c3876" type="button" role="tab" aria-controls="dom-f47a8cc2-b779-4dfe-9795-64bfca7c3876" aria-selected="true" id="tab-dom-f47a8cc2-b779-4dfe-9795-64bfca7c3876">Preview</button>
                    <button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-6e3e3ee4-d8a9-48fb-a473-66b6964ed956" type="button" role="tab" aria-controls="dom-6e3e3ee4-d8a9-48fb-a473-66b6964ed956" aria-selected="false" id="tab-dom-6e3e3ee4-d8a9-48fb-a473-66b6964ed956">Code</button>
                  </div>
                </div>
              </div>
            </div>
            <div class="card-body bg-light">
              <div class="tab-content">
                <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-f47a8cc2-b779-4dfe-9795-64bfca7c3876" id="dom-f47a8cc2-b779-4dfe-9795-64bfca7c3876"><a class="d-block link-black" href="#!">Link black</a>
                ...
                <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-6e3e3ee4-d8a9-48fb-a473-66b6964ed956" id="dom-6e3e3ee4-d8a9-48fb-a473-66b6964ed956">
