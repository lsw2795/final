              ...
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                ...
                <li class="nav-item">
                  ...
                  <ul class="nav collapse show" id="utilities">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="../../modules/utilities/overlayscrollbar.jsp">
          ...
          <div class="card mb-3">
              ...
              <div class="row flex-between-end">
                ...
                <div class="col-auto ms-auto">
                  <div class="nav nav-pills nav-pills-falcon flex-grow-1" role="tablist">
                    <button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-c97854b4-b98c-4363-9ca0-ee014ca4d04b" type="button" role="tab" aria-controls="dom-c97854b4-b98c-4363-9ca0-ee014ca4d04b" aria-selected="true" id="tab-dom-c97854b4-b98c-4363-9ca0-ee014ca4d04b">Preview</button>
                    <button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-0c6e0e6b-98c4-4754-bd4d-068bc6f43571" type="button" role="tab" aria-controls="dom-0c6e0e6b-98c4-4754-bd4d-068bc6f43571" aria-selected="false" id="tab-dom-0c6e0e6b-98c4-4754-bd4d-068bc6f43571">Code</button>
                  </div>
                </div>
              </div>
            </div>
            <div class="card-body bg-light">
              <div class="tab-content">
                <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-c97854b4-b98c-4363-9ca0-ee014ca4d04b" id="dom-c97854b4-b98c-4363-9ca0-ee014ca4d04b">
                ...
                <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-0c6e0e6b-98c4-4754-bd4d-068bc6f43571" id="dom-0c6e0e6b-98c4-4754-bd4d-068bc6f43571">
