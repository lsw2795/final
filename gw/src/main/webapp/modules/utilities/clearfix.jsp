              ...
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                ...
                <li class="nav-item">
                  ...
                  <ul class="nav collapse show" id="utilities">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="../../modules/utilities/clearfix.jsp">
          ...
          <div class="card mb-3">
            ...
            <div class="card-body position-relative">
              <div class="row">
                <div class="col-lg-8">
                  <h3>Clearfix</h3>
                  <p class="mb-0">Quickly and easily clear floated content within a container by adding a clearfix utility.</p><a class="btn btn-link btn-sm ps-0 mt-2" href="https://getbootstrap.com/docs/5.3/helpers/clearfix/" target="_blank">Clearfix on Bootstrap<span class="fas fa-chevron-right ms-1 fs--2"></span></a>
                </div>
              </div>
            </div>
          </div>
              ...
              <div class="card">
                  ...
                  <div class="row flex-between-end">
                    ...
                    <div class="col-auto ms-auto">
                      <div class="nav nav-pills nav-pills-falcon flex-grow-1" role="tablist">
                        <button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-578f8bd2-4a1c-4c94-864b-2a022d3f1bd8" type="button" role="tab" aria-controls="dom-578f8bd2-4a1c-4c94-864b-2a022d3f1bd8" aria-selected="true" id="tab-dom-578f8bd2-4a1c-4c94-864b-2a022d3f1bd8">Preview</button>
                        <button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-eb7b1895-8092-4965-bde2-088d170108cc" type="button" role="tab" aria-controls="dom-eb7b1895-8092-4965-bde2-088d170108cc" aria-selected="false" id="tab-dom-eb7b1895-8092-4965-bde2-088d170108cc">Code</button>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="card-body bg-light">
                  <div class="tab-content">
                    <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-578f8bd2-4a1c-4c94-864b-2a022d3f1bd8" id="dom-578f8bd2-4a1c-4c94-864b-2a022d3f1bd8">
                    ...
                    <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-eb7b1895-8092-4965-bde2-088d170108cc" id="dom-eb7b1895-8092-4965-bde2-088d170108cc">
