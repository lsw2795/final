              ...
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                ...
                <li class="nav-item">
                  ...
                  <ul class="nav collapse show" id="email">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="../../app/email/email-detail.jsp">
              ...
              <div class="row">
                <div class="col-md d-flex">
                  ...
                  <div class="flex-1 ms-2">
                    <h5 class="mb-0">Women work wonders… on your marketing skills</h5><a class="text-800 fs--1" href="#!"><span class="fw-semi-bold">Emma Watson</span><span class="ms-1 text-500">&lt;emma@watson.com&gt;</span></a>
                  </div>
                </div>
              ...
              <div class="row justify-content-center">
                <div class="col-lg-8 col-xxl-6">
                  <div class="card shadow-none mb-3"><img class="card-img-top" src="../../assets/img/icons/spot-illustrations/international-women-s-day-2.png" alt="" />
                    <div class="card-body">
                      <h3 class="fw-semi-bold">Happy International Women’s Day!</h3>
                      <p>On International Women’s Day, we at ThemeWagon want you to discover the skills you can learn from our amazing women digital marketing instructors.</p>
                      <p>That's not all, when you enroll in one of their courses, use promo code: <code>GirlPower20</code> and get <a class="fw-semi-bold" href="#!">20% off</a> as our Women's Day gift to you. This offer <a class="fw-semi-bold" href="#!">expires in 7 days</a> —so pick your course—and enroll today!</p>
