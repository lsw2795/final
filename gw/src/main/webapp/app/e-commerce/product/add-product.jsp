                  ...
                  <ul class="nav collapse show" id="e-commerce">
                    <li class="nav-item"><a class="nav-link dropdown-indicator" href="#product" data-bs-toggle="collapse" aria-expanded="true" aria-controls="e-commerce">
                      ...
                      <ul class="nav collapse show" id="product">
                        ...
                        <li class="nav-item"><a class="nav-link active" href="../../../app/e-commerce/product/add-product.jsp">
                  ...
                  <form>
                    <div class="row gx-2">
                      ...
                      <div class="col-12 mb-3">
                        ...
                        <input class="form-control" id="manufacturar-name" type="text" />
                      </div>
                      <div class="col-12 mb-3">
                      ...
                      <div class="col-12 mb-3">
                        <label class="form-label" for="product-summary">Product Summary: </label>
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  <form class="dropzone dropzone-multiple p-0" id="dropzoneMultipleFileUpload" data-dropzone="data-dropzone" action="#!" data-options='{"acceptedFiles":"image/*"}'>
                    ...
                    <div class="dz-message" data-dz-message="data-dz-message"> <img class="me-2" src="../../../assets/img/icons/cloud-upload.svg" width="25" alt="" /><span class="d-none d-lg-inline">Drag your image here<br/>or, </span><span class="btn btn-link p-0 fs--1">Browse</span></div>
                  ...
                  <div class="row gx-2">
                    <div class="col-12 mb-3">
                      ...
                      <div class="create-product-description-textarea">
                        <textarea class="tinymce d-none" data-tinymce="data-tinymce" name="product-description" id="product-description" required="required"></textarea>
                      </div>
                    </div>
                  ...
                  <div class="row gx-2 flex-between-center mb-3">
                    ...
                    <div class="col-sm-9">
                      <div class="d-flex flex-between-center">
                        <h6 class="mb-0 text-700">2.3GHz quad-core Intel Core i5</h6><a class="btn btn-sm btn-link text-danger" href="#!" data-bs-toggle="tooltip" data-bs-placement="top" title="Remove"><span class="fs--1 fas fa-trash-alt"></span></a>
                      </div>
                    </div>
                  </div>
                  <div class="row gx-2 flex-between-center mb-3">
                    ...
                    <div class="col-sm-9">
                      <div class="d-flex flex-between-center">
                        <h6 class="mb-0 text-700">8GB of 2133MHz LPDDR3 onboard memory</h6><a class="btn btn-sm btn-link text-danger" href="#!" data-bs-toggle="tooltip" data-bs-placement="top" title="Remove"><span class="fs--1 fas fa-trash-alt"></span></a>
                      </div>
                    </div>
                  </div>
                  <div class="row gx-2 flex-between-center mb-3">
                    ...
                    <div class="col-sm-9">
                      <div class="d-flex flex-between-center">
                        <h6 class="mb-0 text-700">Apple</h6><a class="btn btn-sm btn-link text-danger" href="#!" data-bs-toggle="tooltip" data-bs-placement="top" title="Remove"><span class="fs--1 fas fa-trash-alt"></span></a>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="card-body">
                    <div class="row gx-2">
                      <div class="col-8 mb-3">
                        <label class="form-label" for="base-price">Base Price: <span data-bs-toggle="tooltip" data-bs-placement="top" title="Product regular price"><span class="fas fa-question-circle text-primary fs--1 ms-1"></span></span></label>
                      ...
                      <div class="col-12 mb-4">
                        <label class="form-label" for="discount-percentage">Discount in percentage:</label>
                        <input class="form-control" id="discount-percentage" type="text" />
                      </div>
                      <div class="col-12">
                        <label class="form-label" for="final-price">Final price:<span data-bs-toggle="tooltip" data-bs-placement="top" title="Product final price"><span class="fas fa-question-circle text-primary fs--1 ms-1"></span></span></label>
                ...
                <div class="card mb-3">
                  ...
                  <div class="card-body">
                    <div class="form-check">
                      <input class="form-check-input p-2" id="vendor-delivery" type="radio" name="product-shipping" />
                      <label class="form-check-label fs-0 fw-normal text-700" for="vendor-delivery">Delivered by vendor (you)</label>
                    </div>
                    <div class="form-check">
                      <input class="form-check-input p-2" id="falcon-delivery" type="radio" name="product-shipping" />
                      <label class="form-check-label fs-0 fw-normal text-700" for="falcon-delivery">Delivered by FALCON <span class="badge badge-subtle-warning rounded-pill ms-2">Recommended</span></label>
                    </div>
                  </div>
                </div>
                <div class="card mb-3">
                  ...
                  <div class="card-body">
                    <div class="form-check">
                      ...
                      <label class="form-check-label fs-0 fw-normal text-700" for="in-stock">In stock</label>
                    </div>
                    <div class="form-check">
                      <input class="form-check-input p-2" id="unavailable" type="radio" name="stock-status" />
                      <label class="form-check-label fs-0 fw-normal text-700" for="unavailable">Unavailable</label>
                    </div>
                    <div class="form-check">
                      <input class="form-check-input p-2" id="to-be-announced" type="radio" name="stock-status" />
                      <label class="form-check-label fs-0 fw-normal text-700" for="to-be-announced">To be announced</label>
                    </div>
                  </div>
                </div>
              </div>
