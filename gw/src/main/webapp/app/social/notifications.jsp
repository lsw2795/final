  ...
  <body>
    ...
    <main class="main" id="top">
      <div class="container" data-layout="container">
              ...
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                ...
                <li class="nav-item">
                  ...
                  <ul class="nav collapse show" id="social">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="../../app/social/notifications.jsp">
          ...
          <div class="card overflow-hidden mb-3">
            ...
            <div class="card-body fs--1 p-0">
              ...
              <a class="border-bottom-0 notification rounded-0 border-x-0 border-300" href="#!">
                <div class="notification-avatar">
                  <div class="avatar avatar-xl me-3">
                    <img class="rounded-circle" src="../../assets/img/logos/harvard.png" alt="" />
        ...
        <div class="modal fade" id="notification-settings-modal" tabindex="-1" role="dialog" aria-labelledby="notification-settings-modal-label" aria-hidden="true">
          <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
              <div class="modal-header d-flex align-items-center border-bottom px-4">
                <h4 class="mb-0" id="notification-settings-modal-label">Notification Settings</h4>
              </div>
              <div class="modal-body p-4">
                <form class="text-start">
                  <div class="form-check lh-1 mb-0">
                    <input class="form-check-input" type="radio" value="" id="always" name="notification-settings" />
                    <label class="form-check-label mb-0" for="always">Get a notification each time there is activity on your page or an important update.
                    </label>
                  </div>
                  <div class="form-check lh-1 mb-0">
                    <input class="form-check-input" type="radio" value="" id="everyday" name="notification-settings" />
                    <label class="form-check-label mb-0" for="everyday">Get one notification every 12-24 hours on all activity and updates.
                    </label>
                  </div>
                  <div class="form-check lh-1 mb-0">
                    <input class="form-check-input" type="radio" value="" id="off" name="notification-settings" />
                    <label class="form-check-label mb-0" for="off">Off
                    </label>
                  </div>
                  <h5 class="fs-0 mb-3 mt-4">Edit your notification settings for: </h5>
                  <ul class="list-group list-group-flush mb-4 fs--1">
                    <li class="list-group-item d-flex justify-content-between align-items-center py-2 px-0 border-200 bg-transparent"><span>New Mention of Page </span><span class="form-check fs-0 mb-0">
                        <input class="form-check-input me-0" id="checkbox1" type="checkbox" name="checkbox1" checked="checked"/></span></li>
                    <li class="list-group-item d-flex justify-content-between align-items-center py-2 px-0 border-200 bg-transparent"><span>New Comments on page post</span><span class="form-check fs-0 mb-0">
                        <input class="form-check-input me-0" id="checkbox2" type="checkbox" name="checkbox2" checked="checked"/></span></li>
                    <li class="list-group-item d-flex justify-content-between align-items-center py-2 px-0 border-200 bg-transparent"><span>Edits to Comments you have written</span><span class="form-check fs-0 mb-0">
                        <input class="form-check-input me-0" id="checkbox3" type="checkbox" name="checkbox3" checked="checked"/></span></li>
                  </ul>
                  <div class="form-check mb-0">
                    <input class="form-check-input" type="checkbox" id="followers-activity" />
                    <label class="form-check-label mb-0" for="followers-activity">Allow notifications from your followers activity
                    </label>
                  </div>
                  <div class="form-check mb-0">
                    <input class="form-check-input" type="checkbox" id="groups" />
                    <label class="form-check-label mb-0" for="groups">Groups
                    </label>
                  </div>
                  <div class="form-check mb-0">
                    <input class="form-check-input" type="checkbox" id="associations" />
                    <label class="form-check-label mb-0" for="associations">Associations
                    </label>
                  </div>
                </form>
              </div>
              <div class="modal-footer border-top text-start py-3 px-4 d-flex justify-content-end">
                <button class="btn btn-secondary btn-sm" data-bs-dismiss="modal">Cancel</button>
                <button class="btn btn-primary btn-sm ms-2" type="submit">Update</button>
              </div>
            </div>
          </div>
        </div>
