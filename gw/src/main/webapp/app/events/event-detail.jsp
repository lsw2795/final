            ...
            <div class="navbar-vertical-content scrollbar">
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                ...
                <li class="nav-item">
                  ...
                  <!-- parent pages--><a class="nav-link dropdown-indicator" href="#events" role="button" data-bs-toggle="collapse" aria-expanded="true" aria-controls="events">
                  ...
                  <ul class="nav collapse show" id="events">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="../../app/events/event-detail.jsp">
            ...
            <div class="col-lg-4 ps-lg-2">
              <div class="sticky-sidebar">
                <div class="card mb-3 fs--1">
                  <div class="card-body">
                    <h6>Date And Time</h6>
                    <p class="mb-1">Mon, Dec 31, 2018, 11:59 PM – <br />Tue, Jan 1, 2019, 12:19 AM EST</p><a href="#!">Add to Calendar</a>
                    <h6 class="mt-4">Location</h6>
                    <div class="mb-1">Boston Harborwalk<br />Christopher Columbus Park<br />Boston, MA 02109<br />United States</div><a href="#view-map">View Map</a>
