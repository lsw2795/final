...
<html data-bs-theme="light" lang="en-US" dir="ltr">
  ...
  <head>
    ...
    <link rel="manifest" href="/gw/assets/img/favicons/manifest.json">
    <meta name="msapplication-TileImage" content="/gw/assets/img/favicons/mstile-150x150.png">
    <meta name="theme-color" content="#ffffff">
    <script src="/gw/assets/js/config.js"></script>
    <script src="/gw/vendors/simplebar/simplebar.min.js"></script>
    ...
    <link href="/gw/vendors/simplebar/simplebar.min.css" rel="stylesheet">
    <link href="/gw/assets/css/theme-rtl.css" rel="stylesheet" id="style-rtl">
    <link href="/gw/assets/css/theme.css" rel="stylesheet" id="style-default">
    <link href="/gw/assets/css/user-rtl.css" rel="stylesheet" id="user-style-rtl">
    <link href="/gw/assets/css/user.css" rel="stylesheet" id="user-style-default">
    <script>
  ...
  <body>
    ...
    <main class="main" id="top">
      <div class="container" data-layout="container">
        ...
        <div class="row flex-center min-vh-100 py-6 text-center">
          <div class="col-sm-10 col-md-8 col-lg-6 col-xxl-5"><a class="d-flex flex-center mb-4" href="<c:url value='/'/>"><img class="me-2" src="/gw/adminfinallogo.png" alt="" width="300" /></a>
            <div class="card">
              <div class="card-body p-4 p-sm-5">
                <div class="fw-black lh-1 text-300 fs-error">404</div>
                <p class="lead mt-4 text-800 font-sans-serif fw-semi-bold w-md-75 w-xl-100 mx-auto">"찾고 있는 페이지를 찾을 수 없습니다."</p>
                <hr />
                <p>주소가 정확한지, 페이지가 이동하지 않았는지 확인하세요.</p><a class="btn btn-primary btn-sm mt-3" href="<c:url value='/'/>"><span class="fas fa-home me-2"></span>Go to the main</a>
              </div>
            </div>
          </div>
        </div>
    ...
    <!--    JavaScripts-->
    <!-- ===============================================-->
    <script src="/gw/vendors/popper/popper.min.js"></script>
    <script src="/gw/vendors/bootstrap/bootstrap.min.js"></script>
    <script src="/gw/vendors/anchorjs/anchor.min.js"></script>
    <script src="/gw/vendors/is/is.min.js"></script>
    <script src="/gw/vendors/fontawesome/all.min.js"></script>
    <script src="/gw/vendors/lodash/lodash.min.js"></script>
    <script src="https://polyfill.io/v3/polyfill.min.js?features=window.scroll"></script>
    <script src="/gw/vendors/list.js/list.min.js"></script>
    <script src="/gw/assets/js/theme.js"></script>
