              ...
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                <li class="nav-item">
                  ...
                  <ul class="nav collapse show" id="dashboard">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="../dashboard/support-desk.jsp">
              ...
              <div class="row g-0 h-100">
                <div class="col-12 mb-3">
                  <div class="card bg-light shadow-none">
                    <div class="bg-holder bg-card d-none d-sm-block" style="background-image:url(../assets/img/illustrations/ticket-bg.png);">
                    </div>
                    <!--/.bg-holder-->

                    <div class="card-header d-flex align-items-center z-1 p-0"><img src="../assets/img/illustrations/ticket-welcome.png" alt="" width="96" />
                      <div class="ms-n3">
                        <h6 class="mb-1 text-primary">Welcome to</h6>
                        <h4 class="mb-0 text-primary fw-bold">Falcon<span class="text-info fw-medium"> Support Desk</span></h4>
                      </div>
                    </div>
                  </div>
                </div>
                    ...
                    <div class="card-body">
                      <div class="row g-0">
                        <div class="col-md-6 border-200 border-bottom border-end-md pb-x1 pe-md-x1">
                          <div class="row g-0">
                            <div class="col-6"><img class="mt-1" src="../assets/img/tickets/hold-tickets.png" alt="" width="39" />
                              <h2 class="mt-2 mb-1 text-700 fw-normal">25<span class="fas fa-caret-up ms-2 me-1 fs--1 text-primary"></span><span class="fs--1 fw-semi-bold text-primary">5.3%</span></h2>
                        ...
                        <div class="col-md-6 ps-md-x1 pb-x1 pt-x1 pt-md-0 border-bottom border-200">
                          <div class="row g-0">
                            <div class="col-6"><img class="mt-1" src="../assets/img/tickets/open-tickets.png" alt="" width="39" />
                              <h2 class="mt-2 mb-1 text-700 fw-normal">05<span class="fas fa-caret-up ms-2 me-1 fs--1 text-success"></span><span class="fs--1 fw-semi-bold text-success">3.20%</span></h2>
                        ...
                        <div class="col-md-6 border-200 border-bottom border-bottom-md-0 border-end-md pt-x1 pe-md-x1 pb-x1 pb-md-0">
                          <div class="row g-0">
                            <div class="col-6"><img class="mt-1" src="../assets/img/tickets/due-tickets.png" alt="" width="39" />
                              <h2 class="mt-2 mb-1 text-700 fw-normal">02<span class="fas fa-caret-up ms-2 me-1 fs--1 text-info"></span><span class="fs--1 fw-semi-bold text-info">2.3%</span></h2>
                        ...
                        <div class="col-md-6 ps-md-x1 pt-x1">
                          <div class="row g-0">
                            <div class="col-6"><img class="mt-1" src="../assets/img/tickets/unassigned.png" alt="" width="39" />
                              <h2 class="mt-2 mb-1 text-700 fw-normal">03<span class="fas fa-caret-up ms-2 me-1 fs--1 text-warning"></span><span class="fs--1 fw-semi-bold text-warning">3.12%</span></h2>
              ...
              <div class="card h-100">
                <div class="card-header d-flex flex-between-center border-bottom border-200 py-2">
                  ...
                  <div class="dropdown font-sans-serif btn-reveal-trigger">
                    <button class="btn btn-link text-600 btn-sm dropdown-toggle dropdown-caret-none btn-reveal" type="button" id="dropdown-unresolved-tickets" data-bs-toggle="dropdown" data-boundary="viewport" aria-haspopup="true" aria-expanded="false"><span class="fas fa-ellipsis-h fs--2"></span></button>
                    <div class="dropdown-menu dropdown-menu-end border py-2" aria-labelledby="dropdown-unresolved-tickets"><a class="dropdown-item" href="#!">View</a><a class="dropdown-item" href="#!">Export</a>
                  ...
                  <div class="row">
                    <div class="col-md-auto border-end-md border-200 pt-3 pt-md-0 d-md-flex align-items-center">
                      <div class="row flex-md-column px-3">
                        <div class="col-auto border-end border-end-md-0 border-bottom-md pb-md-3 mb-md-3 ps-0 ps-md-3 pe-x1 pe-md-3 me-1 me-md-0">
                          <div class="d-flex align-items-center mb-n1">
                            <label class="fs-0 mb-n1 text-700 cursor-pointer" for="urgent">14</label>
                            <input class="form-check-input small-dot mt-0 shadow-none remove-checked-icon rounded-circle cursor-pointer" type="checkbox" data-unresolved-tickets="Urgent" value="" id="urgent" checked="checked" />
                          </div>
                          <label class="fs--2 mb-0 text-700 cursor-pointer" for="urgent">Urgent</label>
                        </div>
                        <div class="col-auto border-end border-end-md-0 border-bottom-md pb-md-3 mb-md-3 pe-x1 pe-md-3 me-1 me-md-0">
                          <div class="d-flex align-items-center mb-n1">
                            <label class="fs-0 mb-n1 text-700 cursor-pointer" for="high">16</label>
                            <input class="form-check-input small-dot mt-0 shadow-none remove-checked-icon rounded-circle cursor-pointer form-check-input-info" type="checkbox" data-unresolved-tickets="High" value="" id="high" checked="checked" />
                          </div>
                          <label class="fs--2 mb-0 text-700 cursor-pointer" for="high">High</label>
                        </div>
                        <div class="col-auto border-end border-end-md-0 border-bottom-md pb-md-3 mb-md-3 pe-x1 pe-md-3 me-1 me-md-0">
                          <div class="d-flex align-items-center mb-n1">
                            <label class="fs-0 mb-n1 text-700 cursor-pointer" for="medium">53</label>
                            <input class="form-check-input small-dot mt-0 shadow-none remove-checked-icon rounded-circle cursor-pointer bg-priority-medium" type="checkbox" data-unresolved-tickets="Medium" value="" id="medium" checked="checked" />
                          </div>
                          <label class="fs--2 mb-0 text-700 cursor-pointer" for="medium">Medium</label>
                        </div>
                        <div class="col-auto pe-0">
                          <div class="d-flex align-items-center mb-n1">
                            <label class="fs-0 mb-n1 text-700 cursor-pointer" for="low">25</label>
                            <input class="form-check-input small-dot mt-0 shadow-none remove-checked-icon rounded-circle cursor-pointer bg-priority-low" type="checkbox" data-unresolved-tickets="Low" value="" id="low" checked="checked" />
                          </div>
                          <label class="fs--2 mb-0 text-700 cursor-pointer" for="low">Low</label>
                        </div>
                      </div>
                    </div>
                ...
                <div class="card-footer text-center border-top border-200 p-0"><a class="btn btn-link btn-sm px-0 fw-medium py-2" href="#!">View all<span class="fas fa-chevron-right ms-1 fs--2"></span></a></div>
              </div>
            </div>
          </div>
          <div class="row g-3">
                  ...
                  <div class="row g-md-0">
                    <div class="col-auto d-md-flex">
                      <div class="d-flex align-items-center me-md-3 form-check mb-0">
                        <input class="form-check-input dot mt-0 shadow-none remove-checked-icon rounded-circle cursor-pointer" type="checkbox" data-number-of-tickets="On Hold Tickets" value="" id="onHoldTickets" checked="checked" />
                        <label class="form-check-label lh-base mb-0 fs--2 text-500 fw-semi-bold font-base cursor-pointer" for="onHoldTickets">On Hold Tickets</label>
                      </div>
                      <div class="d-flex align-items-center me-md-3 form-check mb-0 mt-n1 mt-md-0">
                        <input class="form-check-input dot mt-0 shadow-none remove-checked-icon rounded-circle open-tickets cursor-pointer" type="checkbox" data-number-of-tickets="Open Tickets" value="" id="openTickets" checked="checked" />
                        <label class="form-check-label lh-base mb-0 fs--2 text-500 fw-semi-bold font-base cursor-pointer" for="openTickets">Open Tickets</label>
                      </div>
                    </div>
                    <div class="col-auto d-md-flex">
                      <div class="d-flex align-items-center me-md-3 form-check mb-0">
                        <input class="form-check-input dot mt-0 shadow-none remove-checked-icon rounded-circle due-tickets cursor-pointer" type="checkbox" data-number-of-tickets="Due Tickets" value="" id="dueTickets" checked="checked" />
                        <label class="form-check-label lh-base mb-0 fs--2 text-500 fw-semi-bold font-base cursor-pointer" for="dueTickets">Due Tickets</label>
                      </div>
                      <div class="d-flex align-items-center form-check mb-0 mt-n1 mt-md-0">
                        <input class="form-check-input dot mt-0 shadow-none remove-checked-icon rounded-circle unassigned-tickets cursor-pointer" type="checkbox" data-number-of-tickets="Unassigned Tickets" value="" id="unassignedTickets" checked="checked" />
                        <label class="form-check-label lh-base mb-0 fs--2 text-500 fw-semi-bold font-base cursor-pointer" for="unassignedTickets">Unassigned Tickets</label>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div class="col-xxl-4 col-md-6">
              <div class="card h-100">
                <div class="card-header d-flex flex-between-center border-bottom border-200 py-2">
                  ...
                  <div class="dropdown font-sans-serif btn-reveal-trigger">
                    <button class="btn btn-link text-600 btn-sm dropdown-toggle dropdown-caret-none btn-reveal" type="button" id="dropdown-customer-satisfaction" data-bs-toggle="dropdown" data-boundary="viewport" aria-haspopup="true" aria-expanded="false"><span class="fas fa-ellipsis-h fs--2"></span></button>
                  ...
                  <div class="row">
                    <div class="col-6 border-end border-200 py-3 d-flex justify-content-center">
                      <div>
                        ...
                        <h6 class="fs-0 mb-0 d-flex align-items-center">150<small class="badge px-0 text-success bg-transparent d-flex align-items-start"><span class="fas fa-caret-up ms-2 me-1 fs--2"></span><span class="fs--1">23.3%</span></small></h6>
                      </div>
                    </div>
                    <div class="col-6 py-3 d-flex justify-content-center">
                      <div>
                        <h6 class="text-600 mb-1 fs--2">Negative</h6>
                        <h6 class="fs-0 mb-0 d-flex align-items-center">20<small class="badge px-0 text-danger d-flex align-items-start"><span class="fas fa-caret-down ms-2 me-1 fs--2"></span><span class="fs--1">5.23%</span></small></h6>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div class="col-xxl-3 col-md-6">
              <div class="card h-100">
                <div class="card-header d-flex flex-between-center bg-light">
                  ...
                  <button class="btn btn-falcon-default btn-sm d-flex align-items-center" type="button"><span class="fas fa-plus" data-fa-transform="shrink-3"></span><span class="ms-1">Add</span></button>
                </div>
                <div class="card-body ticket-todo-list scrollbar-overlay">
                  <div class="d-flex hover-actions-trigger btn-reveal-trigger gap-3 border-200 border-bottom mb-3">
                    <div class="form-check mb-0">
                      <input class="form-check-input form-check-line-through" type="checkbox" id="ticket-checkbox-todo-0" />
                      <label class="form-check-label w-100 pe-3" for="ticket-checkbox-todo-0"><span class="mb-1 text-700 d-block">Sidenav text cutoff rendering issue</span><span class="fs--2 text-600 lh-base font-base fw-normal d-block mb-2">Problem with Falcon theme</span></label>
                    </div>
                    <div class="hover-actions end-0">
                      <button class="btn fs--2 icon-item-sm btn-link px-0 text-600"><span class="fas fa-trash text-danger"></span></button>
                    </div>
                  </div>
                  <div class="d-flex hover-actions-trigger btn-reveal-trigger gap-3 border-200 border-bottom mb-3">
                    <div class="form-check mb-0">
                      <input class="form-check-input form-check-line-through" type="checkbox" id="ticket-checkbox-todo-1" />
                      <label class="form-check-label w-100 pe-3" for="ticket-checkbox-todo-1"><span class="mb-1 text-700 d-block">Notify when the WebPack release is ready</span><span class="fs--2 text-600 lh-base font-base fw-normal d-block mb-2">Falcon Bootstarp 5</span></label>
                    </div>
                    <div class="hover-actions end-0">
                      <button class="btn fs--2 icon-item-sm btn-link px-0 text-600"><span class="fas fa-trash text-danger"></span></button>
                    </div>
                  ...
                  <div class="d-flex hover-actions-trigger btn-reveal-trigger gap-3 border-200 border-bottom mb-3">
                    <div class="form-check mb-0">
                      <input class="form-check-input form-check-line-through" type="checkbox" id="ticket-checkbox-todo-2" />
                      <label class="form-check-label w-100 pe-3" for="ticket-checkbox-todo-2"><span class="mb-1 text-700 d-block">File Attachments</span><span class="fs--2 text-600 lh-base font-base fw-normal d-block mb-2">Sending attachments automatically attaches them to the notification email that the client receives as well as making them accessible through.</span></label>
                    </div>
                    <div class="hover-actions end-0">
                      <button class="btn fs--2 icon-item-sm btn-link px-0 text-600"><span class="fas fa-trash text-danger"></span></button>
                    </div>
                  ...
                  <div class="d-flex hover-actions-trigger btn-reveal-trigger gap-3 border-200 border-bottom mb-3">
                    <div class="form-check mb-0">
                      <input class="form-check-input form-check-line-through" type="checkbox" id="ticket-checkbox-todo-3" />
                      <label class="form-check-label w-100 pe-3" for="ticket-checkbox-todo-3"><span class="mb-1 text-700 d-block">Billing a Client</span><span class="fs--2 text-600 lh-base font-base fw-normal d-block mb-2">It's also possible to create a billable item for a client when you reply to a ticket. You can generate invoices or log time spent on a ticket.</span></label>
                    </div>
                    <div class="hover-actions end-0">
                      <button class="btn fs--2 icon-item-sm btn-link px-0 text-600"><span class="fas fa-trash text-danger"></span></button>
                    </div>
                  ...
                  <div class="d-flex hover-actions-trigger btn-reveal-trigger gap-3 border-200 border-bottom mb-3">
                    <div class="form-check mb-0">
                      <input class="form-check-input form-check-line-through" type="checkbox" id="ticket-checkbox-todo-4" />
                      <label class="form-check-label w-100 pe-3" for="ticket-checkbox-todo-4"><span class="mb-1 text-700 d-block">Sidenav text cutoff rendering issue</span><span class="fs--2 text-600 lh-base font-base fw-normal d-block mb-2">Problem with Falcon theme</span></label>
                    </div>
                    <div class="hover-actions end-0">
                      <button class="btn fs--2 icon-item-sm btn-link px-0 text-600"><span class="fas fa-trash text-danger"></span></button>
                    </div>
                  ...
                  <div class="d-flex hover-actions-trigger btn-reveal-trigger gap-3 border-200 border-bottom mb-3">
                    <div class="form-check mb-0">
                      <input class="form-check-input form-check-line-through" type="checkbox" id="ticket-checkbox-todo-5" />
                      <label class="form-check-label w-100 pe-3" for="ticket-checkbox-todo-5"><span class="mb-1 text-700 d-block">Notify when the WebPack release is ready</span><span class="fs--2 text-600 lh-base font-base fw-normal d-block mb-2">Falcon Bootstarp 5</span></label>
                    </div>
                    <div class="hover-actions end-0">
                      <button class="btn fs--2 icon-item-sm btn-link px-0 text-600"><span class="fas fa-trash text-danger"></span></button>
                    </div>
                  ...
                  <div class="d-flex hover-actions-trigger btn-reveal-trigger gap-3 border-200 mb-0">
                    <div class="form-check mb-0">
                      <input class="form-check-input form-check-line-through" type="checkbox" id="ticket-checkbox-todo-6" />
                      <label class="form-check-label w-100 pe-3 mb-0" for="ticket-checkbox-todo-6"><span class="mb-1 text-700 d-block">File Attachments</span><span class="fs--2 text-600 lh-base font-base fw-normal d-block mb-0">Sending attachments automatically attaches them to the notification email that the client receives as well as making them accessible through.</span></label>
                    </div>
                    <div class="hover-actions end-0">
                      <button class="btn fs--2 icon-item-sm btn-link px-0 text-600"><span class="fas fa-trash text-danger"></span></button>
                    </div>
                ...
                <div class="card-footer border-top border-200 text-center p-0"><a class="btn btn-link btn-sm fw-medium py-2" href="#!">View all<span class="fas fa-chevron-right ms-1 fs--2"></span></a></div>
              </div>
            </div>
            <div class="col-xxl-9">
