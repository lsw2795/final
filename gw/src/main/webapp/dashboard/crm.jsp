              ...
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                <li class="nav-item">
                  ...
                  <ul class="nav collapse show" id="dashboard">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="../dashboard/crm.jsp">
                  ...
                  <div class="col-md-auto p-3">
                    <form class="row align-items-center g-3">
                      ...
                      <div class="col-md-auto position-relative">
                        <input class="form-control form-control-sm datetimepicker ps-4" id="CRMDateRange" type="text" data-options="{&quot;mode&quot;:&quot;range&quot;,&quot;dateFormat&quot;:&quot;M d&quot;,&quot;disableMobile&quot;:true , &quot;defaultDate&quot;: [&quot;May 03&quot;, &quot;May 10&quot;] }" /><span class="fas fa-calendar-alt text-primary position-absolute top-50 translate-middle-y ms-2"> </span>
                      </div>
                    </form>
                  </div>
                </div>
                  ...
                  <div class="w-100">
                    ...
                    <div class="progress-stacked overflow-visible rounded-5 font-sans-serif fw-medium fs--1 mt-xxl-auto">
                      <div class="progress" style="width: 50%; height: 20px;" role="progressbar" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100">
                        <div class="progress-bar overflow-visible bg-progress-gradient border-end border-white border-2 rounded-end rounded-pill text-start"><span class="text-700 mt-n6">$47.8k</span></div>
                      </div>
                      <div class="progress" style="width: 20%; height: 20px;" role="progressbar" aria-valuenow="20" aria-valuemin="0" aria-valuemax="100">
                        <div class="progress-bar overflow-visible bg-primary-subtle border-end border-white border-2 text-start"><span class="text-700 mt-n6">$20.2k</span></div>
                      </div>
                      <div class="progress" style="width: 15%; height: 20px;" role="progressbar" aria-valuenow="15" aria-valuemin="0" aria-valuemax="100">
                        <div class="progress-bar overflow-visible bg-info-subtle border-end border-white border-2 text-start"><span class="text-700 mt-n6">$18k</span></div>
                      </div>
                    ...
                    <table class="table mb-0 fs--1 border-200 table-borderless">
                      ...
                      <tbody>
                        <tr class="border-bottom border-200">
                          <td class="align-middle font-sans-serif fw-medium text-nowrap"><a href="../app/e-commerce/customer-details.jsp">John oliver</a></td>
                        ...
                        <tr class="border-bottom border-200">
                          <td class="align-middle font-sans-serif fw-medium text-nowrap"><a href="../app/e-commerce/customer-details.jsp">Sean Paul</a></td>
                        ...
                        <tr class="border-bottom border-200">
                          <td class="align-middle font-sans-serif fw-medium text-nowrap"><a href="../app/e-commerce/customer-details.jsp">Brad Shaw</a></td>
                        ...
                        <tr>
                          <td class="align-middle font-sans-serif fw-medium text-nowrap"><a href="../app/e-commerce/customer-details.jsp">Max Payne</a></td>
                  ...
                  <div class="card h-100">
                    ...
                    <div class="card-body pt-0">
                      <div class="d-flex bg-100 py-2 mb-3 justify-content-center mx-nx1 fs--1 border-bottom border-200">
                        <p class="text-600 mb-0 border-end border-200 px-x1 d-flex align-items-center">Current Rete: <span class="fs-sm-1 font-sans-serif ms-2 text-700"> 4.5%</span><span class="fas fa-caret-up ms-2 ms-xxl-3 fs--1 text-success"></span></p>
                        <p class="text-600 mb-0 px-x1">Target Rete:<span class="fs-sm-1 font-sans-serif ms-2 text-700"> 6%</span></p>
                      </div>
                    ...
                    <table class="table fs--1 mb-0">
                      <thead class="bg-200 text-800">
                        <tr>
                          <th class="white-space-nowrap align-middle py-0" style="max-width: 30px;">
                            <div class="form-check mb-0 d-flex align-items-center">
                              <input class="form-check-input mt-0" id="checkbox-bulk-leads-select" type="checkbox" data-bulk-select='{"body":"table-recent-leads-body","actions":"table-recent-leads-actions","replacedElement":"table-recent-leads-replace-element"}' />
                            </div>
                          </th>
                      ...
                      <tbody class="list" id="table-recent-leads-body">
                        <tr class="hover-actions-trigger btn-reveal-trigger hover-bg-100">
                          ...
                          <td class="align-middle white-space-nowrap"><a class="text-800" href="../pages/user/profile.jsp">
                              <div class="d-flex align-items-center">
                                <div class="avatar avatar-xl">
                                  <img class="rounded-circle" src="../assets/img/team/1-thumb.png" alt="" />
