...
<%@ include file = "../inc/top.jsp" %>
 ...
 <div class="row gx-3">
            <h2>Q&A 게시판</h2>
            <div >
              <div class="card" id="allContactTable" data-list='{"valueNames":["name","phone-number","report","subscription","social"],"page":15,"pagination":true,"fallback":"contact-table-fallback"}'>
