            ...
            <div class="modal-content border">
              <form id="addEventForm" autocomplete="on" method="post" action="<c:url value='/calendar/addSchedule'/>">
                  ...
                  <div class="mb-3">
                    ...
                    <input class="form-control datetimepicker" id="eventStartDate" type="text" required="required" name="begindate" placeholder="yyyy/mm/dd hh:mm" data-options='{"static":"true","enableTime":"true","dateFormat":"Y-m-d H:i"}' />
                  </div>
                  <div class="mb-3">
