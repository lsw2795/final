              ...
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                ...
                <li class="nav-item">
                  ...
                  <ul class="nav collapse show" id="customization">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="../../documentation/customization/dark-mode.jsp">
          ...
          <div class="card mb-3">
            ...
            <div class="card-body position-relative">
              <div class="row">
                <div class="col-lg-8">
                  <h3>Dark Mode</h3>
                  <p class="mb-0">It’s effortless to switch Dark Mode in Falcon. You can enable Dark Mode by default or create a Dark/Light switch if you want. To set the default mode "Dark", please see the <a href='../../documentation/customization/configuration.jsp'>configuration page</a>.</p>
                </div>
              </div>
            </div>
          </div>
          <div class="card mb-3">
            <div class="card-header">
              <div class="row flex-between-end">
                <div class="col-auto align-self-center">
                  <h5 class="mb-0" data-anchor="data-anchor">Toggle Dark Mode</h5>
                  <p class="mb-0 pt-1 mt-2 mb-0">Toggling dark mode is very easy in Falcon. You can toggle dark or light mode by using checkbox, radio input, switch input and custom icon component.</p>
                </div>
                <div class="col-auto ms-auto">
                  <div class="nav nav-pills nav-pills-falcon flex-grow-1 mt-2" role="tablist">
                    <button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-24bc03dc-6195-486b-b960-e94a7f62e8b6" type="button" role="tab" aria-controls="dom-24bc03dc-6195-486b-b960-e94a7f62e8b6" aria-selected="true" id="tab-dom-24bc03dc-6195-486b-b960-e94a7f62e8b6">Preview</button>
                    <button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-196dac3c-3375-44a6-ab54-2f63d7a79458" type="button" role="tab" aria-controls="dom-196dac3c-3375-44a6-ab54-2f63d7a79458" aria-selected="false" id="tab-dom-196dac3c-3375-44a6-ab54-2f63d7a79458">Code</button>
                  </div>
                </div>
              </div>
            </div>
            <div class="card-body bg-light">
              <div class="tab-content">
                <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-24bc03dc-6195-486b-b960-e94a7f62e8b6" id="dom-24bc03dc-6195-486b-b960-e94a7f62e8b6">
                  <div class="row">
                    <div class="col">
                ...
                <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-196dac3c-3375-44a6-ab54-2f63d7a79458" id="dom-196dac3c-3375-44a6-ab54-2f63d7a79458">
...
&lt;/div&gt;</code></pre>
          ...
          <div class="card mb-3">
            <div class="card-header">
              <h5 class="mb-0">If you are using gulp based workflow</h5>
            </div>
            <div class="card-body bg-light">
              <h6 class="fs-0">Modify Dark colors using SCSS</h6>
              <p>You can find all the variables used to create the dark mode in <code>/src/scss/theme/root/_dark.scss</code> file. If you want to override a variable, copy that variable to your <code>/src/scss/theme/user.scss</code> file and update it as you see fit. When you change the variable with scss, make sure that the gulp is running.</p>
            </div>
          </div>
          <div class="card mb-3">
            <div class="card-header">
              <h5 class="mb-0">If you are not using gulp based workflow</h5>
            </div>
            <div class="card-body bg-light">
              <h6 class="fs-0">Modify Dark colors using CSS</h6>
              <p>You can find all the CSS variables used to create the dark mode in <code>/public/assets/css/theme.css</code> file. Look for <code>:root[data-bs-theme=dark]</code> and you will see all the available variables. If you want to override a variable, copy that variable to your <code>/public/assets/css/user.css</code> file and update it as you see fit.</p>
              <pre class="language-css"><code class="lang-css">/*-----------------------------------------------
|   Theme Styles
-----------------------------------------------*/
:root,
[data-bs-theme=light] {
...
[data-bs-theme=dark] {
  ...
  --falcon-gray-300: 52, 64, 80;
          ...
          <div class="card mb-3">
            <div class="card-header">
              <h5 class="mb-0">Using the Dark CSS classes in HTML</h5>
            </div>
            <div class="card-body bg-light">
              <h6 class="fs-0">You can keep a style constant regardless of current (light or dark) mode</h6>
              <p>If you want a component to retain it’s color (light or dark) as it is regardless of the current mode, you can use the following attributes -</p>
              ...
              <div class="row gx-3">
                <div class="col-lg-6">
                  <div class="card">
                      ...
                      <div class="row flex-between-end">
                        ...
                        <div class="col-auto ms-auto">
                          <div class="nav nav-pills nav-pills-falcon flex-grow-1" role="tablist">
                            <button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-c36dda26-2117-4175-a146-97afe6384c1d" type="button" role="tab" aria-controls="dom-c36dda26-2117-4175-a146-97afe6384c1d" aria-selected="true" id="tab-dom-c36dda26-2117-4175-a146-97afe6384c1d">Preview</button>
                            <button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-e342bd31-1e2d-4bb7-ae60-0e71bb66d875" type="button" role="tab" aria-controls="dom-e342bd31-1e2d-4bb7-ae60-0e71bb66d875" aria-selected="false" id="tab-dom-e342bd31-1e2d-4bb7-ae60-0e71bb66d875">Code</button>
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="card-body bg-light">
                      <div class="tab-content">
                        <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-c36dda26-2117-4175-a146-97afe6384c1d" id="dom-c36dda26-2117-4175-a146-97afe6384c1d">
                        ...
                        <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-e342bd31-1e2d-4bb7-ae60-0e71bb66d875" id="dom-e342bd31-1e2d-4bb7-ae60-0e71bb66d875">
                          <pre class="scrollbar rounded-1" style="max-height:420px"><code class="language-html">&lt;div class=&quot;card bg-100&quot; data-bs-theme=&quot;light&quot;&gt;
  &lt;div class=&quot;card-body&quot;&gt;
    &lt;p class=&quot;mb-0 text-700&quot;&gt;&lt;b&gt;This element will retain it's color if you switch between light and dark mode.&lt;/b&gt;&lt;/p&gt;
  &lt;/div&gt;
&lt;/div&gt;</code></pre>
                  ...
                  <div class="card">
                    <div class="card-header">
                      <div class="row flex-between-end">
                        ...
                        <div class="col-auto ms-auto">
                          <div class="nav nav-pills nav-pills-falcon flex-grow-1" role="tablist">
                            <button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-ae21e722-976c-4a4c-8a38-d022a299f47c" type="button" role="tab" aria-controls="dom-ae21e722-976c-4a4c-8a38-d022a299f47c" aria-selected="true" id="tab-dom-ae21e722-976c-4a4c-8a38-d022a299f47c">Preview</button>
                            <button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-be95eea0-6d78-4879-ab93-badbdfcbe03a" type="button" role="tab" aria-controls="dom-be95eea0-6d78-4879-ab93-badbdfcbe03a" aria-selected="false" id="tab-dom-be95eea0-6d78-4879-ab93-badbdfcbe03a">Code</button>
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="card-body bg-light">
                      <div class="tab-content">
                        <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-ae21e722-976c-4a4c-8a38-d022a299f47c" id="dom-ae21e722-976c-4a4c-8a38-d022a299f47c">
                        ...
                        <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-be95eea0-6d78-4879-ab93-badbdfcbe03a" id="dom-be95eea0-6d78-4879-ab93-badbdfcbe03a">
                          <pre class="scrollbar rounded-1" style="max-height:420px"><code class="language-html">&lt;div class=&quot;card bg-100&quot; data-bs-theme=&quot;dark&quot;&gt;
  &lt;div class=&quot;card-body&quot;&gt;
    &lt;p class=&quot;mb-0 text-700&quot;&gt;&lt;b&gt;This element will retain it's color if you switch between light and dark mode.&lt;/b&gt;&lt;/p&gt;
  &lt;/div&gt;
&lt;/div&gt;</code></pre>
              ...
              <div class="card">
                <div class="card-header">
                  <div class="row flex-between-end">
                    ...
                    <div class="col-auto ms-auto">
                      <div class="nav nav-pills nav-pills-falcon flex-grow-1" role="tablist">
                        <button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-e22b73ef-cae8-4383-bd20-74fdff24c61c" type="button" role="tab" aria-controls="dom-e22b73ef-cae8-4383-bd20-74fdff24c61c" aria-selected="true" id="tab-dom-e22b73ef-cae8-4383-bd20-74fdff24c61c">Preview</button>
                        <button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-853aa64c-b1c1-4a97-9ea3-445be923c8e1" type="button" role="tab" aria-controls="dom-853aa64c-b1c1-4a97-9ea3-445be923c8e1" aria-selected="false" id="tab-dom-853aa64c-b1c1-4a97-9ea3-445be923c8e1">Code</button>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="card-body bg-light">
                  <div class="tab-content">
                    <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-e22b73ef-cae8-4383-bd20-74fdff24c61c" id="dom-e22b73ef-cae8-4383-bd20-74fdff24c61c">
                    ...
                    <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-853aa64c-b1c1-4a97-9ea3-445be923c8e1" id="dom-853aa64c-b1c1-4a97-9ea3-445be923c8e1">
                      <pre class="scrollbar rounded-1" style="max-height:420px"><code class="language-html">&lt;div class=&quot;card bg-light dark__bg-primary&quot;&gt;
  &lt;div class=&quot;card-body&quot;&gt;
    &lt;p class=&quot;mb-0&quot;&gt;&lt;span class=&quot;fw-bold&quot;&gt;This element will retain it's color if you switch between light and dark mode.&lt;/span&gt;&lt;/p&gt;
  &lt;/div&gt;
&lt;/div&gt;</code></pre>
          ...
          <div class="card mb-3">
            <div class="card-header">
              <h5 class="mb-0">Emit JavaScript event on color scheme change</h5>
            </div>
            <div class="card-body bg-light">
              ...
              <pre><code class="lang-js">const themeController = document.body;
