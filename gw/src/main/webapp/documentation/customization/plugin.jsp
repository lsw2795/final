...
<html data-bs-theme="light" lang="en-US" dir="ltr">
  ...
  <body>
    ...
    <main class="main" id="top">
      <div class="container" data-layout="container">
              ...
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                ...
                <li class="nav-item">
                  ...
                  <ul class="nav collapse show" id="customization">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="../../documentation/customization/plugin.jsp">
        ...
        <div class="content">
          ...
          <div class="card mb-3">
            <div class="card-header">
              <h5 class="mb-0" data-anchor="data-anchor">Simple approach(without npm)</h5>
            </div>
            <div class="card-body bg-light">
              <p class="mb-0">Place your new plugin in <code>public/vendors</code> folder. Eg: to add the <code>flatpickr</code> plugin, we will download it from <a href="https://flatpickr.js.org/" target="_blank">here,</a> unzip it and place the <code>flatpickr-master</code> folder in <code>public/vendors</code> folder. You can now simply link the plugin files to your HTML and use them.</p>
            </div>
          </div>
          <div class="card mb-3">
            <div class="card-header">
              <h5 class="mb-0" data-anchor="data-anchor">Using npm</h5>
            </div>
            <div class="card-body bg-light">
              <p>Suppose we are installing the <code>flatpickr</code> plugin. Here are the steps:</p>
              <p class="fw-bold font-sans-serif mb-0">Step 1:</p>
              <p>run npm command for install plugin. for <code>flatpickr </code>we can run </p>
              <Pre> <code class="lang-js">npm i flatpickr</code></Pre>
              <p class="fw-bold font-sans-serif mb-0 mt-3">Step 2:</p>
              <p>Go to <code>vendors.json </code>file and give the path directory from node_modules as follow</p>
              <pre><code class="language-js">&quot;flatpickr&quot;: {
	...
	&quot;dest&quot;: &quot;flatpickr&quot;
              ...
              <p class="fw-bold font-sans-serif mb-0 mt-3">Step 3:</p>
              <p>Run the following command:</p>
              <pre><code class="lang-js">gulp vendor:move</code></pre>
            </div>
          </div>
          <div class="card mb-3">
            <div class="bg-holder d-none d-lg-block bg-card" style="background-image:url(../../assets/img/icons/spot-illustrations/corner-4.png);">
          ...
          <div class="card mb-3">
            ...
            <div class="card-body bg-light">
              <p class="mb-0">A JavaScript utility for adding deep anchor links to existing page content. AnchorJS is lightweight, accessible, and has no dependencies.</p><a class="font-sans-serif" href="../../modules/components/anchor.jsp">Implementation in theme</a> - <a class="font-sans-serif" href="https://www.bryanbraun.com/anchorjs/#basic-usage" target="_blank">Full Documentation</a>
            </div>
          </div>
          <div class="card mb-3">
            <div class="card-header">
              <h5 class="mb-0" data-anchor="data-anchor">Chart.js</h5>
            </div>
            <div class="card-body bg-light">
              <p class="mb-0">simple yet flexible JavaScript charting for designers & developers.</p><a class="font-sans-serif" href="../../modules/charts/chartjs.jsp">Implementation in theme</a> - <a class="font-sans-serif" href="https://www.chartjs.org/docs/latest/" target="_blank">Full Documentation</a>
            </div>
          </div>
          <div class="card mb-3">
            <div class="card-header">
              <h5 class="mb-0" data-anchor="data-anchor">Choices</h5>
            </div>
            <div class="card-body bg-light">
              <p class="mb-0">Choices.js is a lightweight, configurable select box/text input plugin. Similar to Select2 and Selectize but without the jQuery dependency</p><a class="font-sans-serif" href="../../modules/forms/advance/advance-select.jsp">Implementation in theme</a> - <a class="font-sans-serif" href="https://github.com/jshjohnson/Choices" target="_blank">Full Documentation</a>
            </div>
          </div>
          <div class="card mb-3">
            <div class="card-header">
            ...
            <div class="card-body bg-light">
              <p class="mb-0">CountUp.js is a dependency-free, lightweight JavaScript class that can be used to quickly create animations that display numerical data in a more interesting way.</p><a class="font-sans-serif" href="../../modules/components/countup.jsp">Implementation in theme</a> - <a class="font-sans-serif" href="https://github.com/inorganik/CountUp.js" target="_blank">Full Documentation</a>
            </div>
          </div>
          <div class="card mb-3">
            <div class="card-header">
              <h5 class="mb-0" data-anchor="data-anchor">D3.js</h5>
            </div>
            <div class="card-body bg-light">
              <p class="mb-0">JavaScript library for manipulating documents based on data.</p><a class="font-sans-serif" href="../../modules/charts/d3js.jsp">Implementation in theme</a> - <a class="font-sans-serif" href="https://github.com/d3/d3/wiki" target="_blank">Full Documentation</a>
            </div>
          </div>
          <div class="card mb-3">
            <div class="card-header">
            ...
            <div class="card-body bg-light">
              <p class="mb-0">Day.js 2KB immutable date-time library alternative to Moment.js with the same modern API.</p><a class="font-sans-serif" href="https://day.js.org/docs/en/installation/installation" target="_blank">Full Documentation</a>
            </div>
          </div>
          <div class="card mb-3">
            <div class="card-header">
              <h5 class="mb-0" data-anchor="data-anchor">Draggable.js</h5>
            </div>
            <div class="card-body bg-light">
              <p class="mb-0">A lightweight, responsive, modern drag & drop library.</p><a class="font-sans-serif" href="../../modules/components/draggable.jsp">Implementation in theme</a> - <a class="font-sans-serif" href="https://shopify.github.io/draggable/docs/" target="_blank">Full Documentation</a>
            </div>
          </div>
          <div class="card mb-3">
            <div class="card-header">
            ...
            <div class="card-body bg-light">
              <p class="mb-0">DropzoneJS is an open-source library that provides drag & drop file uploads with image previews.</p><a class="font-sans-serif" href="../../modules/forms/advance/file-uploader.jsp">Implementation in theme</a> - <a class="font-sans-serif" href="https://www.dropzonejs.com/" target="_blank">Full Documentation</a>
            </div>
          </div>
          <div class="card mb-3">
            <div class="card-header">
            ...
            <div class="card-body bg-light">
              <p class="mb-0">A powerful, interactive charting and visualization library for browser.</p><a class="font-sans-serif" href="../../modules/charts/echarts/how-to-use.jsp">Implementation in theme</a> - <a class="font-sans-serif" href="https://echarts.apache.org/en/option.jsp" target="_blank">Full Documentation</a>
            </div>
          </div>
          <div class="card mb-3">
            <div class="card-header">
            ...
            <div class="card-body bg-light">
              <p class="mb-0">Lightweight, powerful javascript datetimepicker with no dependencies.</p><a class="font-sans-serif" href="../../modules/forms/advance/date-picker.jsp">Implementation in theme</a> - <a class="font-sans-serif" href="https://flatpickr.js.org/" target="_blank">Full Documentation</a>
            </div>
          </div>
          <div class="card mb-3">
            <div class="card-header">
            ...
            <div class="card-body bg-light">
              <p class="mb-0">Get vector icons and social logos on your website with Font Awesome, the web's most popular icon set and toolkit.</p><a class="font-sans-serif" href="https://fontawesome.com/how-to-use/on-the-web/referencing-icons/basic-use" target="_blank">Full Documentation</a>
            </div>
          </div>
          <div class="card mb-3">
            <div class="card-header">
            ...
            <div class="card-body bg-light">
              <p class="mb-0">Full-sized drag &amp; drop event calendar.</p><a class="font-sans-serif" href="../../modules/components/calendar.jsp">Implementation in theme</a> - <a class="font-sans-serif" href="https://fullcalendar.io/docs" target="_blank">Full Documentation</a>
            </div>
          </div>
          <div class="card mb-3">
            <div class="card-header">
            ...
            <div class="card-body bg-light">
              <p class="mb-0">Glightbox is a pure javascript lightbox. It can display images, iframes, inline content and videos with optional autoplay for YouTube, Vimeo and even self hosted videos.</p><a class="font-sans-serif" href="../../modules/components/pictures/lightbox.jsp">Implementation in theme</a> - <a class="font-sans-serif" href="https://github.com/biati-digital/glightbox" target="_blank">Full Documentation</a>
            </div>
          </div>
          <div class="card mb-3">
            <div class="card-header">
            ...
            <div class="card-body bg-light">
              <p class="mb-0">Falcon uses Google map with Snazzy Maps, with different color schemes aimed towards web designers and developers.</p><a class="font-sans-serif" href="../../modules/maps/google-map.jsp">Implementation in theme</a> - <a class="font-sans-serif" href="https://developers.google.com/maps/documentation/javascript/tutorial" target="_blank">Full Documentation</a>
            </div>
          </div>
          <div class="card mb-3">
            <div class="card-header">
              <h5 class="mb-0" data-anchor="data-anchor">Inputmask</h5>
            </div>
            <div class="card-body bg-light">
              <p class="mb-0">Inputmask is a javascript library that creates an input mask.</p><a class="font-sans-serif" href="../../modules/forms/advance/input-mask.jsp">Implementation in theme</a> - <a class="font-sans-serif" href="https://github.com/RobinHerbots/Inputmask" target="_blank">Full Documentation</a>
            </div>
          </div>
          <div class="card mb-3">
            <div class="card-header">
            ...
            <div class="card-body bg-light">
              <p class="mb-0">Micro check plugin. Check types, regexps, presence, time and more...</p><a class="font-sans-serif" href="http://is.js.org/" target="_blank">Full Documentation</a>
            </div>
          </div>
          <div class="card mb-3">
            <div class="card-header">
              <h5 class="mb-0" data-anchor="data-anchor">Leaflet Map</h5>
            </div>
            <div class="card-body bg-light">
              <p class="mb-0">JavaScript library for mobile-friendly interactive maps</p><a class="font-sans-serif" href="../../modules/maps/leaflet-map.jsp">Implementation in theme</a> - <a class="font-sans-serif" href="https://leafletjs.com/" target="_blank">Full Documentation</a>
            </div>
          </div>
          <div class="card mb-3">
            <div class="card-header">
            ...
            <div class="card-body bg-light">
              <p class="mb-0">Tiny, invisible and simple, yet powerful and incredibly fast vanilla JavaScript that adds search, sort, filters and flexibility to plain HTML lists, tables, or anything.</p><a class="font-sans-serif" href="../../modules/tables/advance-tables.jsp">Implementation in theme</a> - <a class="font-sans-serif" href="https://listjs.com/" target="_blank">Full Documentation</a>
            </div>
          </div>
          <div class="card mb-3">
            <div class="card-header">
            ...
            <div class="card-body bg-light">
              <p class="mb-0">A modern JavaScript utility library delivering modularity, performance, &amp; extras.</p><a class="font-sans-serif" href="https://lodash.com" target="_blank">Full Documentation</a>
            </div>
          </div>
          <div class="card mb-3">
            <div class="card-header">
              <h5 class="mb-0" data-anchor="data-anchor">Lottie Web</h5>
            </div>
            <div class="card-body bg-light">
              <p class="mb-0">Render After Effects animations natively on Web, Android, and iOS, and React Native.</p><a class="font-sans-serif" href="../../modules/components/animated-icons.jsp">Implementation in theme</a> - <a class="font-sans-serif" href="https://github.com/airbnb/lottie-web" target="_blank">Full Documentation</a>
            </div>
          </div>
          <div class="card mb-3">
            <div class="card-header">
              <h5 class="mb-0" data-anchor="data-anchor">NoUiSlider</h5>
            </div>
            <div class="card-body bg-light">
              <p class="mb-0">noUiSlider is a lightweight range slider with multi-touch support and a ton of features.</p><a class="font-sans-serif" href="../../modules/forms/advance/range-slider.jsp">Implementation in theme</a> - <a class="font-sans-serif" href="https://refreshless.com/nouislider/" target="_blank">Full Documentation</a>
            </div>
          </div>
          <div class="card mb-3">
            <div class="card-header">
              <h5 class="mb-0" data-anchor="data-anchor">Picmo</h5>
            </div>
            <div class="card-body bg-light">
              <p class="mb-0">Vanilla JavaScript emoji picker component.</p><a class="font-sans-serif" href="../../modules/forms/advance/emoji-button.jsp">Implementation in theme</a> - <a class="font-sans-serif" href="https://picmojs.com/docs/api/overview" target="_blank">Full Documentation</a>
            </div>
          </div>
          <div class="card mb-3">
            <div class="card-header">
              <h5 class="mb-0" data-anchor="data-anchor">Plyr</h5>
            </div>
            <div class="card-body bg-light">
              <p class="mb-0">A simple, lightweight, accessible and customizable HTML5, YouTube and Vimeo media player that supports modern browsers.</p><a class="font-sans-serif" href="../../modules/components/videos/plyr.jsp">Implementation in theme</a> - <a class="font-sans-serif" href="https://github.com/sampotts/plyr/blob/master/README.md" target="_blank">Full Documentation</a>
            </div>
          </div>
          <div class="card mb-3">
            <div class="card-header">
            ...
            <div class="card-body bg-light">
              <p class="mb-0">Star rating widget for the browser. Unlimited number of stars. No dependencies. No Jquery required.</p><a class="font-sans-serif" href="../../modules/forms/advance/rating.jsp">Implementation in theme</a> - <a class="font-sans-serif" href="https://fredolss.github.io/rater-js/" target="_blank">Full Documentation</a>
            </div>
          </div>
          <div class="card mb-3">
            <div class="card-header">
              <h5 class="mb-0" data-anchor="data-anchor">SimpleBar</h5>
            </div>
            <div class="card-body bg-light">
              <p class="mb-0">Custom scrollbars made simple, lightweight, easy to use and cross-browser.</p><a class="font-sans-serif" href="../../modules/utilities/overlayscrollbar.jsp">Implementation in theme</a> - <a class="font-sans-serif" href="https://github.com/Grsmto/simplebar/tree/master/packages/simplebar" target="_blank">Full Documentation</a>
            </div>
          </div>
          <div class="card mb-3">
            <div class="card-header">
            ...
            <div class="card-body bg-light">
              <p class="mb-0">Swiper is the most modern free mobile touch slider with hardware accelerated transitions and amazing native behavior. It is intended to be used in mobile websites, mobile web apps, and mobile native/hybrid apps.</p><a class="font-sans-serif" href="../../modules/components/carousel/swiper.jsp">Implementation in theme</a> - <a class="font-sans-serif" href="https://swiperjs.com" target="_blank">Full Documentation</a>
            </div>
          </div>
          <div class="card mb-3">
            <div class="card-header">
              <h5 class="mb-0" data-anchor="data-anchor">Tinymce editor</h5>
            </div>
            <div class="card-body bg-light">
              <p class="mb-0">The world's most popular JavaScript library for rich text editing.</p><a class="font-sans-serif" href="../../modules/forms/advance/editor.jsp">Implementation in theme</a> - <a class="font-sans-serif" href="https://www.tiny.cloud/docs/quick-start/" target="_blank">Full Documentation</a>
            </div>
          </div>
          <div class="card mb-3">
            <div class="card-header">
            ...
            <div class="card-body bg-light">
              <p class="mb-0">A JavaScript library that types out, deletes them, and then types again.</p><a class="font-sans-serif" href="../../modules/components/typed-text.jsp">Implementation in theme</a> - <a class="font-sans-serif" href="https://mattboldt.com/demos/typed-js/" target="_blank">Full Documentation</a>
            </div>
          </div>
          <footer class="footer">
