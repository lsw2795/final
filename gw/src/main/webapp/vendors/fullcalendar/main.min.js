...
var FullCalendar = function(e) {
    ...
    var Lo = function(e) {
        ...
        return n(t, e), t.prototype.shouldComponentUpdate = function(e, t) {
            ...
            _t(this.state, r(r({}, this.state), e), this.stateEquality) || this.setState(e)
    ...
    var Ni = function() {
        ...
        return e.prototype.resetOptions = function(e, t) {
            ...
            var a = gn([cn, e.optionDefaults, n, o, e.optionOverrides, i]),
                ...
                d = !1,
                p = {};
            for (var f in a) a[f] === u[f] || fn[f] && fn[f](a[f], u[f]) ? l[f] = c[f] : (a[f] === this.currentCalendarOptionsInput[f] || fn[f] && fn[f](a[f], this.currentCalendarOptionsInput[f]) ? f in this.currentCalendarOptionsRefined && (l[f] = this.currentCalendarOptionsRefined[f]) : s[f] ? l[f] = s[f](a[f]) : p[f] = a[f], d = !0);
    ...
    }, e.triggerDateSelect = mr, e.unmountComponentAtNode = No, e.unpromisify = yo, e.version = "5.11.4", e.whenTransitionDone = Ne, e.wholeDivideDurations = Wt, Object.defineProperty(e, "__esModule", {
        value: !0
    }), e
}({});